namespace XYECOM.Plugin.DZ
{
    ...
    /// SQLServer 相关处理类
    /// </summary>
    internal class SQLServer : IDbProvider
    {
        ...
        internal SQLServer(string vDBaseConnectionString)
        {
            this._connectionString = string.Empty;
            this._errorString = string.Empty;
        ...
        public object vCommand(object[,] _vParameters, string _vCommandText, bool _vStoredProcedure)
        {
            ...
            command.Connection = new SqlConnection(this.vDataBaseConnectionString);
        ...
        public DataSet vDataSet(object[,] _vParameters, string _vCommandText, bool _vStoredProcedure)
        {
            ...
            try
            {
                SqlCommand selectCommand = (SqlCommand) this.vCommand(_vParameters, _vCommandText, _vStoredProcedure);
        ...
        public int vExecuteNonQuery(object[,] _vParameters, string _vCommandText, bool _vStoredProcedure)
        {
            ...
            try
            {
                SqlCommand command = (SqlCommand) this.vCommand(_vParameters, _vCommandText, _vStoredProcedure);
