        ...
        <div id="rightzqlist">
            ...
            <table style="margin: 8px auto" class="tab">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtCaseName" runat="server" Width="430px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtCaseName"
                            ErrorMessage="请填写档案名称！" ForeColor="Red" Font-Size="9pt"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="info_lei3">
            ...
            <table style="margin: 8px auto" class="tab" runat="server" id="tbFile">
                <tr>
                    <td class="info_lei3">
                        选择文件
                    </td>
                    <td>
                        <asp:FileUpload ID="flCase" runat="server" Width="403px" /><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="请上传档案文件！" ControlToValidate="flCase" 
            ...
            <div style="text-align: center; line-height: 40px">
                ...
                <input type="button" id="btnBack" onclick="javascript:history.back();" value="返回"
                    style="background: url(../Other/images/no.gif); width: 80px; height: 25px; border: none;
