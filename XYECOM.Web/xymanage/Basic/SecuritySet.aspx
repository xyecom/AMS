...
<table class="xy_tb xy_tb2" >
    <tr class="nobg">
    <td colspan="2" class="td27">验证码开启项：</td>
    </tr>
    <tr>
       ...
       <tr class="nobg">
    <td colspan="2" class="td27">验证码长度：</td>
    </tr>
    <tr>
        <td class="vtop" colspan="2">
        <asp:TextBox  runat="server" ID="txtVCodeLength" MaxLength="2" Width="20px"></asp:TextBox>
            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtVCodeLength"
                ErrorMessage="长度2～15之间" MaximumValue="15" MinimumValue="2" Type="Integer"></asp:RangeValidator><br/><span class="vtop tips2">2~15之间</span>
        </td>
    </tr>
    
       <tr class="nobg">
    <td colspan="2" class="td27">验证码字符扭曲度：</td>
    </tr>
    <tr>
        <td class="vtop" colspan="2">
            ...
            <br/><span class="vtop tips2">1为不扭曲</span>
        </td>
    </tr>
    
       <tr class="nobg">
    <td colspan="2" class="td27">验证码字符池：</td>
    </tr>
    <tr>
        <td class="vtop" colspan="2">
            <asp:TextBox runat="server" ID="txtVCodeCharPool" TextMode="MultiLine" Rows="10" Columns="100"></asp:TextBox><br/><span class="vtop tips2">多个之间用逗号(,)隔开,建议最少30字符个以上；如果要启用中文字符，尽量使用常用汉字</span>
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtVCodeCharPool"
                ErrorMessage="字符池不能为空"></asp:RequiredFieldValidator></td>
    </tr>
    
    
    <tr class="nobg">
    <td colspan="2" class="td27">禁止访问IP列表：</td>
    </tr>
    <tr>
        <td class="vtop" colspan="2">
            <asp:TextBox runat="server" ID="txtForbidIP" TextMode="MultiLine" Rows="6" Columns="100"></asp:TextBox><br/><span class="vtop tips2">多个之间用 | 隔开</span>
        </td>
    </tr>
</table>
