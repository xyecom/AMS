...
<tr class="nobg">
  <td colspan="2" class="td27">上传图片最大尺寸：</td>
  </tr>
  <tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadImg" runat="server" CssClass="txt" MaxLength="24"></asp:TextBox></td><td class="vtop tips2">格式为：宽度 * 高度 例如：1024*768。</td></tr>

<tr class="nobg">
  <td colspan="2" class="td27">缩略图文件夹：</td>
  </tr>
  <tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadThumbnailImgFolder" runat="server" CssClass="txt" MaxLength="24"></asp:TextBox></td><td class="vtop tips2">格式为：宽度 * 高度 例如：1024*768。</td></tr>

<tr class="nobg">
  <td colspan="2" class="td27">缩略图1尺寸：</td>
  </tr>
  <tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadThumbnailImg1" runat="server" CssClass="txt" MaxLength="24" ></asp:TextBox></td><td class="vtop tips2">格式为：宽度 * 高度</td></tr>

<tr class="nobg">
  <td colspan="2" class="td27">缩略图2尺寸：</td>
  </tr>
  <tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadThumbnailImg2" runat="server" CssClass="txt" MaxLength="24" ></asp:TextBox></td><td class="vtop tips2">格式为：宽度 * 高度</td></tr>

<tr class="nobg">
  <td colspan="2" class="td27">缩略图3尺寸：</td>
  </tr>
  <tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadThumbnailImg3" runat="server" CssClass="txt" MaxLength="24" ></asp:TextBox></td><td class="vtop tips2">格式为：宽度 * 高度</td></tr>

<tr class="nobg">
  <td colspan="2" class="td27">上传图片类型：</td>
  </tr>
  <tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadFileType" runat="server" CssClass="txt" MaxLength="50"></asp:TextBox></td><td class="vtop tips2">文件类型后缀名,以";"隔开。</td></tr>

<tr class="nobg">
  <td colspan="2" class="td27">图片大小：</td>
</tr>
<tr><td class="vtop rowform">
    <asp:TextBox ID="tbUploadFileSize" runat="server" CssClass="txt" MaxLength="4" onblur="IsInt(this);" Width="40px">0</asp:TextBox>KB</td><td class="vtop tips2">KB 为单位，1M = 1024KB</td>
</tr>

<tr class="nobg">
  <td colspan="2" class="td27">上传附件类型：</td>
</tr>
<tr>
<td class="vtop rowform">
    <asp:TextBox ID="tbUploadAdjunctType" runat="server" CssClass="txt" MaxLength="50" ></asp:TextBox></td><td class="vtop tips2">文件类型后缀名,以";"隔开。</td>
</tr>
<tr class="nobg">
  <td colspan="2" class="td27">附件大小：</td>
</tr>
<tr><td class="vtop rowform">
<asp:TextBox ID="tbUploadAdjunctSize" runat="server" CssClass="input" MaxLength="4" onblur="IsInt(this);"
                Width="40px">0</asp:TextBox> KB</td><td class="vtop tips2">KB 为单位，1M = 1024KB</td>
</tr>
</table>
  ...
  <tr>
    ...
    <tr>
        ...
        <br/>
                ...
                <br/>
                <p><asp:Label ID="lbWaterMarkPicURL" runat="server"></asp:Label></p>
                <br/>
...
<table class="xy_tb xy_tb2" >
    <tr class="nobg">
    <td colspan="2" class="td27">相关新闻调用数量：</td>
    </tr>
    <tr>
        <td class="vtop rowform">
            <asp:TextBox ID="txtAboutNewsNum" runat="server" MaxLength="4" Width="40px" CssClass="input" onblur="IsInt(this);"></asp:TextBox></td>
        <td class="vtop tips2">
        </td>
    </tr>
    
    <tr class="nobg">
    <td colspan="2" class="td27">自动收集站内搜索关键词：</td>
    </tr>
    <tr>
        <td class="vtop rowform">
...
<asp:Button ID="btnok" runat="server" CssClass="button" Text="保存设置" OnClientClick="return chkfunctioninput();" OnClick="btnok_Click" />
</div>
</div>
</td>
</tr>
