<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitsAdd.aspx.cs" Inherits="XYECOM.Web.xymanage.Basic.UnitsAdd" %>
...
<tr class="nobg">
  <td colspan="2" class="td27">单位名称：</td>
</tr>
<tr>
...
<td colspan="2" class="content_action"><asp:button id="btnok" runat="server" CssClass="button" Text="保存" OnClick="btnok_Click"  ></asp:button>
   <input type="button" onclick="javascript:history.go(-1);" value="返回" class="button" />
