<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAreaLabel.aspx.cs" Inherits="XYECOM.Web.xymanage.LabelManage.AddAreaLabel" %>
...
<h1><a href="../index.aspx">后台管理首页</a> >> 新增地区导航标签</h1>
<table width="100%" >
<tr>
<td class="right" >

<div class="main-setting">
<div class="itemtitle"><h3>新增地区导航标签</h3></div>

<table class="xy_tb xy_tb2 infotable border_buttom0">
    <tr>
        <th>标签名称：</th>
        <td style="font-weight:bold">{XY_CLS_<asp:TextBox ID="txtLabelName" runat="server" CssClass="input_s"></asp:TextBox>}
        <br/>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLabelName"
ErrorMessage="标签名称不能为空！" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
        <th>请选择导航至模块：</th>
    <td>
    <asp:DropDownList Width="150" ID="ddlClass" runat="server" onchange="ShowToPage(this)">
</asp:DropDownList><br/>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlClass"
            Display="Dynamic" ErrorMessage="请选择分类" SetFocusOnError="True"></asp:RequiredFieldValidator></td>  
    </tr>
    <tr>
       <th>
            中文名称：
        ...
        <td>
            <asp:TextBox ID="txtCNName" runat="server" Columns="32" CssClass="input_s"></asp:TextBox><br/>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCNName"
                ErrorMessage="中文名称不能为空！" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
        <th>
        选择目标页面：</th>
        <td>
        <asp:RadioButtonList ID="rblToPage" runat="server" RepeatDirection="Horizontal"
            RepeatLayout="Flow">
...
<input id="Radio2" name="z" type="radio" onclick="$('tb2').style.display='none';$('tb1').style.display='block';" />自动组合
    ...
    <table  style="display:none;margin-top:5px;"  class="xy_tb xy_tb border_buttom0" cellpadding="4" id="tb1">
    <tr>
        <td colspan="2">
...
<tr>
          ...
          <asp:Panel ID="pnlSuperClass" runat="server">
                   <ul style="width:300px;"> <li style="margin:0px;padding:0px;"></asp:Panel></li></ul></td>
