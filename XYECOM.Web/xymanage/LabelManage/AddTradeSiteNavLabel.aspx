<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTradeSiteNavLabel.aspx.cs" Inherits="XYECOM.Web.xymanage.LabelManage.AddTradeSiteNavLabel" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>新增行业站导航标签</title>
...
<h1><a href="../index.aspx">后台管理首页</a> >> 新增行业站导航标签</h1>
<table width="100%" >
<tr>
<td class="right">    

<div class="main-setting">
<div class="itemtitle"><h3 id="title" runat="server">新增行业站导航标签</h3>
</div>
...
<tr>
   <td class="vtop rowform" style="font-weight:bold; width:500px; height: 48px;">
     {XY_TSN_<asp:TextBox ID="txtName" Columns="30" runat="server" CssClass="input" MaxLength="50"></asp:TextBox>}
...
<tr class="nobg">
  <td colspan="2" class="td27">行业列表：</td>
</tr>
<tr>
   <td class="vtop rowform">
    
       <asp:CheckBoxList ID="chklstTrade" runat="server" RepeatColumns="4" RepeatLayout="Table">
       </asp:CheckBoxList><br/>
