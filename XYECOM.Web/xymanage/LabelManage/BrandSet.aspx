<%@ Page Language="C#" AutoEventWireup="true" Inherits="xymanage_LabelManage_BrandSet"
    CodeBehind="BrandSet.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>品牌信息标签设置</title>
                ...
                <div class="main-setting">
                    ...
                    <table width="100%" class="xy_tb xy_tb2 setLabelData" id="base">
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="hidptid" runat="server" type="hidden" value="" /><input id="moduleflag"
                                    runat="server" type="hidden" value="" /><input id="hidweburl" runat="server" type="hidden" />
                                <input id="selectflag" type="hidden" value="1" /><input id="hidsuffix" runat="server"
                                    type="hidden" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table width="100%" class="xy_tb xy_tb2 setLabelData" id="page" style="display: none;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbpagecorporationnum" runat="server" CssClass="inpu" MaxLength="10"
                                    onblur="isNumer(this);"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
...
var cla = new ClassType("cla",'brand','classType','hidptid');
cla.Mode = "select";
cla.Init();
</script>
