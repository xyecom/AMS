...
namespace XYECOM.Web.xymanage.Ranking
{
    public partial class List : XYECOM.Web.BasePage.ManagePage
    {
        ...
        protected override void BindData()
        {
            ...
            //设置编辑或查看后要返回当前页面的状态
            backURL = XYECOM.Core.Utils.JSEscape("../Ranking/list.aspx?keyword=" + txtkey.Text.Trim() +
            ...
            DataTable dt = XYECOM.Business.Utils.GetPaginationData("XYV_Ranking", "RID", "Rid,keyword,UI_Name,beginTime,endtime,Rank,userID,KeyId", "RID desc", strwhere,Page1.PageSize, this.Page1.CurPage, out totalRecord);
