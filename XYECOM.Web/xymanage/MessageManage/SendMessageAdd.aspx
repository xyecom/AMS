<%@ Page Language="C#" AutoEventWireup="true" Inherits="xymanage_MessageManage_SendMessageAdd" Codebehind="SendMessageAdd.aspx.cs" %>
...
<h1><a href="../index.aspx">后台管理首页</a> >> 发送短信</h1>
<table  width="100%" >
<tr>
<td class="right">
...
<div class="itemtitle"><h3>站内短信</h3>
    <ul class="tab1" id="mainMenus0">
            ...
            <li class="current"><a href="#"><span>发送信息</span></a></li>
        </ul>
</div>
...
<table width="100%" style="margin-top:0px;" cellpadding="0" cellspacing="0">
    ...
    <td>
            ...
            <td><label>
                ...
                <input id="Button3" class="button" type="button" value="返回" onclick="window.location.href='SendMessageList.aspx';" /><br />
        ...
        <td align="left" class="select_user">
         <div id="a2">
	        ...
	        <div id="b22">
                ...
                <div id="pansearch" >
                    ...
                    结果列表：
                        ...
                        <hr />
                        <uc1:page ID="Page2" runat="server" Mode="simple"/>
                </div>
	        </div> 
	        <div id="b23" style="display:none;">
                ...
                <div  id="personserach">
		        按姓名搜索：<br />
                <asp:TextBox ID="txtperson" runat="server" MaxLength="20" Columns="29"></asp:TextBox>
            ...
            <hr />
             ...
             <uc1:page ID="Page1" runat="server" Mode="simple"/> 
	        </div>
	        </div>
    </td> 
</tr>
