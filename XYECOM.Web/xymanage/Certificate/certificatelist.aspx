...
<h1><a href="../index.aspx">后台设置首页</a> >> 企业证书信息列表</h1>
<table width="100%"   >
<tr>
<td class="right">
...
<div class="itemtitle"><h3>企业证书信息列表</h3>
...
<asp:BoundField HeaderText="证书类别" DataField="CE_Type" >
    ...
    <asp:ButtonField CommandName="shenhe" HeaderText="审　核" DataTextField="AuditingState" ><ItemStyle CssClass="action" Width="10%" /></asp:ButtonField>   
   <asp:TemplateField HeaderText="查看">
    <ItemStyle Width="10%" />
        <ItemTemplate>
            <a href='certificateinfo.aspx?CE_ID=<%# Eval("CE_ID") %>&CE_Type=<%# Eval("CE_Type") %>&U_ID=<%# Eval("U_ID") %>&backURL=<%# backURL %>'><img src="../images/look.GIF" alt="查看" /></a>
        </ItemTemplate>
    </asp:TemplateField>
...
<tr>
<td class="content_action"><input  id="chkAll" onclick="chkAll_true()" type="checkbox" name="chkAll"/>全选
<asp:button id="Btndel" runat="server" CssClass="button" Text="删除" OnClick="Btndel_Click"></asp:button></td>
</tr>
</table>
