<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSubject.aspx.cs" Inherits="XYECOM.Web.xymanage.VoteManage.EditSubject1" %>
...
<h1><a href="../index.aspx">后台管理首页</a> >> 编辑调查问题</h1>
<table width="100%" >
<tr>
<td class="right">    

<div class="main-setting">
<div class="itemtitle"><h3 id="title" runat="server">编辑调查问题</h3>
</div>
