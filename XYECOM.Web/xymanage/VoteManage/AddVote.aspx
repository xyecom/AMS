<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddVote.aspx.cs" Inherits="XYECOM.Web.xymanage.VoteManage.AddVote" %>
...
<h1><a href="../index.aspx">后台管理首页</a> >> 新增调查</h1>
<table width="100%" >
<tr>
<td class="right">    

<div class="main-setting">
<div class="itemtitle"><h3 id="title" runat="server">新增调查</h3>
</div>
...
<tr>
   <td class="vtop rowform" >
     <asp:TextBox ID="txtEndTime" runat="server" Enabled="true" CssClass="input_s" onclick="getDateString(this);" MaxLength="30" Width="100px"></asp:TextBox>
