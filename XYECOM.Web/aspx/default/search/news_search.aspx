<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.search.news_search,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("				<h2><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/bg_invest_tit.gif\" width=\"12\" height=\"12\" alt=\"\" align=\"absmiddle\" /> 栏目选择：</h2>\r\n");
	XYBody.Append("				<div class=\"sch_cnts\" id=\"xy_ClassList\"></div>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div id=\"FilterDiv\">\r\n");
	XYBody.Append("				<div id=\"FilterDivA\">\r\n");
	XYBody.Append("					<span>每页显示数量:\r\n");
	XYBody.Append("					    <select name=\"PageSize\" id=\"PageSize\" onchange=\"NewsSearch();\">\r\n");
	...
	XYBody.Append("					    <option value=\"100\" >100</option>\r\n");
	XYBody.Append("					    </select>\r\n");
	XYBody.Append("					</span>\r\n");
	XYBody.Append("					<strong class=\"Font14 redLink\">缩小范围:</strong>\r\n");
	XYBody.Append("					<select id=\"newsType\">\r\n");
	XYBody.Append("	                    <option value=\"\">资讯类型</option>\r\n");
	XYBody.Append("	                    <option value=\"1\">普通资讯</option>\r\n");
	XYBody.Append("	                    <option value=\"2\">图片资讯</option>\r\n");
	XYBody.Append("	                    <option value=\"3\">标题资讯</option>\r\n");
	XYBody.Append("	                </select>\r\n");
	XYBody.Append("	                <select id=\"isCommend\">\r\n");
	XYBody.Append("	    	            <option value=\"\">是否推荐</option>\r\n");
	XYBody.Append("	                    <option value=\"1\">推荐</option>\r\n");
	XYBody.Append("	                    <option value=\"0\">不推荐</option>     \r\n");
	XYBody.Append("	                </select>\r\n");
	XYBody.Append("	                <input type=\"text\" value=\"开始时间\" id=\"newsStartDate\" size=\"10\" readonly=\"readonly\" onclick=\"getDateString(this);\"/>\r\n");
	XYBody.Append("	                <input type=\"text\" value=\"结束时间\" id=\"newsEndDate\" size=\"10\" readonly=\"readonly\" onclick=\"getDateString(this);\"/>\r\n");
	XYBody.Append("					<input type=\"text\" size=\"8\" id=\"txtkeyword\" onkeydown =\"NewsSearchKeyDown();\" />\r\n");
	XYBody.Append("					<input type=\"button\" name=\"Submit\" value=\"筛选\" onclick=\"NewsSearch()\" />\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<script language=\"javascript\">");	XYBody.Append(pageinfo.OnLoadEvents);	XYBody.Append("</" + "script>\r\n");
	XYBody.Append("            " +  XYECOMCreateHTML("XY_NewsList").ToString() + "\r\n");
	...
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div class=\"MTitle_01\">\r\n");
	XYBody.Append("				<h2 id=\"h2_1\" class=\"\"><a target=\"_blank\" href=\"#\"><strong>展会技巧</strong></a></h2>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div id=\"Div7\" class=\"Mblk_01\">\r\n");
	XYBody.Append("				<div class=\"com_pages\">\r\n");
	XYBody.Append("					<ul>\r\n");
	XYBody.Append("						<li><a target=\"_blank\" href=\"#\">多国暴发甲型H1N1流感</a></li>\r\n");
	XYBody.Append("						<li><a target=\"_blank\" href=\"#\">胡锦涛出席上合峰会</a></li>\r\n");
