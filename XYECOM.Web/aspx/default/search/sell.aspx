...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("                                        <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/enterWEB.gif\" alt=\"进入企业网站\"\r\n");
	XYBody.Append("                                            width=\"112\" height=\"21\" border=\"0\" /></a>&nbsp;&nbsp;&nbsp; <a href=\"");	XYBody.Append(tempuser.contactus.ToString());	XYBody.Append("\"\r\n");
	XYBody.Append("                                                target=\"_blank\">\r\n");
	XYBody.Append("                                                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/enterContact.gif\"\r\n");
	XYBody.Append("                                                    alt=\"查看联系方式\" width=\"112\" height=\"21\" border=\"0\" /></a>\r\n");
	XYBody.Append("                                </td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                            <tr>\r\n");
	...
	XYBody.Append("<a href=\"");	XYBody.Append(offerinfo.OrderLink.ToString());	XYBody.Append("\" target=\"_blank\">在线订购</a>\r\n");
	...
	XYBody.Append("                                    联 系 人：");	XYBody.Append(tempuser.linkman.ToString());	XYBody.Append("&nbsp;&nbsp;<img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/icon_tianjiasy.gif\"\r\n");
	XYBody.Append("                                        width=\"13\" height=\"12\" style=\"position: relative; top: 1px;\" />\r\n");
	XYBody.Append("                                    <a href=\"javascript:void(null);\" onclick=\"Favorite();\" class=\"orange\">添加为商业伙伴</a>\r\n");
	XYBody.Append("                                </td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                        </table>\r\n");
	XYBody.Append("                    </div>\r\n");
	...
	XYBody.Append("                                    <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/inquire2.gif\" width=\"139\"\r\n");
	XYBody.Append("                                        height=\"36\" border=\"0\" /></a>\r\n");
	XYBody.Append("                            </td>\r\n");
	XYBody.Append("                            <td style=\"text-align: center;\">\r\n");
	XYBody.Append("                                <span class=\"Font14\">或联系</span>：<strong class=\"orange\" class=\"TempTele\">86-010-62669815</strong>\r\n");
	XYBody.Append("                            </td>\r\n");
	XYBody.Append("                        </tr>\r\n");
	XYBody.Append("                    </table>\r\n");
	XYBody.Append("                </div>\r\n");
	...
	XYBody.Append("                    <strong>详细信息:</strong></div>\r\n");
	...
	XYBody.Append("                    <strong>联系方式:</strong></div>\r\n");
	XYBody.Append("                <div class=\"ProDesText\" id=\"linkmessage\">\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("            <div id=\"ProTitle\">\r\n");
	XYBody.Append("                <span>该企业发布的其他信息</span></div>\r\n");
	...
	XYBody.Append("            <span>\r\n");
	XYBody.Append("                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/icon1.gif\" width=\"20\"\r\n");
	XYBody.Append("                    height=\"14\" /><a href=\"javascript:void(null);\" onclick=\"Favorite();\">收藏此信息</a>&nbsp;&nbsp;&nbsp;\r\n");
	XYBody.Append("                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/icon2.gif\" width=\"21\"\r\n");
	XYBody.Append("                    height=\"11\" /><a href=\"#\">推荐给朋友</a>&nbsp;&nbsp;&nbsp;\r\n");
	XYBody.Append("                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/icon3.gif\" height=\"16\" /><a\r\n");
	XYBody.Append("                    href=\"");	XYBody.Append(config.weburl);	XYBody.Append("feedback.");	XYBody.Append(config.suffix);	XYBody.Append("\">举报此信息</a> </span><strong class=\"orange\">\r\n");
	XYBody.Append("                        还没有找到合适的产品?</strong> 赶快<a href=\"");	XYBody.Append(config.weburl);	XYBody.Append("user/\" target=\"_blank\">发布求购信息</a>，让供应商主动来找您！\r\n");
	XYBody.Append("        </div>\r\n");
	...
	XYBody.Append("                <a target=\"_blank\" href=\"#\" class=\"red\"><strong>加入我们，享受更多服务</strong></a></center>\r\n");
	XYBody.Append("        </div>\r\n");
	...
	XYBody.Append("                    <li><a href=\"\">\r\n");
	XYBody.Append("                        <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/btn_gq_reg.gif\" width=\"130\"\r\n");
	...
	XYBody.Append("									<a href=\"");	XYBody.Append(tempuser.contactus.ToString());	XYBody.Append("\" target=\"_blank\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/enterContact.gif\" alt=\"查看联系方式\" width=\"112\" height=\"21\" border=\"0\" /></a>\r\n");
	XYBody.Append("									</td>\r\n");
	XYBody.Append("									</tr>\r\n");
	XYBody.Append("								<tr>\r\n");
	...
	XYBody.Append("				</div>\r\n");
	XYBody.Append("                <div id=\"ProTitle\"><span>该企业发布的其他信息</span></div>\r\n");
	XYBody.Append("                <div class=\"ProAbout\">\r\n");
	 data = GetAboutInfo();
	...
	XYBody.Append("						</div>\r\n");
	XYBody.Append("						<div id=\"ProInfoB\">\r\n");
	XYBody.Append("						<!--!!!!!!!!!!!!!!招商详细信息!!!!!!!!!!!!!-->\r\n");
	XYBody.Append("							<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
	XYBody.Append("									<tr>\r\n");
	XYBody.Append("										<td  height=\"24\" colspan=\"2\">项目区域要求：");	XYBody.Append(investmentinfo.AreaName.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("									</tr>\r\n");
	XYBody.Append("									<tr>\r\n");
	...
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div id=\"ProDesTitle\">\r\n");
	XYBody.Append("					    <strong>招商支持：:</strong>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div class=\"ProDesText\">\r\n");
	XYBody.Append("					     ");	XYBody.Append(investmentinfo.Support.ToString());	XYBody.Append("\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div id=\"ProDesTitle\">\r\n");
	XYBody.Append("					    <strong>招商要求：:</strong>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div class=\"ProDesText\">\r\n");
	XYBody.Append("					     ");	XYBody.Append(investmentinfo.Demand.ToString());	XYBody.Append("\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div id=\"ProDesTitle\">\r\n");
	XYBody.Append("					    <strong>联系方式:</strong>\r\n");
	XYBody.Append("					</div>\r\n");
	...
	XYBody.Append("            <input type =\"hidden\" id=\"_param_onlinejoin_Areas\" value =\"");	XYBody.Append(investmentinfo.A_Area.ToString());	XYBody.Append("\" />\r\n");

	XYBody.Append("<div  class=\"infoAbout  commentTitle\"> <a name=\"message\"></a>\r\n");
	XYBody.Append("  <form id=\"frmjoin\" action=\"\" method=\"post\">\r\n");
	XYBody.Append("    <ul class=\"comment\">\r\n");
	XYBody.Append("      <li class=\"\" id=\"tab1\"><a href=\"javascript:;\" onClick=\"SetUserState(1)\">我是游客</a></li>\r\n");
	XYBody.Append("      <li class=\"now\" id=\"tab2\"><a href=\"javascript:;\" onClick=\"SetUserState(2)\">我是会员</a></li>\r\n");
	XYBody.Append("    </ul>\r\n");
	XYBody.Append("  <div class=\"commentList\">\r\n");
	XYBody.Append("    <ul id=\"_onlinejoin_guest\" class=\"line\" style=\"display:none;\">\r\n");
	XYBody.Append("      <li>\r\n");
	XYBody.Append("        <label>联系人：<em>*</em></label>\r\n");
	...
	XYBody.Append("      </li>\r\n");
	XYBody.Append("      <li>\r\n");
	XYBody.Append("        <label >验证码：<em>*</em></label>\r\n");
	XYBody.Append("         ");	XYBody.Append(pageinfo.GetValidateCodeHTML("txtcode","guestVCodeImg"));	XYBody.Append("\r\n");

	}	//end if

	XYBody.Append("      </li>\r\n");
	XYBody.Append("      <li>\r\n");
	XYBody.Append("        <input name=\"\" type=\"button\" class=\"button\" value=\"确 定\"  onclick =\"joinSend();\"/>\r\n");
	XYBody.Append("        <input type=\"button\" name=\"button\"  class=\"button\" value=\"清 空\" onclick =\";\"  />\r\n");
	XYBody.Append("      </li>\r\n");
	XYBody.Append("    </ul>\r\n");
	XYBody.Append("  </div>\r\n");
	XYBody.Append("  </form>\r\n");
