<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.search.buy_search,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("    <link href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/css/Survey.css\" rel=\"stylesheet\"\r\n");
	XYBody.Append("        type=\"text/css\" />\r\n");
	...
	XYBody.Append("    <script type=\"text/javascript\" src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/js/SupplyBuyValidate.js\"\r\n");
	XYBody.Append("        language=\"javascript\"></" + "script>\r\n");
	XYBody.Append("    <link href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/css/index.css\" rel=\"stylesheet\"\r\n");
	XYBody.Append("        type=\"text/css\" />\r\n");
	XYBody.Append("</head>\r\n");
	XYBody.Append("<body onload=\"SearchSetDefaultValue();\">\r\n");
	...
	XYBody.Append("            <div id=\"left\">\r\n");
	XYBody.Append("                <input type=\"hidden\" id=\"xy_FlagName\" value=\"SupplyBuy\" />\r\n");
	...
	XYBody.Append("                            <select name=\"pagesize\" id=\"pagesize\">\r\n");
	...
	XYBody.Append("                        </select>\r\n");
	XYBody.Append("                        <select id=\"jinji\">\r\n");
	XYBody.Append("                            <option value=\"\">不限制求购状态</option>\r\n");
	XYBody.Append("                            <option value=\"0\">紧急求购</option>\r\n");
	XYBody.Append("                            <option value=\"1\">普通求购</option>\r\n");
	XYBody.Append("                        </select>\r\n");
	XYBody.Append("                        <select id=\"style\" style=\"display: none\">\r\n");
	XYBody.Append("                            <option value=\"0\" selected=\"selected\">样式1</option>\r\n");
	XYBody.Append("                            <option value=\"1\">样式2</option>\r\n");
	XYBody.Append("                        </select>\r\n");
	XYBody.Append("                        <input type=\"text\" size=\"8\" id=\"txtkeyword\" onclick=\"SearchKeyDown()\" />\r\n");
	XYBody.Append("                        <input type=\"button\" name=\"Submit\" value=\"筛选\" onclick=\"listsearch()\" />\r\n");
	XYBody.Append("                    </div>\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("                <script type=\"text/javascript\" language=\"javascript\">                    { pageinfo.OnLoadEvents }</" + "script>\r\n");
	XYBody.Append("                " +  XYECOMCreateHTML("XY_newSupplyBuy").ToString() + "\r\n");
	...
	XYBody.Append("                                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp_meeting_11.gif\"\r\n");
	XYBody.Append("                                    alt='展会合作'></a></li>\r\n");
	XYBody.Append("                            <li><a href=\"#\">\r\n");
	XYBody.Append("                                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp_meeting_22.gif\"\r\n");
	XYBody.Append("                                    alt='展会合作'></a></li>\r\n");
	XYBody.Append("                            <li><a href=\"#\">\r\n");
	XYBody.Append("                                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp_meeting_33.gif\"\r\n");
	XYBody.Append("                                    alt='展会合作'></a></li>\r\n");
	XYBody.Append("                            <div class=\"clr\">\r\n");
	XYBody.Append("                            </div>\r\n");
	XYBody.Append("                        </ul>\r\n");
