<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.search.buyer_search,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("                <input type=\"hidden\" id=\"Hidden1\" value=\"");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("\" />\r\n");
	XYBody.Append("                <script language=\"javascript\">                    { pageinfo.OnLoadEvents }</" + "script>\r\n");
	...
	XYBody.Append("                    " +  XYECOMCreateHTML("XY_SellOfferSaleNo1").ToString() + "\r\n");
	XYBody.Append("                    <!-- 以上为程序提取静态块 -->\r\n");
	XYBody.Append("                    " +  XYECOMCreateHTML("XY_SellOfferSaleNo2").ToString() + "\r\n");
	XYBody.Append("                </div>\r\n");
	...
	XYBody.Append("                " +  XYECOMCreateHTML("XY_OfferWritingList").ToString() + "\r\n");
	...
	XYBody.Append("        " +  XYECOMCreateHTML("XY_MachiningWritingList").ToString() + "\r\n");
	...
	XYBody.Append("        " +  XYECOMCreateHTML("XY_InvestmentNo1").ToString() + " " +  XYECOMCreateHTML("XY_InvestmentNo2").ToString() + " </div>\r\n");
	XYBody.Append("        <div id=\"ProDiv\">\r\n");
	XYBody.Append("            <!--普通列表-->\r\n");
	...
	XYBody.Append("        " +  XYECOMCreateHTML("XY_InvestmentWritingList").ToString() + "\r\n");
	...
	XYBody.Append("    " +  XYECOMCreateHTML("XY_ServiceWritingList").ToString() + "\r\n");
	...
	XYBody.Append("                        <img src=\"" + ads["imageurl"].ToString().Trim() + "\" alt='" + ads["desc"].ToString().Trim() + "' /></a></li>\r\n");
