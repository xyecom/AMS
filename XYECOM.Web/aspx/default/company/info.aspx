<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.company.info,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("		<em>您现在的位置：<a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("\">首页</a> &gt; <strong>企业信息</strong> &gt; ");	XYBody.Append(tempuser.name.ToString());	XYBody.Append("</em>\r\n");
	XYBody.Append("	</div>\r\n");
	XYBody.Append("	<div id=\"idx_cnt2\">\r\n");
	XYBody.Append("		<div id=\"left\">\r\n");
	XYBody.Append("			<div class=\"exhi_pages\">\r\n");
	XYBody.Append("				<h1>");	XYBody.Append(tempuser.name.ToString());	XYBody.Append("</h1>\r\n");
	XYBody.Append("				<div class=\"cate\"><h2>企业简介：</h2></div>\r\n");
	...
	XYBody.Append("                    <img src=\"");	XYBody.Append(tempuser.logo.ToString());	XYBody.Append("\" alt=\"");	XYBody.Append(tempuser.name.ToString());	XYBody.Append("\" align=\"right\"/>\r\n");

	}	//end if

	XYBody.Append("                ");	XYBody.Append(tempuser.synopsis.ToString());	XYBody.Append("</p>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cate\"><h2>企业详细信息</h2></div>\r\n");
	XYBody.Append("				<div class=\"main\">\r\n");
	XYBody.Append("					<table width=\"540\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\" bgcolor=\"#c6c6c6\" style=\"padding:4px;\">\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td width=\"16%\" bgcolor=\"#f5f5f5\">企业性质：</td>\r\n");
	XYBody.Append("					<td width=\"35%\" bgcolor=\"#f5f5f5\"> ");	XYBody.Append(tempuser.character.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					<td width=\"16%\" bgcolor=\"#f5f5f5\">企业类型：</td>\r\n");
	XYBody.Append("					<td width=\"33%\" bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.unittype.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">经营模式：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.mode.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">主营产品和服务：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.supplypro.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">注册时间：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.regdate.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\"></td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\"></td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					</table>\r\n");
	XYBody.Append("				</div>\r\n");
	...
	XYBody.Append("				<div class=\"cate\"><h2>联系方式：</h2></div>\r\n");
	XYBody.Append("				<div class=\"main\">\r\n");
	XYBody.Append("                    <table width=\"540\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\" bgcolor=\"#c6c6c6\" style=\"padding:4px;\">\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td width=\"16%\" bgcolor=\"#f5f5f5\">联 系 人：</td>\r\n");
	XYBody.Append("					<td width=\"35%\" bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.linkman.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					<td width=\"16%\" bgcolor=\"#f5f5f5\">电    话：</td>\r\n");
	XYBody.Append("					<td width=\"33%\" bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.telephone.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">传    真：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.fax.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">手机号码：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.mobile.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">地    址：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.areaname.ToString());	XYBody.Append(" ");	XYBody.Append(tempuser.address.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">Email：</td>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">");	XYBody.Append(tempuser.email.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					<td bgcolor=\"#f5f5f5\">公司主页：</td>\r\n");
	...
	XYBody.Append("				<h2 id=\"h2_1\" class=\"\"><a target=\"_blank\" href=\"#\"><strong>推荐企业</strong></a></h2>\r\n");
	XYBody.Append("			</div>\r\n");
	...
	XYBody.Append("				<h2 id=\"h2_2\" class=\"\"><a target=\"_blank\" href=\"#\" class=\"big\"><strong>企业动态</strong></a></h2>\r\n");
	XYBody.Append("			</div>\r\n");
