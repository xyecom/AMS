<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.receiveinvestmentmessagelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  </td>\r\n");
	XYBody.Append("<td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("person/receivemessageinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?m_id=" + s["M_ID"].ToString().Trim() + "\">" + s["M_Title"].ToString().Trim() + "</a></td>\r\n");
	XYBody.Append("   <td>\r\n");

	if (s["U_ID"].ToString().Trim()=="-1")
	{
