<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.fictitiouacount,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("          <caption>网站币帐户</caption>\r\n");
	XYBody.Append("                <thead>\r\n");
	XYBody.Append("               <tr>\r\n");
	XYBody.Append("                 <th>用户名</th>\r\n");
	XYBody.Append("                 <th>充值金额</th>\r\n");
	XYBody.Append("                 <th>剩余金额</th>\r\n");
	XYBody.Append("                 <th>创建日期</th>\r\n");
	XYBody.Append("               </tr>\r\n");
	XYBody.Append("               </thead>\r\n");
	XYBody.Append("           <tbody>\r\n");
	...
	XYBody.Append("              <td>" + uc["C_SumMoney"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("              <td>" + uc["C_LeftMoney"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("              <td>" + uc["addtime"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("             </tr>\r\n");
