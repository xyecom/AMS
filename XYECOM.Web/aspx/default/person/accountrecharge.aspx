<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.accountrecharge,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<form action=\"\" method =\"post\" target=\"_blank\">\r\n");
	XYBody.Append("  <table class=\"contentl\">\r\n");
	XYBody.Append("  <caption>在线充值<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>充值金额：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td><input name=\"txtAmount\" type=\"text\" id=\"txtAmount\" maxlength=\"20\" size=\"20\"/>注：请输入整数金额</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  </table>\r\n");
	XYBody.Append("<div class=\"content_action\">\r\n");
	XYBody.Append("<input name=\"but01\" type =\"submit\" value=\"确定\" onclick =\"return CheckAccountRecharge('smallLay');\" class =\"button\" />\r\n");
	...
	XYBody.Append("</form>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<div id=\"smallLay\" class=\"smallLay_pay\" style=\"display: none;\">\r\n");
	XYBody.Append("        <ul>\r\n");
	XYBody.Append("            <li class=\"smallLay_pay_t\"><h4>系统提示</h4></li>\r\n");
	XYBody.Append("            <li class=\"smallLay_pay_c\">正在充值，充值完成请点击关闭。注意：如充值失败，请重新输入金额进行充值！</li>\r\n");
	XYBody.Append("            <li class=\"smallLay_pay_b\">\r\n");
	XYBody.Append("                <input type=\"button\" id=\"close_pay\" value=\"关闭\" />\r\n");
	XYBody.Append("            </li>\r\n");
	XYBody.Append("        </ul>\r\n");
	XYBody.Append("    </div>\r\n");
