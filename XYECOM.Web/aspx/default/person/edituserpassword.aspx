<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.edituserpassword,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>修改用户密码<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>登陆名：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td><input   name=\"username\" type=\"text\" value=\"");	XYBody.Append(userinfo.loginname.ToString());	XYBody.Append("\" id=\"username\" maxlength=\"20\" size=\"35\" disabled=\"disabled\" /></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>原密码：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("     <input  name=\"oldpad\" type=\"password\" value=\"\" id=\"oldpad\" maxlength=\"20\" size=\"40\" />\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>新密码：<em class=\"red\">*</em>\r\n");
	XYBody.Append("	</th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("     <input  name=\"pwd\" type=\"password\" value=\"\" id=\"pwd\" maxlength=\"20\" size=\"40\" />\r\n");
	XYBody.Append("     <em>建议采用易记,难猜的英文数字组合 6-20 个字符，只允许数字和英文字母，有大小写区分。</em>\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>确认新密码：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("     <input name=\"pwd1\" type=\"password\" value=\"\" id=\"pwd1\" maxlength=\"20\" size=\"40\" />\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("  </tr>  \r\n");
	XYBody.Append("  </table>\r\n");
	XYBody.Append("<div class=\"content_action\"><input name=\"\" type =\"submit\" value=\" 确定\" onclick =\"return ispasswore();\" class =\"button\" />\r\n");
