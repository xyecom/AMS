<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.remit,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        <caption>汇款确认<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>汇款人姓名：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input id=\"R_Name\" name=\"R_Name\" type=\"text\" size=\"30\" maxlength=\"50\" value=\"");	XYBody.Append(linkman.ToString());	XYBody.Append("\" /></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>联系Email：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input id=\"R_Email\" name=\"R_Email\" type=\"text\" class=\"\" size=\"30\" maxlength=\"50\" value=\"");	XYBody.Append(mail.ToString());	XYBody.Append("\" /></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>联系电话：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("              <input id=\"guohao\" maxlength=\"20\" name=\"guohao\" size=\"20\" type=\"text\"  value=\"");	XYBody.Append(Telephone.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("          </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>汇款时间：<em class=\"red\">*</em>\r\n");
	XYBody.Append("        </th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("         <input id=\"Text1\"  onclick=\"getDateString(this);\" class=\"edline\" name=\"R_Time\" readonly=\"readonly\"/></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>汇入银行：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input id=\"R_Bank\" name=\"R_Bank\" type=\"text\" class=\"\" size=\"50\" maxlength=\"50\" /></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>汇入卡号：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input id=\"R_Account\" name=\"R_Account\" type=\"text\"  size=\"50\" maxlength=\"20\" /></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>收款人姓名：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input id=\"R_CName\" name=\"R_CName\" type=\"text\"  size=\"30\" maxlength=\"50\" /> </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th >汇出卡号：</th>\r\n");
	XYBody.Append("        <td><input id=\"R_CAccount\" name=\"R_CAccount\" type=\"text\" size=\"50\" maxlength=\"20\" /></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("        <th>金额：<em class=\"red\">*</em>\r\n");
	XYBody.Append("        <span>（元）请在您转款金额后面填加小数点，（如：100.01）以便更快确认您的款项，为您操作入帐！</span>\r\n");
	XYBody.Append("        </th>\r\n");
	XYBody.Append("        <td><input id=\"R_Money\" name=\"R_Money\" type=\"text\"  size=\"20\" maxlength=\"50\" />\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        </table>\r\n");
	XYBody.Append("    <div class=\"content_action\"><input name=\"but01\" type =\"submit\" value=\" 确定\" onclick =\"return remitadd();\" class =\"button\" />\r\n");
	XYBody.Append("    <input name=\"but02\" type=\"button\" value=\"取消\" onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("person/index.");	XYBody.Append(config.Suffix);	XYBody.Append("';\"  class =\"button\"/></div> \r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
