<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.receivemessagelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append(" <li class=\"out\"><a  href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("person/receiveoffermessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商业信息留言</a></li>\r\n");
	XYBody.Append(" <li class=\"out\"><a  href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("person/receiveinvestmentmessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">系统留言</a></li>\r\n");
	XYBody.Append(" </ul>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</div>\r\n");
	...
	XYBody.Append("  <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/person/images/ly_img3.gif\" />\r\n");

	}
	else
	{

	XYBody.Append("   <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/person/images/ly_img2.gif\" />\r\n");
