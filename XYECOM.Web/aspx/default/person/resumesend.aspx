<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.resumesend,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("      <caption>您共申请了<em>(");	XYBody.Append(Countss.ToString());	XYBody.Append(")</em>职位！</caption> \r\n");
	XYBody.Append("     <thead>\r\n");
	XYBody.Append("	      <tr>	    \r\n");
	XYBody.Append("	          <th style=\"height: 20px;\">选者</th>\r\n");
	XYBody.Append("	          <th style=\"height: 20px\">单位名称</th>\r\n");
	XYBody.Append("		      <th style=\"height: 20px\" >申请职位</th>		  \r\n");
	XYBody.Append("		      <th style=\"height: 20px\" >申请时间</th>\r\n");
	XYBody.Append("		       <th style=\"height: 20px\" >对方状态</th>	\r\n");
	XYBody.Append("	      </tr>\r\n");
	XYBody.Append("      </thead>\r\n");
	XYBody.Append("      <tbody>\r\n");
	...
	XYBody.Append(" http://" + sd["U_Name"].ToString().Trim() + ".");	XYBody.Append(domainhost.ToString());	XYBody.Append("/\r\n");
	...
	XYBody.Append("      \" target=\"_blank\" >" + sd["UI_Name"].ToString().Trim() + "</a>\r\n");
	XYBody.Append("      </td>\r\n");
	XYBody.Append("      <td><a href=\"\r\n");

	if (sd["EI_HtmlPage"].ToString().Trim()!="")
	{

	XYBody.Append("" + sd["EI_HtmlPage"].ToString().Trim() + "\r\n");
	...
	XYBody.Append(" http://" + sd["U_Name"].ToString().Trim() + ".");	XYBody.Append(domainhost.ToString());	XYBody.Append("/job-" + sd["EI_ID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\r\n");

	}
	else
	{

	XYBody.Append("http://" + sd["U_Name"].ToString().Trim() + ".");	XYBody.Append(domainhost.ToString());	XYBody.Append("/job.");	XYBody.Append(config.Suffix);	XYBody.Append("?u_name=" + sd["U_Name"].ToString().Trim() + "&id=" + sd["EI_ID"].ToString().Trim() + "\r\n");
	...
	XYBody.Append("");	XYBody.Append(config.WebURL);	XYBody.Append("shop/" + sd["U_Name"].ToString().Trim() + "/job-" + sd["EI_ID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\r\n");

	}
	else
	{

	XYBody.Append("");	XYBody.Append(config.WebURL);	XYBody.Append("shop/job.");	XYBody.Append(config.Suffix);	XYBody.Append("?u_name=" + sd["U_Name"].ToString().Trim() + "&id=" + sd["EI_ID"].ToString().Trim() + "\r\n");
	...
	XYBody.Append("      \" target=\"_blank\" >" + sd["EI_Job"].ToString().Trim() + "</a></td>  \r\n");
	XYBody.Append("      <td>\r\n");
	XYBody.Append( Method.formatdatetime(sd["RE_AddDate"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("      <td>\r\n");
