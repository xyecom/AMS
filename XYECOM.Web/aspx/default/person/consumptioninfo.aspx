<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.consumptioninfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("      <caption>现金消费明细列表</caption>\r\n");
	XYBody.Append("       <thead>\r\n");
	XYBody.Append("       <tr>\r\n");
	XYBody.Append("    <th width=\"10%\">消费编号</th>\r\n");
	XYBody.Append("    <th width=\"10%\">用户名</th>\r\n");
	XYBody.Append("         <th width=\"15%\">消费金额</th>\r\n");
	XYBody.Append("      <th width=\"20%\">消费时间</th>\r\n");
	XYBody.Append("      <th width=\"45%\">消费说明</th>\r\n");
	XYBody.Append("       </tr>\r\n");
	XYBody.Append("       </thead>\r\n");
	XYBody.Append("       <tbody>\r\n");

	int CI__loop__id=0;
	foreach(DataRow CI in infolist.Rows)
	{
		CI__loop__id++;

	XYBody.Append("         <tr>\r\n");
	XYBody.Append("	      <td>" + CI["AC_ID"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("    <td>" + CI["U_Name"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("          <td>" + CI["AC_Count"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("          <td>" + CI["AC_Time"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("          <td>\r\n");
	XYBody.Append( Method.left(CI["AC_Explain"].ToString().Trim(),40));
	XYBody.Append("</td>\r\n");
	XYBody.Append("         </tr>\r\n");
