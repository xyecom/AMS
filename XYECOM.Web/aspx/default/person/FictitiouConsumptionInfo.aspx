<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.fictitiouconsumptioninfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>网站币消费明细</caption> \r\n");
	XYBody.Append("    <thead>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>消费编号</th>\r\n");
	XYBody.Append("     <th>用户名</th>\r\n");
	XYBody.Append("     <th>消费金额</th>\r\n");
	XYBody.Append("     <th>消费时间</th>\r\n");
	XYBody.Append("     <th>消费说明</th>    \r\n");
	XYBody.Append("   </tr>\r\n");
	XYBody.Append("   </thead>\r\n");
	XYBody.Append("   <tbody>\r\n");

	int uc__loop__id=0;
	foreach(DataRow uc in infolist.Rows)
	{
		uc__loop__id++;

	XYBody.Append("     <tr>\r\n");
	XYBody.Append("       <td>" + uc["FC_ID"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("      <td>" + uc["U_Name"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("      <td>" + uc["FC_Count"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("      <td>" + uc["FC_Time"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("	   <td>\r\n");
	XYBody.Append( Method.left(uc["FC_Explain"].ToString().Trim(),40));
	XYBody.Append("</td>\r\n");
	XYBody.Append("     </tr>\r\n");
