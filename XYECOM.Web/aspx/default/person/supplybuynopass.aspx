<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.supplybuynopass,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                <a class=\"button\" href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/adv_postbuy.aspx?ID=" + SD["SD_ID"].ToString().Trim() + "\">修改</a>\r\n");
	XYBody.Append("<!--                    <input type=\"button\" class=\"button\" value=\"修改\" onclick=\"location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/adv_post.aspx?ID=" + SD["SD_ID"].ToString().Trim() + "';\" />-->\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
