<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.individualinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("      <caption><span>个人基本信息（*为必填项）</span></caption>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>用户名：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("	    <input  name=\"username\" type=\"text\" value=\"");	XYBody.Append(userinfo.loginname.ToString());	XYBody.Append("\" id=\"username\" maxlength=\"20\" size=\"30\" disabled=\"disabled\" />	\r\n");
	XYBody.Append("	    <em>用户名是唯一不可修改的</em>\r\n");
	XYBody.Append("	    </td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("         <tr>\r\n");
	XYBody.Append("        <th>真实姓名：<em class=\"red\">*</em><span></span></th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("	    <input  name=\"txtname\" type=\"text\" id=\"txtname\" maxlength=\"20\" size=\"30\"  value=\"");	XYBody.Append(userinfo.realname.ToString());	XYBody.Append("\"/><input id=\"sexy\" type=\"radio\" value=\"1\" onclick =\"shousex(1);\"/>先生<input id=\"sexn\" type=\"radio\" value =\"0\"  onclick =\"shousex(2);\"/>女士\r\n");
	XYBody.Append("            <input type =\"hidden\" id=\"sext\"  name=\"sext\" />	\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("       <tr>\r\n");
	XYBody.Append("       <th>注册邮箱：<em class=\"red\">*</em> </th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("         <input id=\"email\"  maxlength=\"35\" type=\"text\" value=\"");	XYBody.Append(userinfo.email.ToString());	XYBody.Append("\" name =\"email\" size =\"35\"  onchange=\"validateemail(this);\"/>\r\n");
	XYBody.Append("         </td>\r\n");
	XYBody.Append("      </tr>  \r\n");
	XYBody.Append("       <tr>\r\n");
	XYBody.Append("     <th>上传照片提示：</th>\r\n");
	XYBody.Append("     <td>\r\n");
	...
	XYBody.Append("<br/></td></tr>\r\n");
	XYBody.Append("       <tr>\r\n");
	XYBody.Append("        <th>\r\n");
	XYBody.Append("            身份证号：</th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("         <input  name=\"txtcode\" type=\"text\" value=\"");	XYBody.Append(userinfo.idcode.ToString());	XYBody.Append("\" id=\"txtcode\" maxlength=\"18\" size=\"20\" /></td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>手机：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("         <input  name=\"txtMobile\" type=\"text\" value=\"");	XYBody.Append(userinfo.mobile.ToString());	XYBody.Append("\" id=\"txtMobile\" maxlength=\"66\" size=\"60\"  />\r\n");
	XYBody.Append("          <em>多个号码之间请用','号（逗号）隔开</em>\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>\r\n");
	XYBody.Append("            联系电话：</th>\r\n");
	XYBody.Append("        <td>     \r\n");
	XYBody.Append("          <input id=\"txtphone\" maxlength=\"100\" size=\"60\" name=\"txtphone\" type=\"text\"  value=\"");	XYBody.Append(userinfo.telephone.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("          <em>格式：010-88888888,多个号码之间请用','号（逗号）隔开</em>\r\n");
	XYBody.Append("	     </td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("    <th>\r\n");
	...
	XYBody.Append("        <td>\r\n");
	XYBody.Append("         <input id=\"txtpostcard\" maxlength=\"6\" type=\"text\" value=\"");	XYBody.Append(userinfo.zipcode.ToString());	XYBody.Append("\" name =\"txtpostcard\" size =\"10\"/>\r\n");
	XYBody.Append("         </td>\r\n");
	XYBody.Append("      </tr> \r\n");
	XYBody.Append("      <tr>\r\n");
	...
	XYBody.Append("         <input  name=\"txtaddress\" type=\"text\" value=\"");	XYBody.Append(userinfo.address.ToString());	XYBody.Append("\" id=\"txtaddress\" maxlength=\"20\" size=\"60\" /></td>\r\n");
	XYBody.Append("      </tr> \r\n");
	XYBody.Append("      </table>\r\n");
	XYBody.Append("    <input type=\"hidden\" id=\"oldEmail\" value=\"");	XYBody.Append(userinfo.email.ToString());	XYBody.Append("\" name=\"oldEmail\" />\r\n");
	XYBody.Append("    <input type =\"hidden\" id=\"type\" value =\"update\" name =\"type\"/>\r\n");
	XYBody.Append("    <div class=\"content_action\">\r\n");
	XYBody.Append("        <nobr>\r\n");
	XYBody.Append("        <input name=\"but01\" type =\"submit\" value=\"确定\" onclick =\"return Individualinfo();\" class =\"button\" />\r\n");
	XYBody.Append("        <input name=\"but02\" type=\"button\" value=\"取消\" onclick =\"window.location.href='/person/index.");	XYBody.Append(config.Suffix);	XYBody.Append("'\"  class =\"button\"/>\r\n");
	XYBody.Append("        </nobr>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div> \r\n");
