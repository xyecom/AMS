<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.person.postadministratormessage,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>给管理员留言<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("  <th >留言标题：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("  <td >\r\n");
	XYBody.Append("      <input id=\"messtitle\" style=\"width: 380px\" type=\"text\" name =\"messtitle\"  maxlength =\"400\"/></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>留言内容：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        <textarea id=\"admincontent\" cols=\"65\" rows=\"15\" name=\"admincontent\"></textarea></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("   </table>\r\n");
	XYBody.Append("<div class=\"content_action\"><input name=\"\" type =\"submit\" value=\" 确定\" onclick =\"return getpostadministrator();\" class =\"button\" />\r\n");
