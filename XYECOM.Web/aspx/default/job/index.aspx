<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.job.index,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("		<div id=\"left\">\r\n");
	XYBody.Append("			<div class=\"area1 jobarea\">\r\n");
	XYBody.Append("				<div class=\"hd\">\r\n");
	XYBody.Append("					<div class=\"tit\">\r\n");
	XYBody.Append("						<span class=\"fright\"><a href=\"\" class=\"black\">更多&raquo;</a></span>\r\n");
	XYBody.Append("						<a href=\"\" class=\"h2_hr1\"><h2>推荐展会</h2></a>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cnt\">\r\n");
	XYBody.Append("					<div id=\"hr_best\">\r\n");
	XYBody.Append("						<ul>\r\n");
	XYBody.Append("							<li><a href=\"#\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp/pic_hr_compy1.jpg\" width=\"320\" height=\"60\" alt=\"\" /></a></li>\r\n");
	XYBody.Append("							<li><a href=\"#\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp/pic_hr_compy2.jpg\" width=\"320\" height=\"60\" alt=\"\" /></a></li>\r\n");
	XYBody.Append("							<li><a href=\"#\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp/pic_hr_compy3.jpg\" width=\"320\" height=\"60\" alt=\"\" /></a></li>\r\n");
	XYBody.Append("							<li><a href=\"#\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp/pic_hr_compy6.jpg\" width=\"320\" height=\"60\" alt=\"\" /></a></li>\r\n");
	XYBody.Append("							<div class=\"clr\"></div>\r\n");
	XYBody.Append("						</ul>\r\n");
	XYBody.Append("						<div class=\"clr\"></div>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div class=\"clr\"></div>\r\n");
	XYBody.Append("					<div id=\"best_exhi\">\r\n");
	XYBody.Append("						<ul>\r\n");
	XYBody.Append("							<li>\r\n");
	XYBody.Append("								<div class=\"lt\"><a href=\"\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp_pic_24.gif\" width=\"108\" height=\"58\" alt=\"\" /></a></div>\r\n");
	XYBody.Append("								<div class=\"rt\">\r\n");
	XYBody.Append("									<h3><a href=\"\" class=\"black\">第二届中国青岛国际厨具、餐具展览会</a></h3>\r\n");
	XYBody.Append("									<p><a href=\"\">餐具展览会于2009年6月7日在青岛国际会展中心圆满胜利闭幕。</a></p>\r\n");
	XYBody.Append("								</div>\r\n");
	XYBody.Append("								<div class=\"clr\"></div>\r\n");
	XYBody.Append("							</li>\r\n");
	XYBody.Append("							<li>\r\n");
	XYBody.Append("								<div class=\"lt\"><a href=\"\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp_pic_23.gif\" width=\"108\" height=\"58\" alt=\"\" /></a></div>\r\n");
	XYBody.Append("								<div class=\"rt\">\r\n");
	XYBody.Append("									<h3><a href=\"\" class=\"black\">第二届国际中国玻璃展销博览会</a></h3>\r\n");
	XYBody.Append("									<p><a href=\"\">第二届国际中国玻璃展销博览会第二届国际中国玻璃展销博览会</a></p>\r\n");
	XYBody.Append("								</div>\r\n");
	XYBody.Append("								<div class=\"clr\"></div>\r\n");
	XYBody.Append("							</li>\r\n");
	XYBody.Append("							<div class=\"clr\"></div>\r\n");
	...
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cnt\">\r\n");
	XYBody.Append("					<div class=\"joblist1\">\r\n");
	XYBody.Append("					    <ul>\r\n");
	XYBody.Append("						    " +  XYECOMCreateHTML("XY_JobIndex_ZhaoPinXinXi16").ToString() + "\r\n");
	XYBody.Append("						</ul>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("			</div>\r\n");
	...
	XYBody.Append("					<div class=\"tit\">\r\n");
	XYBody.Append("						<span class=\"fright\"><a href=\"\" class=\"black\">更多&raquo;</a></span>\r\n");
	XYBody.Append("						<a href=\"\" class=\"h2_hr3\"><h2>国际展会</h2></a>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cnt\">\r\n");
	XYBody.Append("					<div class=\"joblist1\">\r\n");
	XYBody.Append("						<ul>\r\n");
	XYBody.Append("						    " +  XYECOMCreateHTML("XY_JobIndex_QiuZhiXinXi16").ToString() + "\r\n");
	XYBody.Append("						</ul>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("			</div>\r\n");
	...
	XYBody.Append("                        var claPost = new ClassType(\"claPost\",'job','classType','typeid');\r\n");
	...
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div class=\"MTitle_01\">\r\n");
	XYBody.Append("				<h2 id=\"h201\" class=\"\"><a target=\"_blank\" href=\"#\"><strong>人才搜索</strong></a></h2>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div id=\"con01\" class=\"Mblk_01\">\r\n");
	XYBody.Append("				<div class=\"expo_sch\">\r\n");
	XYBody.Append("				<table>\r\n");
	XYBody.Append("				    <tr>\r\n");
	XYBody.Append("					        <td>职位关键字:</td>\r\n");
	XYBody.Append("					        <td><input type=\"text\" id=\"jobkeyword\" onblur=\"isnonull();\"/></td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("						    <td>毕业学校:</td>\r\n");
	XYBody.Append("						    <td><input type=\"text\" id=\"schoolname\"  onblur=\"isnonull();\"/></td>					    \r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					    <td>期望城市:</td>\r\n");
	XYBody.Append("					    <td><span id=\"Span2\"></span>\r\n");
	XYBody.Append("					    <input type =\"hidden\" id=\"hopecityid\"  name=\"hopecityid\" />\r\n");
	XYBody.Append("                        <script type=\"text/javascript\">\r\n");
	XYBody.Append("                        var claArea1 = new ClassType(\"claArea1\",'area','Span2','hopecityid',1);\r\n");
	XYBody.Append("                        claArea1.Mode = \"select\";\r\n");
	XYBody.Append("                        claArea1.Init();\r\n");
	XYBody.Append("                        </" + "script>\r\n");
	XYBody.Append("                        </td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                    <tr>\r\n");
	...
	XYBody.Append("					     <td>\r\n");
	XYBody.Append("					     <select id=\"Schoolage\">\r\n");
	XYBody.Append("	                     <option value=\"1\" selected>不限</option>\r\n");
	...
	XYBody.Append("                         <option value=\"本科\" >本科</option>\r\n");
	...
	XYBody.Append("						<td><input type=\"text\" name=\"Intentpay1\" maxlength=\"6\" size=\"6\"/>~<input type=\"text\" name=\"Intentpay2\" maxlength=\"6\" size=\"6\"/></td>\r\n");
	XYBody.Append("					</tr>\r\n");
	XYBody.Append("					<tr>\r\n");
	XYBody.Append("					    <td colspan=2>　　\r\n");
	XYBody.Append("					        <img  onclick=\"ResumeListSearch();\" src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/btn_expo_sch.gif\" />\r\n");
	XYBody.Append("					    </td>\r\n");
	XYBody.Append("				    </tr>\r\n");
	XYBody.Append("				</table>\r\n");
	XYBody.Append("				</div>\r\n");
	...
	XYBody.Append("				<a href=\"/user\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/btn_hr_1.gif\" width=\"125\" height=\"37\" alt=\"\" /></a> &nbsp; <a href=\"/person\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/btn_hr_2.gif\" width=\"125\" height=\"37\" alt=\"\" /></a>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div class=\"MTitle_01\" style=\"margin-top:6px;\">\r\n");
	XYBody.Append("				<h2 id=\"h201\" class=\"\"><a target=\"_blank\" href=\"#\"><strong>优秀人才</strong></a></h2>\r\n");
	XYBody.Append("			</div>\r\n");
	...
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div class=\"MTitle_01\">\r\n");
	XYBody.Append("				<h2 id=\"h201\" class=\"\"><a target=\"_blank\" href=\"#\"><strong>展会动态</strong></a></h2>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div id=\"con01\" class=\"Mblk_01\">\r\n");
