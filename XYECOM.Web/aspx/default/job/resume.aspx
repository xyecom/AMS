<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.job.resume,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("		<div id=\"left\">\r\n");
	XYBody.Append("			<div class=\"resumeInfo\">\r\n");
	XYBody.Append("            <table>\r\n");
	XYBody.Append("                <caption style=\"text-align:left; font-size:16px; font-weight:bold;\">简历信息</caption>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td width=\"20%\">毕业学校：</td>\r\n");
	XYBody.Append("                    <td width=\"80%\">");	XYBody.Append(resumeInfo.RE_School.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>所学专业：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_Speciality.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>毕业时间：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_Gyear.ToShortDateString().ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>教育程度：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_Schoolage.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>职位：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_Intentjob.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>薪水要求：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_Intentpay.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>期望所在城市：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(ainfo.Name.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>工作年限：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_JobYear.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>工作经验：</td>\r\n");
	XYBody.Append("                    <td>");	XYBody.Append(resumeInfo.RE_Experience.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                </tr>\r\n");
	XYBody.Append("            </table> \r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("		</div>\r\n");
	XYBody.Append("		<div id=\"right\" style=\"width:270px;\">\r\n");
	XYBody.Append("			<div class=\"pages_bnr\"><a href=\"\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/images/temp_bnr_6.gif\" width=\"267\" height=\"241\" alt=\"\" /></a></div>\r\n");
	XYBody.Append("		</div>\r\n");
	XYBody.Append("		<div class=\"clr\"></div>\r\n");
	XYBody.Append("	</div>\r\n");
	XYBody.Append("	<div id=\"news_pages_btm2\" class=\"spacer\"></div>\r\n");
