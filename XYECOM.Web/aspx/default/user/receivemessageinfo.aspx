<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.receivemessageinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<div class=\"remsgTitle\">回复留言</div>\r\n");
	...
	XYBody.Append("  <td><input type=\"text\" size=\"80\"  id=\"rmesstitle\" name=\"rmesstitle\" value =\"");	XYBody.Append(rtitle.ToString());	XYBody.Append("\"  maxlength =\"600\"  disabled =\"disabled\"/></td>\r\n");
	XYBody.Append(" </tr>\r\n");
	XYBody.Append(" <tr>\r\n");
	XYBody.Append("  <th>正文：</th>\r\n");
	XYBody.Append("  <td><textarea name=\"rcontent\" cols=\"80\" rows=\"8\" id=\"rcontent\"></textarea>\r\n");
	XYBody.Append("  <br/>本留言系统不支持html代码，请不要在文本框中输入thml代码</td>\r\n");
	XYBody.Append(" </tr>\r\n");
	XYBody.Append("</table>\r\n");
	XYBody.Append("<table class=\"content_action\">\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("            <input type=\"submit\" class =\"button\"  value=\"确定\"  onclick =\"return huifumessage();\"/> <input type=\"button\" class =\"button\" value=\"取消\"  onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.aspx'\"/>\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("</table>\r\n");
