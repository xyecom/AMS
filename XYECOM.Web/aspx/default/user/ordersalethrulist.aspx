<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.ordersalethrulist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("				<option value=\"10\" 	>交易成功</option>\r\n");
	XYBody.Append("				<option value=\"11\" 	>交易失效</option>\r\n");
	XYBody.Append("				<option value=\"9\" 	>退货成功</option>\r\n");
	XYBody.Append("				<option value=\"12\" 	>退货失败</option>\r\n");
	XYBody.Append("					</select> \r\n");
	...
	XYBody.Append("		  <th style=\"height: 20px\">结束时间</th>		  \r\n");
	...
	XYBody.Append("    <td>" + sd["OF_AdateTime"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("    <td >\r\n");

	if (sd["OF_Type"].ToString().Trim()=="11")
	{
	...
	if (sd["OF_Type"].ToString().Trim()=="10")
	{
	...
	if (sd["OF_Type"].ToString().Trim()=="12")
	{
