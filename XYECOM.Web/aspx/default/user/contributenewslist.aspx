<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.contributenewslist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        基本设置</a> &gt; 公司动态管理</div>\r\n");
	...
	XYBody.Append("        <thead>\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <th width=\"8%\">\r\n");
	XYBody.Append("                    选择\r\n");
	XYBody.Append("                </th>\r\n");
	XYBody.Append("                <th width=\"57%\">\r\n");
	XYBody.Append("                    标 题\r\n");
	XYBody.Append("                </th>\r\n");
	...
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + n["NS_ID"].ToString().Trim() + "\" />\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append( Method.left(n["NS_NewsName"].ToString().Trim(),40));
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    " + n["NS_AddTime"].ToString().Trim() + "\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/editnew.");	XYBody.Append(config.Suffix);	XYBody.Append("?NS_ID=" + n["NS_ID"].ToString().Trim() + "&isflag=1\">修改</a>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
