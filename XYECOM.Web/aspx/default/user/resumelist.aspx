<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.resumelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>职位：");	XYBody.Append(el_name.ToString());	XYBody.Append(" 共有<em>(");	XYBody.Append(count.ToString());	XYBody.Append(")</em>份简历！</caption> \r\n");
	XYBody.Append(" <thead>\r\n");
	XYBody.Append("	  <tr>	    \r\n");
	XYBody.Append("	      <th style=\"height: 20px;\">选者</th>\r\n");
	XYBody.Append("	      <th style=\"height: 20px\">姓名</th>\r\n");
	XYBody.Append("		  <th style=\"height: 20px\" >手机</th>\r\n");
	XYBody.Append("		  <th style=\"height: 20px\" >\r\n");
	XYBody.Append("              联系方式</th>\r\n");
	XYBody.Append("		  <th style=\"height: 20px\" >工作年限</th>\r\n");
	XYBody.Append("		  <th style=\"height: 20px\" >专业</th>\r\n");
	XYBody.Append("		   <th style=\"height: 20px\" >学历</th>	\r\n");
	XYBody.Append("		  <th style=\"height: 20px\" > 简历投放时间</th>	\r\n");
	...
	XYBody.Append("  <tr> \r\n");
	XYBody.Append("   <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + sd["ER_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("  <td>" + sd["UI_LinkMan"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("  <td>" + sd["UI_Mobil"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("  <td>" + sd["U_Address"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("  <td>" + sd["RE_JobYear"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("  <td>" + sd["RE_Speciality"].ToString().Trim() + "</td>  \r\n");
	XYBody.Append("  <td>" + sd["RE_Schoolage"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("  <td>" + sd["RE_AddDate"].ToString().Trim() + "</td>  \r\n");
	XYBody.Append("  <td>\r\n");

	if (sd["RE_Estate"].ToString().Trim()=="1")
	{
	...
	if (sd["RE_Estate"].ToString().Trim()=="2")
	{
	...
	if (sd["RE_Estate"].ToString().Trim()=="3")
	{
	...
	if (sd["RE_Estate"].ToString().Trim()=="4")
	{
	...
	XYBody.Append("    </td>\r\n");
	XYBody.Append("  <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/resumeinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?RE_ID=" + sd["ER_ID"].ToString().Trim() + "\"> 查看</a></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	...
	XYBody.Append("<tr >\r\n");
	XYBody.Append("<td >\r\n");
	XYBody.Append("<input id=\"chkAll\" name=\"chkAll\" type=\"checkbox\" value=\"\" onclick=\"CheckedAll();\"/>全选所有信息\r\n");
	XYBody.Append("<input name=\"Supply\"  class=\"button\" type=\"submit\" value=\"删除\"  onclick=\"return bntDelete()\"/>\r\n");
	XYBody.Append("<input type=\"hidden\" id=\"isDelete\" value=\"Delete\" />\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
