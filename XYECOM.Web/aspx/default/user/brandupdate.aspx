<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.brandupdate,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("               <caption>修改品牌信息 <span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("               <tr>\r\n");
	XYBody.Append("                <th>品牌名称：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                 <input  name=\"txtname\"  type =\"text\" id=\"txtname\" maxlength=\"100\" size=\"50\" value=\"");	XYBody.Append(brandinfo.Title.ToString());	XYBody.Append("\" /> </td>\r\n");
	XYBody.Append("               </tr>\r\n");
	XYBody.Append("               <tr>\r\n");
	XYBody.Append("                <th>品牌类别：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                <input type =\"hidden\" id=\"supplyid\"  name=\"supplyid\" value=\"");	XYBody.Append(brandinfo.SortID.ToString());	XYBody.Append("\" /> <input type =\"hidden\" id=\"ptype\"  name=\"ptype\" value=\"1\"/>\r\n");
	XYBody.Append("                                       <div id=\"classType\"></div>\r\n");
	XYBody.Append("                                    <script type=\"text/javascript\">\r\n");
	XYBody.Append("                                    var cla = new ClassType(\"cla\",'brand','classType','supplyid');\r\n");
	...
	XYBody.Append("               </tr>\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                <th>发布时间：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                 <input  name=\"addtime\"  type =\"text\" id=\"addtime\"  size=\"30\" value=\"");	XYBody.Append(brandinfo.PublishTime.ToString());	XYBody.Append("\" disabled=\"disabled\" /> </td>\r\n");
	XYBody.Append("              </tr>\r\n");
	XYBody.Append("            <tr><th>品牌大图：<em class=\"red\">*</em></th><td>\r\n");
	...
	XYBody.Append("             <tr>\r\n");
	XYBody.Append("             <th>品牌介绍：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("             <td>\r\n");
	...
	XYBody.Append("                var oFCKeditor = new FCKeditor('txtsm') ;\r\n");
	...
	XYBody.Append("             </tr>\r\n");
	XYBody.Append("          </table>\r\n");
	XYBody.Append("        <div class=\"content_action\"><input name=\"\" type =\"submit\" value=\" 确定\" onclick =\"return getbrand();\" class =\"button\" />\r\n");
