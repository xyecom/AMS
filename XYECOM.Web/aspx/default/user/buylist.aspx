<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buylist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <input type=\"submit\" name=\"submit_search\" value=\"查询\" class =\"button\"/>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </div> \r\n");
	...
	XYBody.Append("       <tr> \r\n");
	XYBody.Append("      <td ><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + SD["SD_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("        <td >\r\n");
	 infoimg = GetInfoImgHref(SD["SD_ID"].ToString());
	

	if (infoimg=="")
	{

	XYBody.Append("                <img src=\"/common/images/DefaultImg.gif\" alt=\"" + SD["SD_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}
	else
	{

	XYBody.Append("                <img src=\"");	XYBody.Append(infoimg.ToString());	XYBody.Append("\" alt=\"" + SD["SD_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}	//end if

	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td >\r\n");
	 infourl = GetInfoUrl(module.EName,SD["SD_Flag"].ToString(),SD["SD_ID"].ToString());
	
	XYBody.Append("            <a href=\"");	XYBody.Append(infourl.ToString());	XYBody.Append("\" target =\"_blank\">\r\n");
	XYBody.Append( Method.left(SD["SD_Title"].ToString().Trim(),20));
	XYBody.Append("</a>\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td class=\"wbg_setTime\">" + SD["SD_PublishDate"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td style=\"text-align:center;\">\r\n");

	if (SD["SD_IsSupply"].ToString().Trim()=="True")
	{
	...
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td class=\"wbg_clicknum\">" + SD["SD_ClickNum"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td class=\"orange\"><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?type=venture&InfoID=" + SD["SD_ID"].ToString().Trim() + "\"><em class=\"wbg_messageNum\">" + SD["SD_MessageNum"].ToString().Trim() + "</em></a> 条&nbsp;</td>\r\n");
	XYBody.Append("       <td><input type =\"button\" class =\"button\"  value =\"修改\" onclick =\"location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/adv_post.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("&flag=" + SD["SD_Flag"].ToString().Trim() + "&info_ID=" + SD["SD_ID"].ToString().Trim() + "';\"></td>\r\n");
	XYBody.Append("      </tr>\r\n");
	...
	XYBody.Append("    <input name=\"Supply\"  type=\"submit\" class=\"button\" value=\"启用\"  onclick =\"return resh(3);\"/>\r\n");
	XYBody.Append("    <input name=\"Supply\"  type=\"submit\" class=\"button\" value=\"暂停\" onclick =\"return resh(2);\" />\r\n");
