<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.companysee,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>联系人信息</caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>Email：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.RegInfo.Email.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>姓名：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.LinkMan.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>固定电话：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Telephone.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("   </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("   <th>传真号码：</th>\r\n");
	XYBody.Append("    <td >");	XYBody.Append(info.Fax.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>邮政编码：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Postcode.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("   </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>所在部门：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Section.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>职位：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Post.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>手机：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Mobile.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>联系地址：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Address.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  </table>\r\n");
	XYBody.Append(" <table class=\"contentl\">\r\n");
	XYBody.Append("  <caption>公司详细信息</caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>企业名称：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Name.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>所在区域：</th>\r\n");
	XYBody.Append("    <td>\r\n");

	if (info.AreaInfo!=null)
	{

	XYBody.Append("    ");	XYBody.Append(info.AreaInfo.Name.ToString());	XYBody.Append("\r\n");
	...
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>企业网址：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.HomePage.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>联系地址：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Address.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>企业性质：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Character.ToString());	XYBody.Append("	&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>企业类别：</th>\r\n");
	XYBody.Append("    <td>\r\n");

	if (info._UserTypeInfo!=null)
	{

	XYBody.Append("    ");	XYBody.Append(info._UserTypeInfo.UT_Type.ToString());	XYBody.Append("\r\n");
	...
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>员工人数：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.EmployeeTotal.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>供应产品/服务：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.SupplyPro.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append(" </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>需求产品/服务：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.BuyPro.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>注册资金：</th>\r\n");
	XYBody.Append("    <td >");	XYBody.Append(info.RegisteredCapital.ToString());	XYBody.Append("&nbsp;</td>    \r\n");
	XYBody.Append(" </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("	<th>企业成立年份：</th>\r\n");
	XYBody.Append("    <td> ");	XYBody.Append(info.RegYear.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>企业经营模式：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Mode.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>主营产品/服务：</th>\r\n");
	XYBody.Append("    <td> ");	XYBody.Append(info.MainProduct.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>企业简介：</th>\r\n");
	XYBody.Append("    <td>");	XYBody.Append(info.Synopsis.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  </table>\r\n");
	XYBody.Append("<div class=\"content_action\">\r\n");
	XYBody.Append("<input name=\"submit\" type=\"button\" value=\"返回\" id=\"btnAdd\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/companys.");	XYBody.Append(config.Suffix);	XYBody.Append("'\" class =\"button\" />    \r\n");
	XYBody.Append(" </div>\r\n");
	XYBody.Append(" </form>\r\n");
	XYBody.Append(" </div>\r\n");
