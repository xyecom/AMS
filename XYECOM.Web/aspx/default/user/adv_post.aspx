<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.adv_post,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <a href=\"index.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商务中心</a> &gt; 修改商业信息</div>\r\n");
	...
	XYBody.Append("    <h3>\r\n");
	XYBody.Append("        修改商业信息</h3>\r\n");
	XYBody.Append("    <table class=\"contentl\">\r\n");

	if (module.Item.Count>0)
	{

	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                信息类型：<em>*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td id=\"tdinfotype\">\r\n");
	...
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                信息名称：<em>*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td class=\"two\">\r\n");
	XYBody.Append("                <input id=\"infotitle\" name=\"infotitle\" type=\"text\" size=\"28\" maxlength=\"50\" onchange=\"checkproductname(this);\"\r\n");
	XYBody.Append("                    value=\"");	XYBody.Append(ptname.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("                <em id=\"txt0\" class=\"three\">信息标题中请勿出现特殊字符、信息类型等内容。</em><input type=\"hidden\" id=\"hidmid\"\r\n");
	XYBody.Append("                    name=\"\" value=\"");	XYBody.Append(module.EName.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <input type=\"hidden\" id=\"hidMoueleName\" value=\"");	XYBody.Append(module.EName.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            <input type=\"hidden\" id=\"hidTypeId\" name=\"hidTypeId\" value=\"");	XYBody.Append(typeid.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                选择信息类别：<em>*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <div id=\"classType\">\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("                <script type=\"text/javascript\">\r\n");
	XYBody.Append("                    var cla = new ClassType(\"cla\", 'hidMoueleName', 'classType', 'hidTypeId', null, null, \"tradeids:");	XYBody.Append(userinfo.tradeids.ToString());	XYBody.Append("\");\r\n");
	XYBody.Append("                    cla.Mode = \"select\";\r\n");
	XYBody.Append("                    cla.OnClick = SelectTypeIDOnClick;\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                信息属性：<em>*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td id=\"tabFieldBody\">\r\n");
	XYBody.Append("                <table class=\"c1_table\" width=\"90%\">\r\n");
	XYBody.Append("                    ");	XYBody.Append(filedinnerhtml.ToString());	XYBody.Append("\r\n");
	XYBody.Append("                </table>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                详细说明：<em>*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                信息有效期：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input onclick=\"getDateString(this);\" id=\"EndDate\" maxlength=\"15\" readonly=\"readonly\"\r\n");
	XYBody.Append("                    name=\"EndDate\" /><input id=\"datetype\" type=\"hidden\" value=\"");	XYBody.Append(config.DateType);	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input type=\"radio\" value=\"10\" checked=\"checked\" name=\"rad\" />10天\r\n");
	...
	XYBody.Append("                <input type=\"radio\" value=\"180\" name=\"rad\" />6个月\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtsprice\" value=\"");	XYBody.Append(price.ToString());	XYBody.Append("\" />元\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtsunit\" value=\"");	XYBody.Append(unit.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtssmallnum\" value=\"");	XYBody.Append(smallnum.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtscountnum\" value=\"");	XYBody.Append(sumnum.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                是否支持在线交易：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");

	if (ispaymentvalue=="true")
	{

	XYBody.Append("                <input type=\"radio\" value=\"1\" name=\"rbIsPayMent\" checked=\"checked\" />支持\r\n");
	XYBody.Append("                <input type=\"radio\" value=\"0\" name=\"rbIsPayMent\" />不支持\r\n");

	}
	else
	{

	XYBody.Append("                <input type=\"radio\" value=\"1\" name=\"rbIsPayMent\" />支持\r\n");
	XYBody.Append("                <input type=\"radio\" value=\"0\" name=\"rbIsPayMent\" checked=\"checked\" />不支持\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                单价：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtcprice\" value=\"");	XYBody.Append(price.ToString());	XYBody.Append("\" />元\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                计量单位：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtcunit\" value=\"");	XYBody.Append(unit.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                最小起定量：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtcsmallnum\" value=\"");	XYBody.Append(smallnum.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                货物总量：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"10\" name=\"txtccountnum\" value=\"");	XYBody.Append(sumnum.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input type=\"radio\" id=\"citys\" name=\"rbcity\" onclick=\"showcityname(1);\" value=\"全国\" />全国\r\n");
	...
	XYBody.Append("                <input type=\"hidden\" id=\"city\" name=\"city\" value=\"");	XYBody.Append(area.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("                <script type=\"text/javascript\">\r\n");
	...
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr id=\"trq1\">\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                招商支持：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <textarea id=\"txtsupport\" name=\"txtsupport\" cols=\"80\" rows=\"10\">");	XYBody.Append(txtsupport.ToString());	XYBody.Append("</textarea>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr id=\"trq2\">\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                招商要求：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <textarea id=\"txtdemand\" name=\"txtdemand\" cols=\"80\" rows=\"10\">");	XYBody.Append(txtdemand.ToString());	XYBody.Append("</textarea>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr id=\"trq3\">\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                展示网址：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input maxlength=\"500\" name=\"pageurl\" id=\"pageurl\" value=\"");	XYBody.Append(txtUR.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr id=\"tro\">\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                代理过的品牌：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input type=\"text\" name=\"txtbrand\" value=\"");	XYBody.Append(beginname.ToString());	XYBody.Append("\" id=\"txtbrand\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	...
	XYBody.Append("        <input type=\"submit\" value=\"同意服务条款，我要发布\" class=\"button\" onclick=\"return CheckInfoFrom('");	XYBody.Append(module.EName.ToString());	XYBody.Append("','");	XYBody.Append(module.PEName.ToString());	XYBody.Append("');\" />\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <table class=\"contentl\">\r\n");
	XYBody.Append("        <caption>\r\n");
	XYBody.Append("            <i>\r\n");
	XYBody.Append("                <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/indexpoint.gif\" />\r\n");
	XYBody.Append("                <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/edituserinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("\" target=\"_blank\">点此修改</a></i>联系方式的确认与修改\r\n");
	XYBody.Append("            <a name=\"aegisAlipay5\" />若有误，您发布的信息将无法通过审核！ <a name=\"aegisAlipay6\" />\r\n");
	XYBody.Append("        </caption>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                姓名：\r\n");
	...
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <input type=\"hidden\" id=\"infotype\" name=\"infotype\" value=\"1\" />\r\n");
	XYBody.Append("    <input type=\"hidden\" id=\"infodate\" name=\"infodate\" value=\"10\" />\r\n");
	XYBody.Append("    <input type=\"hidden\" id=\"title\" />\r\n");
	XYBody.Append("    <input type=\"hidden\" id=\"pclist\" name=\"pclist\" value=\"");	XYBody.Append(provincelist.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    <input type=\"hidden\" id=\"hidename\" name=\"pclist\" value=\"");	XYBody.Append(module.EName.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    <div class=\"content_action\">\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
