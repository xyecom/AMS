<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.orderbuythrulist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("				<option value=\"11\" 	>过期失效</option>\r\n");
	XYBody.Append("				<option value=\"10\" 	>成功完成</option>\r\n");
	XYBody.Append("				<option value=\"9\" 	>退货成功</option>\r\n");
	XYBody.Append("				<option value=\"12\" 	>拒绝退货</option>					\r\n");
	XYBody.Append("					</select> \r\n");
	...
	XYBody.Append("	      <th >订单编号</th>	  \r\n");
	XYBody.Append("		  <th style=\"height: 20px\">\r\n");
	XYBody.Append("              货品名称</th>\r\n");
	XYBody.Append("		  <th  style=\"height: 20px\">\r\n");
	XYBody.Append("              卖家</th>\r\n");
	XYBody.Append("		  <th  style=\"height: 20px\">\r\n");
	XYBody.Append("              交易金额</th>\r\n");
	XYBody.Append("		  <th style=\"height: 20px\">\r\n");
	XYBody.Append("              结束时间</th>		  \r\n");
	XYBody.Append("		  <th style=\"height: 20px\">\r\n");
	XYBody.Append("              交易状态</th>\r\n");
	XYBody.Append("           <th style=\" height: 20px;\">\r\n");
	XYBody.Append("              查看</th>\r\n");
	XYBody.Append("	  </tr>\r\n");
	XYBody.Append("  </thead>\r\n");
	...
	if (sd["U_HtmlPage"].ToString().Trim()!="")
	{

	XYBody.Append("" + sd["U_HtmlPage"].ToString().Trim() + "\r\n");
	...
	XYBody.Append(" http://" + sd["U_Name"].ToString().Trim() + "domainhost/\r\n");
