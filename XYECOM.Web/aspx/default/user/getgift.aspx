<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.getgift,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <h3>\r\n");
	XYBody.Append("        您的当前积分可供兑换的礼品</h3>\r\n");
	...
	int dr__loop__id=0;
	foreach(DataRow dr in infolist.Rows)
	{
		dr__loop__id++;

	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>\r\n");
	 infoimg = GetInfoImgHref(dr["GId"].ToString());
	

	if (infoimg=="")
	{

	XYBody.Append("                        <img src=\"/common/images/DefaultImg.gif\" alt=\"" + dr["Name"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");
	...
	XYBody.Append("                        <img src=\"");	XYBody.Append(infoimg.ToString());	XYBody.Append("\" alt=\"" + dr["Name"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");
	XYBody.Append("                        </a>\r\n");
	...
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    " + dr["Name"].ToString().Trim() + "\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    " + dr["Amount"].ToString().Trim() + "\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    " + dr["Number"].ToString().Trim() + "\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/getgift.");	XYBody.Append(config.Suffix);	XYBody.Append("?gid=" + dr["GId"].ToString().Trim() + "\">兑换</a>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
