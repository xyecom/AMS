<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.selectshoptemp,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <form method=\"post\" id=\"tempForm\"  name=\"tempForm\">\r\n");
	XYBody.Append("    <ul class=\"seltabs\">\r\n");
	XYBody.Append("        <li class=\"current\" id=\"tmp_tab1\"><a href=\"javascript:;\" onclick=\"xy_selectBox(2,1,'tmp')\">当前模板</a></li>\r\n");
	XYBody.Append("        <li id=\"tmp_tab2\"><a href=\"javascript:;\" onclick=\"xy_selectBox(2,2,'tmp')\">选择模板</a></li>\r\n");
	XYBody.Append("    </ul>\r\n");
	XYBody.Append("    <!--当前模板-->\r\n");
	XYBody.Append("    <div id=\"tmp_box1\" style=\"display: block;width:100%;\">\r\n");
	 curTempInfo = GetCurTempInfo();
	
	XYBody.Append("        <div class=\"cur_temp\">\r\n");
	XYBody.Append("            <img src=\"");	XYBody.Append(curTempInfo.Image.ToString());	XYBody.Append("\" alt=\"\"/>\r\n");
	XYBody.Append("            <br/> ");	XYBody.Append(curTempInfo.CName.ToString());	XYBody.Append("\r\n");
	XYBody.Append("         </div>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <!--选择模板-->\r\n");
	XYBody.Append("    <div id=\"tmp_box2\" style=\"display: none;\">\r\n");
	 data = GetSkins();
	

	int skin__loop__id=0;
	foreach(DataRow skin in data.Rows)
	{
		skin__loop__id++;

	XYBody.Append("            <div class=\"tmp_sk_name\">" + skin["Name"].ToString().Trim() + "</div>\r\n");
	 data1 = GetThemes(skin["dir"]);
	
	XYBody.Append("            <div class=\"temp_con2\">\r\n");
	XYBody.Append("	        <ul>\r\n");

	int dttemp__loop__id=0;
	foreach(DataRow dttemp in data1.Rows)
	{
		dttemp__loop__id++;

	XYBody.Append("			        <li>\r\n");
	XYBody.Append("			        <a href=\"javascript:document.getElementById('curSelTempName').value='" + dttemp["filename"].ToString().Trim() + "';document.tempForm.submit();\"><img src=\"" + dttemp["img"].ToString().Trim() + "\" alt=\"单击选择\"/>\r\n");
	XYBody.Append("			        <br/> " + dttemp["cname"].ToString().Trim() + "\r\n");
	XYBody.Append("			        </a>\r\n");
	XYBody.Append("			        </li>\r\n");
	...
	XYBody.Append("        <input type=\"hidden\" name=\"curSelTempName\" id=\"curSelTempName\" value=\"\" />\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
