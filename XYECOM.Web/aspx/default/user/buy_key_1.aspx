<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buy_key_1,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<form   method=\"post\" action=\"buy_key_2.");	XYBody.Append(config.suffix);	XYBody.Append("\">\r\n");
	XYBody.Append("    <input type=\"hidden\" name=\"keyId\" value=\"");	XYBody.Append(keyid.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    <input type=\"hidden\" name=\"rank\" value=\"");	XYBody.Append(rank.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    <table class=\"contentl\">\r\n");
	XYBody.Append("      <caption>购买关键词<span>(指定要购买的时间)</span></caption>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>关键词：</th>\r\n");
	XYBody.Append("        <td>");	XYBody.Append(keyword.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("       <tr>\r\n");
	XYBody.Append("        <th>名次：</th>\r\n");
	XYBody.Append("        <td>");	XYBody.Append(rank.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>价格：</th>\r\n");
	XYBody.Append("        <td><span id=\"price\">");	XYBody.Append(price.ToString());	XYBody.Append("</span>");	XYBody.Append(moneyname.ToString());	XYBody.Append("/");	XYBody.Append(timeunits.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>购买时间：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input name=\"timecycle\" type=\"text\" value=\"1\" id=\"timecycle\" maxlength=\"2\" size=\"2\" onblur=\"_xy_BuyKey_RecalculatedPrice()\"/> ");	XYBody.Append(timeunits.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("      </tr>  \r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>支付总额：</th>\r\n");
	XYBody.Append("        <td id=\"amount\">");	XYBody.Append(amount.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      </table>\r\n");
	XYBody.Append("      <table class=\"contentl\">\r\n");
	XYBody.Append("          <caption>信息匹配结果<span>(从匹配结果中选择要展示的信息)</span></caption>\r\n");
	...
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <select name=\"");	XYBody.Append(item.EName.ToString());	XYBody.Append("\" style=\"width:350px;\">\r\n");
	 data = GetMatchData(item.CName);
	...
	int mdata__loop__id=0;
	foreach(DataRow mdata in data.Rows)
	{
		mdata__loop__id++;

	XYBody.Append("                            <option value=\"" + mdata["infoid"].ToString().Trim() + "\">" + mdata["infotitle"].ToString().Trim() + "</option>\r\n");
	...
	XYBody.Append("                        <option value=\"0\">没有匹配信息，请在完成购买后发布相关信息，并重新匹配</option>\r\n");
	...
	XYBody.Append("            <input name=\"\" type =\"submit\" value=\" 确定\" class =\"button\" />\r\n");
