<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.joinlist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<h2>\r\n");
	XYBody.Append("<span><a href=\"?nosee=0\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/ly_img3.gif\" />未读</a> | <a href=\"?nosee=1\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/ly_img2.gif\" />已读</a></span>\r\n");
	XYBody.Append("在线加盟\r\n");
	XYBody.Append("</h2>\r\n");
	XYBody.Append("<div class=\"ly_100\">\r\n");
	XYBody.Append("<div class=\"ly_tit3\">\r\n");
	XYBody.Append(" <ul>\r\n");
	XYBody.Append(" <li class=\"on\"><a  href =\"?\">所有留言</a></li>\r\n");
	XYBody.Append(" </ul>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<div class=\"ly_tit32\">\r\n");
	XYBody.Append("<select name=\"HasReply\" id=\"HasReply\">\r\n");
	...
	XYBody.Append("  <option value=\"1\">一个月内的信息</option>\r\n");
	XYBody.Append("<option value=\"2\">二个月内的信息</option>\r\n");
	XYBody.Append("<option value=\"3\">三个月内的信息</option>\r\n");
	XYBody.Append("</select>\r\n");
	XYBody.Append("<input type=\"submit\" class =\"button\" name=\"msg\" value=\"查询\"/>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<table class=\"ly_tab2 ly_w1\" id=\"joinlist\">\r\n");
	XYBody.Append("<thead><tr><td></td><td></td><td>标题</td><td>\r\n");
	...
	XYBody.Append(" <tr>\r\n");
	XYBody.Append("  <td><input name=\"ckid\" type=\"checkbox\" value=\"" + s["ID"].ToString().Trim() + "\"  name =\"sd_id\"/></td>\r\n");
	...
	if (s["HasReply"].ToString().Trim()=="False")
	{
	...
	XYBody.Append("  </td>\r\n");
	XYBody.Append("  <td>\r\n");
	XYBody.Append("    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/joinshow.");	XYBody.Append(config.Suffix);	XYBody.Append("?id=" + s["ID"].ToString().Trim() + "\">" + s["Title"].ToString().Trim() + "</a><br />" + s["AddTime"].ToString().Trim() + "\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("<td>\r\n");
	...
	XYBody.Append("    " + s["UI_LinkMan"].ToString().Trim() + "\r\n");

	}
	else
	{

	XYBody.Append("    " + s["InfoLinkMan"].ToString().Trim() + "\r\n");
	...
	XYBody.Append("<tr>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        <input id=\"chkAll\" name=\"chkAll\" type=\"checkbox\" value=\"\" onclick=\"SelectAll('joinlist',this);\"/>全选 <input name=\"message\"  class=\"button\" type=\"submit\" value=\"删除\"  onclick=\"return Delete('joinlist')\"/>\r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
