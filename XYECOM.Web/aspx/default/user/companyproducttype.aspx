<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.companyproducttype,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("     <h2>\r\n");
	XYBody.Append("        <span>\r\n");
	XYBody.Append("            <input name=\"newadd\"  class=\"button\" type=\"button\" value=\"新建分类\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/companyproducttypeadd.");	XYBody.Append(config.Suffix);	XYBody.Append("'\"/>\r\n");
	XYBody.Append("        </span>\r\n");
	XYBody.Append("        自定义产品分类管理\r\n");
	XYBody.Append("     </h2>\r\n");
	XYBody.Append("    <table class=\"content\">\r\n");
	XYBody.Append("        <div class=\"ly_tit3\"> \r\n");
	XYBody.Append("            <ul>\r\n");
	XYBody.Append("                <li class=\"on\">分类列表</li>\r\n");
	XYBody.Append("            </ul>\r\n");
	XYBody.Append("        </div>  \r\n");
	XYBody.Append("          <thead>\r\n");
	XYBody.Append("	          <tr>\r\n");
	XYBody.Append("	          <th width=\"10%\">选择</th>\r\n");
	XYBody.Append("	          <th width=\"55%\">分类名称</th>	  \r\n");
	XYBody.Append("	          <!--<th width=\"25%\">信息数量</th>-->\r\n");
	XYBody.Append("	          <th width=\"15%\">修改</th>  \r\n");
	XYBody.Append("	          </tr>\r\n");
	XYBody.Append("          </thead>\r\n");
	XYBody.Append("    <tbody>\r\n");
	...
	XYBody.Append("      <tr> \r\n");
	XYBody.Append("      <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + n["id"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("       <td>\r\n");
	XYBody.Append( Method.left(n["ptname"].ToString().Trim(),40));
	XYBody.Append("</td>\r\n");
	XYBody.Append("       <!--<td>" + n["infocount"].ToString().Trim() + "</td>-->\r\n");
	XYBody.Append("        <td> <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/companyproducttypeadd.");	XYBody.Append(config.Suffix);	XYBody.Append("?id=" + n["id"].ToString().Trim() + "\">修改</a></td>\r\n");
	XYBody.Append("      </tr>\r\n");
	...
	XYBody.Append("<!--<input name=\"sel\"  class=\"button\" type=\"button\" value=\"统计分类数据\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/companyproducttype.");	XYBody.Append(config.Suffix);	XYBody.Append("?stat=yes'\"/> -->\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
	XYBody.Append("<div class=\"page\"></div>\r\n");
