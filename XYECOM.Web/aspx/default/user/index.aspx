...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("            <img src=\"");	XYBody.Append(userinfo.logo.ToString());	XYBody.Append("\" alt=\"用户等级\" width=\"100px\" /></div>\r\n");
	XYBody.Append("        <a href=\"postadministratormessage.");	XYBody.Append(config.Suffix);	XYBody.Append("\">马上升级</a>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <div class=\"Am_2\">\r\n");
	XYBody.Append("        <div class=\"Am_21\">\r\n");
	XYBody.Append("            <div style=\"padding-right: 10px; float: left\">\r\n");
	XYBody.Append("                <span class=\"f14b\">");	XYBody.Append(userinfo.name.ToString());	XYBody.Append("</span> <a class=\"fi\" href=\"edituserinfo.");	XYBody.Append(config.suffix);	XYBody.Append("\">\r\n");
	XYBody.Append("                    编辑&gt;&gt;</a>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("            <br clear=\"all\">\r\n");
	XYBody.Append("            <div id=\"event1\">\r\n");
	XYBody.Append("                <span class=\"hui912\">");	XYBody.Append(userinfo.gradename.ToString());	XYBody.Append("</span> | 开通时间：<span style=\"font-family: Verdana, Arial, Helvetica, sans-serif;\r\n");
	XYBody.Append("                    color: #336600;\">");	XYBody.Append(starttime.ToString());	XYBody.Append("</span>&nbsp;\r\n");

	if (days!="")
	{

	XYBody.Append("离结束时间还有 <span style=\"font-family: Verdana, Arial, Helvetica, sans-serif;\r\n");
	XYBody.Append("                        color: #f60;\">");	XYBody.Append(days.ToString());	XYBody.Append("</span>天\r\n");
	...
	XYBody.Append("                <dt>姓名：</dt><dd><b>");	XYBody.Append(userinfo.linkman.ToString());	XYBody.Append("</b> (");	XYBody.Append(userinfo.sex.ToString());	XYBody.Append(")</dd>\r\n");
	XYBody.Append("                <dt>登录名：</dt><dd><a href=\"");	XYBody.Append(userinfo.shopindex.ToString());	XYBody.Append("/cred.");	XYBody.Append(config.suffix);	XYBody.Append("\" target=\"_blank\"><img\r\n");
	XYBody.Append("                    src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/cert2.gif\" alt=\"诚信资料\" /></a><b>&nbsp;");	XYBody.Append(userinfo.loginname.ToString());	XYBody.Append("</b>\r\n");
	XYBody.Append("                </dd>\r\n");
	XYBody.Append("                <dt>可用金额：</dt><dd><b><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/money.gif\" /><span\r\n");
	XYBody.Append("                    style=\"color: #f60;\">&nbsp;");	XYBody.Append(cash.ToString());	XYBody.Append("</span> 元\r\n");

	if (pageinfo.IsOnlinePayment)
	{

	XYBody.Append("<a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/accountrecharge.");	XYBody.Append(config.Suffix);	XYBody.Append("?burl=/user/index.");	XYBody.Append(config.Suffix);	XYBody.Append("\">在线充值</a>\r\n");

	}	//end if

	XYBody.Append("</b></dd>\r\n");
	XYBody.Append("                <dt>账户余额：</dt><dd><b><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/money.gif\" /><span\r\n");
	XYBody.Append("                    style=\"color: #f60;\">&nbsp;");	XYBody.Append(Balance.ToString());	XYBody.Append("</span> 元</b>\r\n");
	XYBody.Append("                </dd>\r\n");
	XYBody.Append("                <dt>虚拟币：</dt><dd><b><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/vm.png\" /><span\r\n");
	XYBody.Append("                    style=\"color: #f60;\">&nbsp;");	XYBody.Append(dummymoney.ToString());	XYBody.Append("</span> 个</b>(");	XYBody.Append(config.WebMoneyName);	XYBody.Append(")</dd>\r\n");
	XYBody.Append("            </dl>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("        <div>\r\n");
	XYBody.Append("            <div style=\"padding-right: 0px; margin-top: 50px; padding-left: 31px; background: url(");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/blog_bg.gif) no-repeat;\r\n");
	...
	XYBody.Append("                    <font color=\"#cc0000\">访问我的商铺</font></a>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("        <div style=\"width: 388px; padding: 5px; border-top: 1px solid #ddd\">\r\n");
	XYBody.Append("            <ul>\r\n");
	XYBody.Append("                <li>已冻结挂牌保证金: <b><span style=\"color: #f60;\">&nbsp;");	XYBody.Append(S_Margin.ToString());	XYBody.Append("</span> 元 </b></li>\r\n");
	XYBody.Append("                <li>已冻结合同保证金: <b><span style=\"color: #f60;\">&nbsp;");	XYBody.Append(C_Margin.ToString());	XYBody.Append("</span> 元</b></li>\r\n");
	XYBody.Append("                <li>可用合同保证金: <b>&nbsp;&nbsp;&nbsp;<span style=\"color: #f60;\">&nbsp;");	XYBody.Append(AC_Margin.ToString());	XYBody.Append("</span>\r\n");
	XYBody.Append("                    元</b></li>\r\n");

	if (isConMargin)
	{

	XYBody.Append("                    <b><span style=\"color: #f60;\">可用合同保证金不足请<a href=\"/user/ContractMargin/SupplementConMargin.aspx\">及时充值</a>，否则影响您的合同担保信息的交易</span>\r\n");
	XYBody.Append("                    </b>\r\n");
	...
	XYBody.Append("    <div class=\"Am_6\" style=\"background-image: url=(");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/forum_mini_icon.gif);\r\n");
	XYBody.Append("        text-align: left\">\r\n");
	XYBody.Append("        <b>&nbsp;系统提示</b></div>\r\n");
	XYBody.Append("    <div class=\"Am_61\">\r\n");
	XYBody.Append("        <div class=\"bbs_tj fia\">\r\n");
	XYBody.Append("            您的帐户没有通过审核！<br />\r\n");
	XYBody.Append("            原因：");	XYBody.Append(userinfo.reason.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("            意见：");	XYBody.Append(userinfo.advice.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </div>\r\n");
	...
	XYBody.Append("        <b>&nbsp;我的信息统计</b></div>\r\n");
	XYBody.Append("    <div class=\"Am_61\">\r\n");
	XYBody.Append("        <div class=\"bbs_tj fia\">\r\n");
	XYBody.Append("            <div class=\"bbs_ln\">\r\n");
	XYBody.Append("                <em class=\"atv_icon2\"></em>信息：\r\n");
	 data = GetStatData();
	...
	XYBody.Append("            </div>\r\n");
	XYBody.Append("            <div class=\"bbs_ln\">\r\n");
	XYBody.Append("                <em class=\"atv_icon1\"></em>留言：普通短信 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?nosee=0\">\r\n");
	XYBody.Append("                    ");	XYBody.Append(userinfo.messagecount.ToString());	XYBody.Append("</a> 条 系统留言 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receiveinvestmentmessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?nosee=0\">\r\n");
	XYBody.Append("                        ");	XYBody.Append(userinfo.noseesysmsgcount.ToString());	XYBody.Append("</a> 条 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/postadministratormessage.");	XYBody.Append(config.Suffix);	XYBody.Append("\">\r\n");
	XYBody.Append("                            给管理员留言</a></div>\r\n");
	XYBody.Append("            <div class=\"bbs_ln\">\r\n");
	XYBody.Append("                <em class=\"atv_icon3\"></em>收藏：<a href=\"companys.");	XYBody.Append(config.suffix);	XYBody.Append("\">收藏的企业信息</a> <span\r\n");
	XYBody.Append("                    class=\"hui912\">|</span> <a href=\"favoritelist.");	XYBody.Append(config.suffix);	XYBody.Append("\">收藏的商业信息</a>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <!--forum end  -->\r\n");
	XYBody.Append("    <!--个人信息 end-->\r\n");
	XYBody.Append("    <div class=\"Am_6\">\r\n");
	XYBody.Append("        <strong>联系人信息</strong></div>\r\n");
	XYBody.Append("    <br clear=\"all\">\r\n");
	XYBody.Append("    <div class=\"Am_61\">\r\n");
	XYBody.Append("        <div class=\"bbs_tj fia\">\r\n");
	XYBody.Append("            <div class=\"bbs_ln\">\r\n");
	...
	XYBody.Append("                        <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/fix_r3.gif\">\r\n");
	XYBody.Append("                    </td>\r\n");
	XYBody.Append("                    <td>\r\n");
	XYBody.Append("                        &nbsp;\r\n");
	XYBody.Append("                    </td>\r\n");
	...
	XYBody.Append("            信息将排在搜索结果的前三位，能够被买家第一时间就找到。</div>\r\n");
	XYBody.Append("        <br clear=\"all\">\r\n");
	XYBody.Append("        <a class=\"fi\" href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("keyword/index.");	XYBody.Append(config.Suffix);	XYBody.Append("\" target=\"_blank\">\r\n");
	XYBody.Append("            <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/invitef.gif\" /></a>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <!--任务显示 end-->\r\n");
	XYBody.Append("    <!--谁来看过我 start-->\r\n");
	XYBody.Append("    <div class=\"Ar_1 Ucgg\">\r\n");
	XYBody.Append("        网站公告</div>\r\n");
	XYBody.Append("    <br clear=\"all\">\r\n");
