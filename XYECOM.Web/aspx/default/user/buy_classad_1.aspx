<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buy_classad_1,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <a href=\"index.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商务中心</a> &gt; <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/searchkeyword.");	XYBody.Append(config.Suffix);	XYBody.Append("\">\r\n");
	XYBody.Append("        搜索关键词</a> &gt; 购买关键词</div>\r\n");
	...
	if (pageinfo.PageState!="")
	{


	if (pageinfo.PageState=="ok")
	{

	XYBody.Append("    <div class=\"gq_succe\">\r\n");
	XYBody.Append("        <span><b>购买成功！</b></span>\r\n");
	XYBody.Append("        <br />\r\n");
	XYBody.Append("        ");	XYBody.Append(pageinfo.MsgboxText);	XYBody.Append("\r\n");
	XYBody.Append("    </div>\r\n");
	...
	if (pageinfo.PageState=="error")
	{

	XYBody.Append("    <div class=\"gq_succe\">\r\n");
	XYBody.Append("        <span><b>购买失败！</b></span>\r\n");
	XYBody.Append("        <br />\r\n");
	XYBody.Append("        ");	XYBody.Append(pageinfo.MsgboxText);	XYBody.Append("\r\n");
	XYBody.Append("    </div>\r\n");
	...
	XYBody.Append("    <input type=\"hidden\" name=\"classid\" value=\"");	XYBody.Append(classid.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    <input type=\"hidden\" name=\"classname\" value=\"");	XYBody.Append(classname.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    <table class=\"contentl\">\r\n");
	XYBody.Append("        <caption>\r\n");
	XYBody.Append("            广告分类与价格<span>(指定要购买的时间)</span></caption>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                类别名称：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	 str = GetAllClassNameForClassAds();
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <span id=\"price\">");	XYBody.Append(price.ToString());	XYBody.Append("</span>");	XYBody.Append(moneyname.ToString());	XYBody.Append("/");	XYBody.Append(timeunits.ToString());	XYBody.Append("\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                购买时间：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input name=\"timecycle\" type=\"text\" value=\"1\" id=\"timecycle\" maxlength=\"2\" size=\"2\"\r\n");
	XYBody.Append("                    onblur=\"_xy_BuyKey_RecalculatedPrice()\" />\r\n");
	XYBody.Append("                ");	XYBody.Append(timeunits.ToString());	XYBody.Append("\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	...
	XYBody.Append("                支付总额：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td id=\"amount\">\r\n");
	XYBody.Append("                ");	XYBody.Append(amount.ToString());	XYBody.Append("\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <table class=\"contentl\">\r\n");
	XYBody.Append("        <caption>\r\n");
	XYBody.Append("            广告详细信息</caption>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td colspan=\"2\">\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr style=\"height: 100px;\">\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                上传图片：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input id=\"txtImageUrl\" name=\"txtImageUrl\" size=\"45\" type=\"text\" /></br> <font color=\"red\">\r\n");
	XYBody.Append("                    注意：上传图片和填写图片地址只能选择一项</font>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                广告链接地址：\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input id=\"txtLink\" name=\"txtLink\" size=\"45\" type=\"text\" /></br> 请填写网站完整URL地址，如http://www.xyecom.com\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	...
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <textarea id=\"txtDesc\" name=\"txtDesc\" cols=\"45\" rows=\"5\"></textarea>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <div class=\"content_action\">\r\n");
	XYBody.Append("        <input name=\"\" type=\"submit\" value=\"确定\" onclick=\"return buy_classad_1_Check();\" class=\"button\" />\r\n");
	XYBody.Append("        <input name=\"but02\" type=\"button\" value=\"取消\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/buyclassads.");	XYBody.Append(config.Suffix);	XYBody.Append("'\"\r\n");
