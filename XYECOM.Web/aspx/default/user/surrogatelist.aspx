<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.surrogatelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("   <tr> \r\n");
	XYBody.Append("    <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + S["S_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("     <td >\r\n");
	 infoimg = GetInfoImgHref(S["S_ID"].ToString());
	

	if (infoimg=="")
	{

	XYBody.Append("            <img src=\"/common/images/DefaultImg.gif\" alt=\"" + S["S_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}
	else
	{

	XYBody.Append("            <img src=\"");	XYBody.Append(infoimg.ToString());	XYBody.Append("\" alt=\"" + S["S_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}	//end if

	XYBody.Append("     </td>\r\n");
	XYBody.Append("    <td class=\"infoTitle\" >\r\n");
	 infourl = GetInfoUrl(module.EName,S["S_Flag"].ToString(),S["S_ID"].ToString());
	
	XYBody.Append("        <a href=\"");	XYBody.Append(infourl.ToString());	XYBody.Append("\" target =\"_blank\">\r\n");
	XYBody.Append( Method.left(S["S_Title"].ToString().Trim(),20));
	XYBody.Append("</a>\r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("   <td class=\"wbg_setTime\">" + S["S_AddTime"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("   <td style=\"text-align:center;\">\r\n");

	if (S["S_Pause"].ToString().Trim()=="True")
	{
	...
	XYBody.Append("   </td>\r\n");
	XYBody.Append("   <td class=\"wbg_clicknum\">" + S["S_ClickNum"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("   <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?type='service'&InfoID=" + S["S_ID"].ToString().Trim() + "\"><em class=\"wbg_messageNum\">" + S["S_MessageNum"].ToString().Trim() + "</em></a> 条&nbsp;</td>\r\n");
	XYBody.Append("<td><input type =\"button\" class =\"button\"  value =\"修改\" onclick =\"location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/adv_post.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("&flag=" + S["S_Flag"].ToString().Trim() + "&info_ID=" + S["S_ID"].ToString().Trim() + "';\"/></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	...
	XYBody.Append("<input name=\"surrogate\"  type=\"submit\" class=\"button\" value=\"启用\" onclick =\"return resh(3);\" />\r\n");
	XYBody.Append("<input name=\"surrogate\"  type=\"submit\" class=\"button\" value=\"暂停\"  onclick =\"return resh(2);\"/>\r\n");
	XYBody.Append("<input name=\"surrogate\"  class=\"button\" type=\"submit\" value=\"刷新\" onclick=\"return resh(1);\"/>\r\n");
	XYBody.Append("<input name =\"surrogate\" class =\"button\" type =\"submit\" value =\"删除\"  onclick =\"return bntDelete();\" />&nbsp;\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
