<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.uploadlogo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        <ul class=\"upimgtab\">\r\n");
	XYBody.Append("            <li class=\"cur\"><a href=\"");	XYBody.Append(config.weburl);	XYBody.Append("user/uploadlogo.");	XYBody.Append(config.suffix);	XYBody.Append("\">上传商铺Logo</a></li>\r\n");
	XYBody.Append("            <li><a href=\"");	XYBody.Append(config.weburl);	XYBody.Append("user/uploadimage.");	XYBody.Append(config.suffix);	XYBody.Append("\">上传企业形象图片</a></li>\r\n");
	XYBody.Append("            <li><a href=\"");	XYBody.Append(config.weburl);	XYBody.Append("user/uploadbanner.");	XYBody.Append(config.suffix);	XYBody.Append("\">上传商铺Banner</a></li>\r\n");
	XYBody.Append("        </ul>\r\n");
	XYBody.Append("        <table class=\"loadimage\">\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td align=\"center\">\r\n");
	...
	XYBody.Append("                <script language=\"javascript\" type=\"text/javascript\">UploadInitPicSize(300,200);</" + "script>\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>&nbsp;<input type=\"submit\" class=\"button\" onclick=\"javascript:return setuserimg();\" value=\"确定\" /></td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("        </table>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
