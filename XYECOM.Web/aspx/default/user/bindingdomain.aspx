<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.bindingdomain,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("            <caption>绑定顶级域名</caption>\r\n");
	XYBody.Append("            <thead> </thead>\r\n");
	XYBody.Append("            <tbody>\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    您可以将域名绑定到你的网店上，操作注意事项如下:<br/><br/>\r\n");
	XYBody.Append("                    1.域名绑定完全免费，但必须提供正确的ICP备案信息.<br/>\r\n");
	XYBody.Append("                    2.涉及违反国家相关法律法规内容的域名不予通过.<br/>\r\n");
	XYBody.Append("                    3.申请提交后三个工作日之内进行审核,在这过程中网店能正常通过原路径访问.<br/><br/>\r\n");
	XYBody.Append("                    由于信息产业部网站查询备案信息可能会出错，所以请您先登录信息产业部网站确保能查询到正确的备案信息.\r\n");
	XYBody.Append("                    <br/><br/>\r\n");
	...
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                第一步：请将你的域名解析到网址：<font color=\"red\">www.xyecs.cn</font><br/><br/>\r\n");
	XYBody.Append("                &nbsp;&nbsp;&nbsp;注意：一定要使用CNAME（别名）方式做指向，不能使用A记录、MX记录，url转发\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                 第二步：请填写正确的信息：\r\n");
	XYBody.Append("                 <table width=\"100%\">\r\n");
	XYBody.Append("                    <tr>\r\n");
	XYBody.Append("                        <th>您的域名：</th>\r\n");
	XYBody.Append("                        <td><input type=\"text\" name=\"userdomain\" value=\"");	XYBody.Append(userdomain.ToString());	XYBody.Append("\"/> 如：www.xyecs.cn</td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                    <tr>\r\n");
	XYBody.Append("                        <th>ICP备案号：</th>\r\n");
	XYBody.Append("                        <td><input type=\"text\" name=\"icpinfo\" value=\"");	XYBody.Append(icpinfo.ToString());	XYBody.Append("\"/> 如：京ICP备8888888号</td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                 </table>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	...
	XYBody.Append("            <input name=\"submit\"  type=\"submit\" class=\"button\" value=\"确认\" onclick=\"javascript:return Announceinfo()\"/> \r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("  </div>\r\n");
