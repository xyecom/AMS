<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.part,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>编辑企业专栏<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>效果预览：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        <div class=\"part_preview\">\r\n");
	XYBody.Append("        &nbsp;");	XYBody.Append(labelBody.ToString());	XYBody.Append("\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>上传图片：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	...
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th width=\"15%\">信息类型：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td width=\"85%\">\r\n");
	 data = GetAllModule();
	...
	XYBody.Append("            <input name=\"modulename\" type=\"radio\" value=\"" + item["key"].ToString().Trim() + "\" checked=\"true\" onclick=\"_xy_part_getUserData()\"/>" + item["ModuleName"].ToString().Trim() + "\r\n");

	}
	else
	{

	XYBody.Append("            <input name=\"modulename\" type=\"radio\" value=\"" + item["key"].ToString().Trim() + "\"  onclick=\"_xy_part_getUserData()\"/>" + item["ModuleName"].ToString().Trim() + "\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td width=\"43%\">\r\n");
	XYBody.Append("                <div id=\"_all_info_box\" class=\"partbox\"></div>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("            <td width=\"14%\">\r\n");
	XYBody.Append("                <input type=\"button\" value=\">> 加入 >>\" onclick=\"_xy_part_addInfo();\"/><br/><br/>\r\n");
	XYBody.Append("                <input type=\"button\" value=\"<< 删除 <<\" onclick=\"_xy_part_moveInfo();\"/><br/><br/>\r\n");
	XYBody.Append("                <br/><br/>\r\n");
	XYBody.Append("                <input type=\"button\" value=\"设为头条>>\" onclick=\"_xy_part_setTop();\"/>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("            <td width=\"43%\">\r\n");
	XYBody.Append("                <div id=\"_select_info_box\" class=\"partbox\">\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("                <input type=\"hidden\" id=\"UserId\" name=\"UserId\" value=\"");	XYBody.Append(userinfo.userid.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("                <input type=\"hidden\" id=\"_hidTopInfoId\" name=\"_hidTopInfoId\" value=\"\" />\r\n");
	XYBody.Append("                <input type=\"hidden\" id=\"_hidInfoIds\" name=\"_hidInfoIds\" value=\"\" />\r\n");
	XYBody.Append("                <input type=\"hidden\" id=\"_infoIds\" name=\"_infoIds\" value=\"");	XYBody.Append(infoids.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("                <script>_xy_part_initPage();</" + "script>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("	</td>\r\n");
	...
	XYBody.Append("    <input name=\"\" type =\"submit\" value=\"确定发布\" onclick =\"return _xy_part_submit();\" class =\"button\" />\r\n");
	XYBody.Append("    <input name=\"but02\" type=\"button\" value=\"返回\" onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/partlist.");	XYBody.Append(config.Suffix);	XYBody.Append("'\" class =\"button\" />\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</form>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<script>_xy_part_getUserData();</" + "script>\r\n");
