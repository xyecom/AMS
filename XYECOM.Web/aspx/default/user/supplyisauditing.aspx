<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.supplyisauditing,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
...
	XYBody.Append( Method.left(SDT["SD_Title"].ToString().Trim(),40));
	XYBody.Append("</td>\r\n");
	...
	XYBody.Append("            <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?type='offer'&InfoID=" + SDT["SD_ID"].ToString().Trim() + "\"><em class=\"wbg_messageNum\">" + SDT["SD_MessageNum"].ToString().Trim() + "</em></a> 条&nbsp;</td>\r\n");
