<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.invoicelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<div class=\"location fia\"><a href=\"index.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商务中心</a> &gt;  <a href=\"/user/invoicelist.aspx\">财务管理 </a> &gt;  发票信息列表</div>\r\n");
	...
	XYBody.Append("    <h3>发票信息列表</h3>\r\n");
	XYBody.Append("   <form action=\"#\" method=\"post\">\r\n");
	XYBody.Append("  <table  class=\"content\">\r\n");
	XYBody.Append("  <thead>\r\n");
	XYBody.Append("	  <tr>\r\n");
	XYBody.Append("		  <th width=\"35%\" >姓名</th>\r\n");
	XYBody.Append("		  <th width=\"12%\">邮编</th>\r\n");
	XYBody.Append("		  <th width=\"14%\">金额</th>\r\n");
	XYBody.Append("		  <th width=\"12%\">产品名称</th>\r\n");
	XYBody.Append("		  <th width=\"10%\">状态</th>\r\n");
	XYBody.Append("	  </tr>\r\n");
	XYBody.Append("  </thead>\r\n");
	XYBody.Append("  <tbody>\r\n");
	...
	XYBody.Append("  <tr> \r\n");
	XYBody.Append("    <td>" + SDS["I_Name"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("    <td>" + SDS["I_PostCode"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("    <td>" + SDS["I_Money"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("    <td>" + SDS["I_Product"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("   <td class=\"orange\">\r\n");

	if (SDS["I_IsFlag"].ToString().Trim()=="1")
	{
	...
	if (SDS["I_IsFlag"].ToString().Trim()=="2")
	{
	...
	if (SDS["I_IsFlag"].ToString().Trim()=="3")
	{
