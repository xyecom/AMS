<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.infoselect,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<style>\r\n");
	XYBody.Append("    #right .content_xz input[name='module']\r\n");
	XYBody.Append("    {\r\n");
	XYBody.Append("        cursor: pointer;\r\n");
	XYBody.Append("        float: left;\r\n");
	XYBody.Append("    }\r\n");
	XYBody.Append("    #right .content_xz label\r\n");
	XYBody.Append("    {\r\n");
	XYBody.Append("        cursor: pointer;\r\n");
	XYBody.Append("        float: left;\r\n");
	XYBody.Append("    }\r\n");
	...
	XYBody.Append("    <table class=\"content_xz\">\r\n");
	XYBody.Append("        <thead>\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <th>\r\n");
	XYBody.Append("                    请选择您发布的信息类型\r\n");
	XYBody.Append("                </th>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("        </thead>\r\n");
	XYBody.Append("        <tbody>\r\n");
	XYBody.Append("            <tr id=\"tr0\" class=\"xuanze\">\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input type=\"radio\" id=\"Radio0\" name=\"module\" checked=\"checked\" value=\"/user/ChooseProductType.aspx\"\r\n");
	XYBody.Append("                        onclick=\"selectinfotype('tr0',this);\" />\r\n");
	XYBody.Append("                    <label for=\"Radio0\">\r\n");
	XYBody.Append("                        <span class=\"labeltext\">发布产品</span>\r\n");
	XYBody.Append("                    </label>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr id=\"tr1\">\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input type=\"radio\" id=\"Radio1\" name=\"module\" value=\"/user/ChooseProductType.aspx?IsContractVouch=1\"\r\n");
	XYBody.Append("                        onclick=\"selectinfotype('tr1',this);\" />\r\n");
	XYBody.Append("                    <label for=\"Radio1\">\r\n");
	XYBody.Append("                        <span class=\"labeltext\">发布合同担保交易</span>\r\n");
	XYBody.Append("                    </label>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr id=\"tr2\">\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input type=\"radio\" id=\"Radio2\" name=\"module\" value=\"/user/Venture/AddFinancingInfo.aspx\"\r\n");
	XYBody.Append("                        onclick=\"selectinfotype('tr2',this);\" />\r\n");
	XYBody.Append("                    <label for=\"Radio2\">\r\n");
	XYBody.Append("                        <span class=\"labeltext\">发布融资信息</span>\r\n");
	XYBody.Append("                    </label>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr id=\"tr3\">\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input type=\"radio\" id=\"Radio3\" name=\"module\" value=\"/user/Venture/AddInvestmentInfo.aspx\"\r\n");
	XYBody.Append("                        onclick=\"selectinfotype('tr3',this);\" />\r\n");
	XYBody.Append("                    <label for=\"Radio3\">\r\n");
	XYBody.Append("                        <span class=\"labeltext\">发布投资信息</span>\r\n");
	XYBody.Append("                    </label>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr id=\"tr4\">\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input type=\"radio\" id=\"Radio4\" name=\"module\" value=\"/user/dis_post_step.aspx?ename=service\"\r\n");
	XYBody.Append("                        onclick=\"selectinfotype('tr4',this);\" />\r\n");
	XYBody.Append("                    <label for=\"Radio4\">\r\n");
	XYBody.Append("                        <span class=\"labeltext\">发布服务信息</span>\r\n");
	XYBody.Append("                    </label>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            <tr id=\"tr5\">\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input type=\"radio\" id=\"Radio5\" name=\"module\" value=\"/user/dis_post_step.aspx?ename=investment\"\r\n");
	XYBody.Append("                        onclick=\"selectinfotype('tr5',this);\" />\r\n");
	XYBody.Append("                    <label for=\"Radio5\">\r\n");
	XYBody.Append("                        <span class=\"labeltext\">发布招商代理信息</span>\r\n");
	XYBody.Append("                    </label>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("        </tbody>\r\n");
	...
	XYBody.Append("        <input type=\"hidden\" id=\"selected\" value=\"/user/ChooseProductType.aspx\" />\r\n");
	XYBody.Append("        <input name=\"submit\" type=\"button\" value=\"选好了，继续\" class=\"button\" onclick=\"selectpage();\" />\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("</div>\r\n");
