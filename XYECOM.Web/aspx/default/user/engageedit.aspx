<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.engageedit,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("   <caption>修改招聘信息<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>拟招聘岗位：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("     <td>\r\n");
	XYBody.Append("  <input type =\"hidden\" id=\"engageaid\"  name=\"engageaid\" value=\"");	XYBody.Append(ei.PostId.ToString());	XYBody.Append("\"/> \r\n");
	XYBody.Append("<div id=\"classTypejob\"></div>\r\n");
	XYBody.Append("<script type=\"text/javascript\">\r\n");
	XYBody.Append("var jobcla = new ClassType(\"jobcla\",'job','classTypejob','engageaid');\r\n");
	XYBody.Append("jobcla.Mode = \"select\";\r\n");
	XYBody.Append("jobcla.Init();\r\n");
	XYBody.Append("</" + "script> \r\n");
	XYBody.Append("  </td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>具体职位名称：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td><input name=\"EI_Job\" type=\"text\" value=\"");	XYBody.Append(ei.JobTitle.ToString());	XYBody.Append("\" size=\"30\"  maxlength=\"40\" />\r\n");
	XYBody.Append("    <span >（应与上一项拟招聘岗位相匹配）</span></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>招聘类型：</th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	<select name=\"EI_Type\">\r\n");
	XYBody.Append("	<option value=\"");	XYBody.Append(ei.JobType.ToString());	XYBody.Append("\">");	XYBody.Append(ei.JobType.ToString());	XYBody.Append("</option>\r\n");
	XYBody.Append("	<option value=\"不限\">不限</option>\r\n");
	XYBody.Append("    <option value=\"全职\">全职</option>\r\n");
	XYBody.Append("    <option value=\"兼职\">兼职</option>\r\n");
	XYBody.Append("    </select></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("   <th>招聘人数：</th>\r\n");
	XYBody.Append("    <td><input name=\"EI_Number\" type=\"text\" size=\"8\" value=\"");	XYBody.Append(ei.Number.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("	人<span>（只能填数字）</span></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>招聘部门：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	<input name=\"EI_Branch\" type=\"text\" value=\"");	XYBody.Append(ei.JobBranch.ToString());	XYBody.Append("\" size=\"30\"  maxlength=\"40\"/>\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>截至日期：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("		 <input onclick=\"getDateString(this);\" id=\"EI_EndDate\"  readonly=\"readonly\" value=\"");	XYBody.Append(ei.EndDate.ToShortDateString().ToString());	XYBody.Append("\" name =\"EI_EndDate\" />\r\n");
	XYBody.Append("        <span>（系统默认30天）</span></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("<tr>\r\n");
	XYBody.Append("<th>\r\n");
	XYBody.Append("工作地区：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("<td>\r\n");
	...
	XYBody.Append("</tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>具体要求：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td >\r\n");
	XYBody.Append("	<textarea name=\"EI_Request\" cols=\"50\" rows=\"5\">");	XYBody.Append(ei.Request.ToString());	XYBody.Append("</textarea>\r\n");
	XYBody.Append("	<span >（60-650字）</span>	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>薪资福利：</th>\r\n");
	XYBody.Append("    <td >\r\n");
	XYBody.Append("	<input name=\"EI_Pay\" type=\"text\" value=\"");	XYBody.Append(ei.Pay.ToString());	XYBody.Append("\" size=\"8\" />\r\n");
	XYBody.Append("        元<span>（0位面议，只能填数字）</span>	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  </table>\r\n");
	XYBody.Append("   <table id=\"Table1\" class=\"contentl\">\r\n");
	XYBody.Append("  <caption> 应聘条件</caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>学历：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	<select name=\"EI_Eb\">\r\n");
	XYBody.Append("	<option value=\"");	XYBody.Append(ei.Education.ToString());	XYBody.Append("\">");	XYBody.Append(ei.Education.ToString());	XYBody.Append("</option>\r\n");
	XYBody.Append("    <option value=\"不限\">不限</option>\r\n");
	XYBody.Append("    <option value=\"大专\">大专</option>\r\n");
	XYBody.Append("    <option value=\"本科\">本科</option>\r\n");
	XYBody.Append("    <option value=\"研究生\">研究生</option>\r\n");
	XYBody.Append("    <option value=\"博士生\">博士生</option>\r\n");
	XYBody.Append("    </select>以上\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("    <th>年龄：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	<select name=\"EI_Age\">\r\n");
	XYBody.Append("	<option value=\"");	XYBody.Append(ei.Age.ToString());	XYBody.Append("\">");	XYBody.Append(ei.Age.ToString());	XYBody.Append("</option>\r\n");
	XYBody.Append("    <option value=\"不限\">不限</option>\r\n");
	XYBody.Append("    <option value=\"20-25\">20-25</option>\r\n");
	XYBody.Append("    <option value=\"26-30\">26-30</option>\r\n");
	XYBody.Append("    <option value=\"31-35\">31-35</option>\r\n");
	XYBody.Append("    <option value=\"35-40\">35-40</option>\r\n");
	XYBody.Append("    <option value=\"40-50\">40-50</option>\r\n");
	XYBody.Append("    </select>\r\n");
	XYBody.Append("        岁\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>性别：</th>\r\n");
	XYBody.Append("    <td >\r\n");
	XYBody.Append("	<select name=\"EI_Sex\">\r\n");
	XYBody.Append("	<option value=\"");	XYBody.Append(ei.Sex.ToString());	XYBody.Append("\">");	XYBody.Append(ei.Sex.ToString());	XYBody.Append("</option>\r\n");
	XYBody.Append("    <option value=\"不限\">不限</option>\r\n");
	XYBody.Append("    <option value=\"男性\">男性</option>\r\n");
	XYBody.Append("    <option value=\"女性\">女性</option>\r\n");
	XYBody.Append("    </select>\r\n");
	XYBody.Append("	</td>    \r\n");
	XYBody.Append("	<th>工作经验：</th>\r\n");
	XYBody.Append("    <td >\r\n");
	XYBody.Append("        <input name=\"EI_Experience\" type=\"text\" id=\"Text2\" value=\"");	XYBody.Append(ei.Experience.ToString());	XYBody.Append("\" size=\"10\" />\r\n");
	XYBody.Append("        年以上\r\n");
	XYBody.Append("	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>户口所在地：</th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        <input name=\"EI_Nationality\" type=\"text\" id=\"Text3\" value=\"");	XYBody.Append(ei.Nationality.ToString());	XYBody.Append("\" size=\"40\"  maxlength=\"180\" /></td>\r\n");
	XYBody.Append("    <td></td>\r\n");
	XYBody.Append("	<td></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("</table>\r\n");
	XYBody.Append("<br/>\r\n");
	XYBody.Append("<!--检查联系信息-->\r\n");
	XYBody.Append("<table class=\"contentl\">\r\n");
	XYBody.Append("<caption>检查联系信息<span>(本次招聘的联系方式系统默认您单位的联系方式)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	...
	XYBody.Append(" <input name=\"submit\"  type=\"submit\" class=\"button\" value=\"确认\" onclick=\"javascript:return engeinfo()\"/> \r\n");
	XYBody.Append("  <input name=\"submit\"  type=\"button\" class=\"button\" value=\"取消\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/engagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("';\"/> \r\n");
	XYBody.Append(" </div>\r\n");
	XYBody.Append(" </div>\r\n");
	XYBody.Append("</form>\r\n");
