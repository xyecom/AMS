<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buylistnotauditing,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	int SDY__loop__id=0;
	foreach(DataRow SDY in infolist.Rows)
	{
		SDY__loop__id++;

	XYBody.Append("               <tr> \r\n");
	XYBody.Append("              <td ><input  name=\"sd_id\" id=\"sd_id\" type=\"checkbox\" value=\"" + SDY["SD_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("                <td >\r\n");
	 infoimg = GetInfoImgHref(SDY["SD_ID"].ToString());
	

	if (infoimg=="")
	{

	XYBody.Append("                        <img src=\"/common/images/DefaultImg.gif\" alt=\"" + SDY["SD_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}
	else
	{

	XYBody.Append("                        <img src=\"");	XYBody.Append(infoimg.ToString());	XYBody.Append("\" alt=\"" + SDY["SD_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}	//end if

	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td class=\"infoTitle\">\r\n");
	XYBody.Append( Method.left(SDY["SD_Title"].ToString().Trim(),20));
	XYBody.Append("</td>\r\n");
	XYBody.Append("                <td class=\"wbg_setTime\">" + SDY["SD_PublishDate"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                <td style=\"text-align:center;\">\r\n");

	if (SDY["SD_IsSupply"].ToString().Trim()=="True")
	{
