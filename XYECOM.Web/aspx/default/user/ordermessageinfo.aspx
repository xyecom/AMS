<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.ordermessageinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>给");	XYBody.Append(bargaining.ToString());	XYBody.Append("留言<span>(*为必填项)</span></caption>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("  <th >留言标题：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("  <td >\r\n");
	XYBody.Append("      <input id=\"messtitle\" style=\"width: 380px\" type=\"text\" name =\"messtitle\"  maxlength =\"400\" value=\"");	XYBody.Append(msgTitle.ToString());	XYBody.Append("\" readonly=\"readonly\" /></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	...
	XYBody.Append("<input name=\"but02\" type=\"button\" value=\"取消\" onclick =\"window.location.href='/user/index.aspx';\"  class =\"button\"/>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</form>\r\n");
	XYBody.Append("</div>\r\n");
