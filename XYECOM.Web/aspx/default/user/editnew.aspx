<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.editnew,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <a href=\"index.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商务中心</a> &gt; <a href=\"#\">基本设置</a> &gt; 公司动态修改</div>\r\n");
	...
	XYBody.Append("            修改资讯<span>（*为必填项）</span></caption>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                标题：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input name=\"title\" type=\"text\" value=\"");	XYBody.Append(newsinfo.Title.ToString());	XYBody.Append("\" id=\"title\" maxlength=\"90\"\r\n");
	XYBody.Append("                    size=\"60\" />\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("         <tr>\r\n");
	XYBody.Append("        <th>副标题：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input  name=\"othertitle\"  type=\"text\" id=\"othertitle\" maxlength=\"100\" size=\"50\"  value=\"");	XYBody.Append(newsinfo.SubTitle.ToString());	XYBody.Append("\"/></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                选择栏目：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <div id=\"customerType\">\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("                <input id=\"selectId\" name=\"selectId\" type=\"hidden\" value=\"");	XYBody.Append(newsinfo.UserTitleInfoId.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("                <input id=\"flag\" type=\"hidden\" value=\"usertitleinfo\" />\r\n");
	XYBody.Append("                <script type=\"text/javascript\">\r\n");
	XYBody.Append("                    var cla = new ClassType(\"cla\", 'flag', 'customerType', 'selectId', 999, 'xy001', 'uid:");	XYBody.Append(userinfo.userid.ToString());	XYBody.Append("');\r\n");
	...
	XYBody.Append("        <td><input name=\"newskeyword\" type=\"text\" id=\"newskeyword\" maxlength=\"100\" size=\"50\" value=\"");	XYBody.Append(newsinfo.Keyword.ToString());	XYBody.Append("\" />多个请以“，”隔开\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>资讯作者：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input name=\"txtauthor\" type=\"text\" id=\"txtauthor\" maxlength=\"100\" size=\"20\" value=\"");	XYBody.Append(newsinfo.Author.ToString());	XYBody.Append("\"/></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>资讯来源：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input  name=\"txtOrigin\"  type =\"text\" id=\"txtOrigin\" maxlength=\"100\" size=\"20\" value=\"");	XYBody.Append(newsinfo.Origin.ToString());	XYBody.Append("\"/></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>资讯导读：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input  type=\"text\" maxlength=\"90\" size=\"90\" name=\"txtLess\" id=\"txtLess\" value=\"");	XYBody.Append(newsinfo.Leadin.ToString());	XYBody.Append("\" /></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>\r\n");
	XYBody.Append("                内容：<em class=\"red\">*</em>\r\n");
	XYBody.Append("            </th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <!--Editer Start-->\r\n");
	...
	XYBody.Append("                </" + "script>\r\n");
	XYBody.Append("                <!--Editer End-->\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <!--<div id=\"divIsContributor\" style=\"display:none;\">\r\n");
	XYBody.Append("<table class=\"contentl\">\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>副标题：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input  name=\"othertitle\"  type=\"text\" id=\"othertitle\" maxlength=\"100\" size=\"50\"  value=\"");	XYBody.Append(newsinfo.SubTitle.ToString());	XYBody.Append("\"/></td>\r\n");
	...
	XYBody.Append("         <td>\r\n");
	XYBody.Append("            <input id=\"Hidden1\"  name=\"Hidden1\" type=\"hidden\" />\r\n");
	XYBody.Append("            <input id=\"hidTypeId\"  name=\"hidTypeId\" type=\"hidden\"  value=\"");	XYBody.Append(newsinfo.TypeIds.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("            <input type=\"hidden\" id=\"hidMoueleName\" />\r\n");
	XYBody.Append("            <div id=\"classType\"></div>\r\n");
	XYBody.Append("            <script type=\"text/javascript\">\r\n");
	XYBody.Append("            //var cla = new ClassType(\"cla\",'news','classType','hidTypeId');\r\n");
	XYBody.Append("            cla.CustomEvent = GetFieldInnerHTML;\r\n");
	XYBody.Append("            cla.Init();\r\n");
	XYBody.Append("            </" + "script>\r\n");
	XYBody.Append("         </td>\r\n");
	XYBody.Append("    </tr>\r\n");
	...
	XYBody.Append("        <td><input  name=\"laiyuan\"  type =\"text\" id=\"laiyuan\" maxlength=\"100\" size=\"50\" value=\"");	XYBody.Append(userinfo.unitname.ToString());	XYBody.Append("\" readonly=\"readonly\"/></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>新闻导读：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td><input  type=\"text\" maxlength=\"90\" size=\"90\" name=\"daodu\" id=\"daodu\" value=\"");	XYBody.Append(newsinfo.Leadin.ToString());	XYBody.Append("\" /></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>是否容许评论：</th>\r\n");
	XYBody.Append("        <td><input  type=\"checkbox\" id=\"ispinglun\" name=\"ispinglun\" onclick=\"Ispinglun();\" value=\"1\"/></td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("</table>\r\n");
	XYBody.Append("</div>-->\r\n");
	XYBody.Append("    <div class=\"content_action\">\r\n");
	XYBody.Append("        <input type=\"checkbox\" id=\"IsContributor\" name=\"IsContributor\" value=\"0\" style=\"display: none;\" />\r\n");
	XYBody.Append("        <input name=\"\" type=\"submit\" value=\"修改\" onclick=\"return  getnews();\" class=\"button\" />\r\n");
