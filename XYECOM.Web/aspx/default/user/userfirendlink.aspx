<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.userfirendlink,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <h3>友情链接管理</h3>\r\n");
	XYBody.Append("  <form action=\"#\" id=\"\" method=\"post\">\r\n");
	XYBody.Append("      <table  class=\"content\">\r\n");
	XYBody.Append("        <thead>\r\n");
	XYBody.Append("          <tr>\r\n");
	XYBody.Append("  	          <th width=\"5%\">选择</th>\r\n");
	XYBody.Append("              <th width=\"20%\">网站名称</th>\r\n");
	XYBody.Append("	          <th width=\"30%\">网站地址</th>\r\n");
	XYBody.Append("	          <th width=\"35%\">Logo地址</th>\r\n");
	...
	foreach(DataRow link in infolist.Rows)
	{
		link__loop__id++;

	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + link["LinkID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("            <td>" + link["SiteName"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("            <td>" + link["Url"].ToString().Trim() + "</td>  \r\n");
	XYBody.Append("            <td>" + link["LogoUrl"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("            <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/userfirendlinkadd.");	XYBody.Append(config.Suffix);	XYBody.Append("?LinkId=" + link["LinkID"].ToString().Trim() + "\">修改</a></td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <input type=\"hidden\" id=\"audting\" name=\"audting\" value=\"\" />\r\n");
	...
	XYBody.Append("            <input name=\"engage\"  class=\"button\" type=\"button\" value=\"添加\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/userfirendlinkedit.");	XYBody.Append(config.Suffix);	XYBody.Append("';\"/>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("            </tr>\r\n");
