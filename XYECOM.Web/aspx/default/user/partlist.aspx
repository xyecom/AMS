<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.partlist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("            <ul>\r\n");
	XYBody.Append("                <li class=\"on\"><a href =\"#}\">企业专栏</a> </li>\r\n");
	XYBody.Append("            </ul>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("          <thead>\r\n");
	XYBody.Append("	          <tr>\r\n");
	XYBody.Append("	          <th width=\"15%\">名称</th>	  \r\n");
	XYBody.Append("	          <th width=\"15%\">格式</th>	  \r\n");
	XYBody.Append("	          <th width=\"15%\">开始时间</th>\r\n");
	XYBody.Append("	          <th width=\"15%\">结束时间</th>\r\n");
	XYBody.Append("	          <th width=\"15%\">是否过期</th>  \r\n");
	XYBody.Append("	          <th width=\"15%\">审核状态</th>  \r\n");
	XYBody.Append("	          <th width=\"10%\">编辑</th>  \r\n");
	XYBody.Append("	          </tr>\r\n");
	XYBody.Append("          </thead>\r\n");
	XYBody.Append("    <tbody>\r\n");
	...
	XYBody.Append("    <tr> \r\n");
	XYBody.Append("        <td>" + row["PartName"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>" + row["Format"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append( Method.formatdatetime(row["BeginTime"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append( Method.formatdatetime(row["EndTime"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("        <td>\r\n");
	 str = IsExpired(row["EndTime"]);
	
	XYBody.Append("           ");	XYBody.Append(str.ToString());	XYBody.Append("\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td>\r\n");
	 str = GetAuditingState(row["AuditingState"]);
	
	XYBody.Append("           ");	XYBody.Append(str.ToString());	XYBody.Append("                \r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td> <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/part.");	XYBody.Append(config.Suffix);	XYBody.Append("?partid=" + row["Partid"].ToString().Trim() + "\">修改</a></td>\r\n");
	XYBody.Append("    </tr>\r\n");
