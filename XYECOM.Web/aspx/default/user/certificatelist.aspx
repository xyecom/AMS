<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.certificatelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        <ul>\r\n");
	XYBody.Append("            <li class=\"on\"><a href =\"#\">企业证书</a> </li>\r\n");
	XYBody.Append("        </ul>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <div class=\"ly_tit32\">\r\n");
	XYBody.Append("        证书类别：<select id=\"txttype\" name=\"txttype\">\r\n");
	XYBody.Append("                <option value=\"\">请选择证书类别</option> \r\n");
	XYBody.Append("                <option value=\"1\">营业执照</option>\r\n");
	XYBody.Append("                <option value=\"2\">税务登记类</option>\r\n");
	XYBody.Append("                <option value=\"3\">经营许可类</option>\r\n");
	XYBody.Append("                <option value=\"4\">其它类</option>\r\n");
	XYBody.Append("                </select>\r\n");
	XYBody.Append("        <input name=\"inquire\" id=\"inquire\" class=\"button\" type=\"submit\" value=\"查看\"  />\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("  <thead>\r\n");
	XYBody.Append("	  <tr>\r\n");
	XYBody.Append("        <th style=\"height: 20px\">选择</th>\r\n");
	XYBody.Append("        <th style=\"height: 20px\">证书名称</th>\r\n");
	XYBody.Append("        <th style=\"height: 20px\" >所属类别</th>\r\n");
	XYBody.Append("        <th style=\"height: 20px\" >生效日期</th>\r\n");
	XYBody.Append("        <th style=\"height: 20px\" >截至日期</th>\r\n");
	XYBody.Append("        <th style=\"height: 20px\">状态</th>\r\n");
	...
	XYBody.Append("  <tr>  \r\n");
	XYBody.Append("    <td ><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + sd["CE_ID"].ToString().Trim() + "\" /></td> \r\n");
	XYBody.Append("    <td>" + sd["CE_Name"].ToString().Trim() + "</td> \r\n");
	XYBody.Append("    <td>\r\n");

	if (sd["CE_Type"].ToString().Trim()=="1")
	{
	...
	XYBody.Append("    </td>    \r\n");
	XYBody.Append("    <td> \r\n");
	XYBody.Append( Method.formatdatetime(sd["CE_Begin"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("    <td >\r\n");
	XYBody.Append( Method.formatdatetime(sd["CE_Upto"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("    <td class=\"orange\">\r\n");

	if (sd["AuditingState"].ToString().Trim()=="True")
	{
	...
	if (sd["AuditingState"].ToString().Trim()=="False")
	{
	...
	if (sd["AuditingState"].ToString().Trim()=="")
	{
	...
	if (sd["CE_Isopen"].ToString().Trim()=="True")
	{
	...
	if (sd["CE_Isopen"].ToString().Trim()=="False")
	{
	...
	XYBody.Append("    </td>\r\n");
	XYBody.Append("    <td >\r\n");
	XYBody.Append("     <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/certificateinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?ce_id=" + sd["CE_ID"].ToString().Trim() + "\" title=\"请点击\">修改</a>/\r\n");
	XYBody.Append("     <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/certificateinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?ce_id=" + sd["CE_ID"].ToString().Trim() + "\" title=\"请点击\">查看</a>      \r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("    </tr> \r\n");
	...
	XYBody.Append("<input name=\"Deletes\" id=\"Deletes\" class=\"button\" type=\"submit\" value=\"删除\"  onclick=\"return bntDelete()\"/>\r\n");
	XYBody.Append("<input name =\"business\"id=\"notopen\" type=\"submit\" class=\"button\" value=\"隐藏\" onclick=\"return bntisopen(this);\" />\r\n");
	XYBody.Append("<input name=\"business\" id=\"open\" type=\"submit\" class=\"button\" value=\"启用\" onclick=\"return bntisopen(this);\"/>\r\n");
	XYBody.Append("<input id=\"isDelete\" name=\"isDelete\" type=\"hidden\" /><input type=\"hidden\" id=\"isSetPause\" name=\"isSetPause\" value=\"\"/>\r\n");
	XYBody.Append("<input name=\"barnd\"  class=\"button\" type=\"button\" value=\"新增\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/certificateadd.");	XYBody.Append(config.Suffix);	XYBody.Append("'\"/>\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
