<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buy_classad_2,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <div>\r\n");
	XYBody.Append("        <div><b>购买成功！</b></div>\r\n");
	XYBody.Append("        <div>");	XYBody.Append(pageinfo.MsgboxText);	XYBody.Append("</div>\r\n");
	XYBody.Append("    </div>\r\n");
	...
	XYBody.Append("    <div>\r\n");
	XYBody.Append("        <div><b>购买失败！</b></div>\r\n");
	XYBody.Append("        <div>");	XYBody.Append(pageinfo.MsgboxText);	XYBody.Append("</div>\r\n");
	XYBody.Append("    </div>\r\n");
