<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.receivemessagelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<h2>\r\n");
	XYBody.Append("<span><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?nosee=0\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/ly_img3.gif\" />未读</a> | <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?nosee=1\"><img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/ly_img2.gif\" />已读</a></span>\r\n");
	XYBody.Append("我收到的留言\r\n");
	XYBody.Append("</h2>\r\n");
	XYBody.Append("<div class=\"ly_100\">\r\n");
	XYBody.Append("<div class=\"ly_tit3\">\r\n");
	XYBody.Append(" <ul>\r\n");
	XYBody.Append(" <li class=\"on\"><a  href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">所有留言</a></li>\r\n");
	XYBody.Append(" <li class=\"out\"><a  href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receiveoffermessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商业信息留言</a></li>\r\n");
	XYBody.Append(" <li class=\"out\"><a  href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receiveinvestmentmessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">系统留言</a></li>\r\n");
	XYBody.Append(" </ul>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<div class=\"ly_tit32\">\r\n");
	XYBody.Append("<select name=\"nokan\" id=\"nokan\">\r\n");
	XYBody.Append("  <option value=\"0\">未读</option>\r\n");
	XYBody.Append("  <option value=\"1\">已读</option>\r\n");
	XYBody.Append("</select>\r\n");
	XYBody.Append("<select name=\"datemes\" id=\"datemes\" >\r\n");
	XYBody.Append("  <option value=\"1\">一个月内的留言</option>\r\n");
	XYBody.Append("<option value=\"2\">二个月内的留言</option>\r\n");
	XYBody.Append("<option value=\"3\">三个月内的留言</option>\r\n");
	XYBody.Append("</select>\r\n");
	XYBody.Append("<input type=\"submit\" class =\"button\" name=\"msg\" value=\"查询\"/>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<table class=\"ly_tab2 ly_w1\">\r\n");
	XYBody.Append("<thead><tr><td></td><td></td><td>标题</td><td>发自</td></tr></thead>\r\n");
	XYBody.Append("<tbody>\r\n");
	...
	XYBody.Append(" <tr>\r\n");
	XYBody.Append("  <td><input name=\"sd_id\" id=\"sd_id\" type=\"checkbox\" value=\"" + s["M_ID"].ToString().Trim() + "\"  name =\"sd_id\"/></td>\r\n");
	XYBody.Append("  <td valign=\"top\">\r\n");

	if (s["M_HasReply"].ToString().Trim()=="False")
	{

	XYBody.Append("  <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/ly_img3.gif\" />\r\n");

	}
	else
	{

	XYBody.Append("   <img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/ly_img2.gif\" />\r\n");
	...
	if (s["type"].ToString().Trim()=="网站")
	{

	XYBody.Append("    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessageinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?m_id=" + s["M_ID"].ToString().Trim() + "\">" + s["M_Title"].ToString().Trim() + "</a><br />" + s["M_AddTime"].ToString().Trim() + "\r\n");
	...
	if (s["U_ID"].ToString().Trim()=="-1"||s["U_ID"].ToString().Trim()=="-2")
	{

	XYBody.Append("    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessageinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?m_id=" + s["M_ID"].ToString().Trim() + "\"></a><em >(系统信息)</em>  <br />\r\n");
	...
	XYBody.Append("    " + s["M_UserName"].ToString().Trim() + "<em >(游客)</em> <br />" + s["M_CompanyName"].ToString().Trim() + "\r\n");

	}
	else
	{

	XYBody.Append("    " + s["M_UserName"].ToString().Trim() + " " + s["M_CompanyName"].ToString().Trim() + "\r\n");
	...
	XYBody.Append("<tr>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("    <input id=\"chkAll\" name=\"chkAll\" type=\"checkbox\" value=\"\" onclick=\"CheckedAll();\"/>全选 <input name=\"message\"  class=\"button\" type=\"submit\" value=\"删除\"  onclick=\"return bntDelete()\"/>\r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
