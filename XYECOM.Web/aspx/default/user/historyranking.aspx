<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.historyranking,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("     <h3>历史排名信息</h3>   \r\n");
	XYBody.Append("    <table class=\"content\">\r\n");
	XYBody.Append("     <thead>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th width=\"30%\">关键词</th>\r\n");
	XYBody.Append("        <th width=\"10%\">名次</th>\r\n");
	XYBody.Append("        <th width=\"10%\">支付金额</th>\r\n");
	XYBody.Append("        <th width=\"15%\">开始时间</th>\r\n");
	XYBody.Append("        <th width=\"15%\">结束时间</th>\r\n");
	XYBody.Append("        <th width=\"15%\">实际结束时间</th>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("     </thead>\r\n");
	XYBody.Append("     <tbody>\r\n");

	int log__loop__id=0;
	foreach(DataRow log in infolist.Rows)
	{
		log__loop__id++;

	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <td>" + log["keyword"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>" + log["rank"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>" + log["amount"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append( Method.formatdatetime(log["begintime"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append( Method.formatdatetime(log["endtime"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append( Method.formatdatetime(log["realendtime"].ToString().Trim(),"yyyy-MM-dd"));
	XYBody.Append("</td>\r\n");
	XYBody.Append("      </tr>\r\n");
