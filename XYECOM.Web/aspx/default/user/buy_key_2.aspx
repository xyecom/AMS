<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buy_key_2,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        </b></span>\r\n");
	XYBody.Append("        <br />\r\n");
	XYBody.Append("        ");	XYBody.Append(pageinfo.MsgboxText);	XYBody.Append("\r\n");
	XYBody.Append("        <br />\r\n");
	XYBody.Append("        <span><a href=\"searchkeyword.");	XYBody.Append(config.suffix);	XYBody.Append("\">搜索关键词</a> | <a href=\"curranking.");	XYBody.Append(config.suffix);	XYBody.Append("\">\r\n");
	XYBody.Append("            当前参与的排名</a> </span>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
