<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.sendmessagelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<h2>我发出的留言</h2>\r\n");
	XYBody.Append("<div class=\"ly_100\">\r\n");
	XYBody.Append("<div class=\"ly_tit3\">\r\n");
	XYBody.Append(" <ul>\r\n");
	XYBody.Append(" <li class=\"on\">所有留言</li>\r\n");
	XYBody.Append(" </ul>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<table class=\"ly_tab2 ly_w1\">\r\n");
	XYBody.Append("<thead><tr><td></td><td>状态</td><td>标题</td><td>接收者</td></tr></thead>\r\n");
	XYBody.Append("<tbody>\r\n");
	...
	XYBody.Append(" <tr>\r\n");
	XYBody.Append("  <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + s["M_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("  <td><span>\r\n");

	if (s["M_HasReply"].ToString().Trim()=="True")
	{

	XYBody.Append("    <font style=\"color:#f60;\">对方已读</font>\r\n");

	}
	else
	{

	XYBody.Append("     <font style=\"color:#444;\">对方未读</font>\r\n");

	}	//end if

	XYBody.Append("    </span><br />\r\n");

	if (s["M_Restore"].ToString().Trim()=="True")
	{

	XYBody.Append("    <font style=\"color:#669900;\">对方已回复</font>\r\n");

	}
	else
	{

	XYBody.Append("    <font style=\"color:#444;\">对方未回复</font>\r\n");

	}	//end if

	XYBody.Append("    </td>\r\n");
	XYBody.Append("  <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/sendmessageinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?m_id=" + s["M_ID"].ToString().Trim() + "\">" + s["M_Title"].ToString().Trim() + "</a><br />" + s["M_AddTime"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("  <td>\r\n");

	if (s["UI_linkMan"].ToString().Trim()=="")
	{
	...
	XYBody.Append("" + s["UI_LinkMan"].ToString().Trim() + "<br />" + s["UI_Name"].ToString().Trim() + "</td>\r\n");
	XYBody.Append(" </tr>\r\n");
	...
	XYBody.Append("<tr>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        <input id=\"Checkbox1\" name=\"chkAll\" type=\"checkbox\" value=\"\" onclick=\"CheckedAll();\"/>全选<input name=\"message\"  class=\"button\" type=\"submit\" value=\"删除\"  onclick=\"return bntDelete()\"/>\r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
