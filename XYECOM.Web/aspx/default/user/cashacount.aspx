<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.cashacount,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("     <h3> 账户明细列表\r\n");

	if (pageinfo.IsOnlinePayment)
	{

	XYBody.Append("        <span style=\"float:right\"><input type=\"button\" class=\"button\" value=\"在线充值\"  onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/accountrecharge.");	XYBody.Append(config.Suffix);	XYBody.Append("?burl=/user/cashacount.");	XYBody.Append(config.Suffix);	XYBody.Append("'\";/></span>\r\n");
	...
	XYBody.Append("        <thead>\r\n");
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <th width=\"5%\">\r\n");
	XYBody.Append("                    时间/流水号\r\n");
	XYBody.Append("                </th>\r\n");
	XYBody.Append("                <th width=\"15%\">\r\n");
	XYBody.Append("                    方式\r\n");
	XYBody.Append("                </th>\r\n");
	XYBody.Append("                <th width=\"20%\">\r\n");
	XYBody.Append("                    金额\r\n");
	XYBody.Append("                </th>\r\n");
	XYBody.Append("                <th width=\"50%\">\r\n");
	XYBody.Append("                    说明\r\n");
	XYBody.Append("                </th>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("        </thead>\r\n");
