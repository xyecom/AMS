<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.supplynotauditing,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("   <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?type='offer'&InfoID=" + SDY["SD_ID"].ToString().Trim() + "\"><em class=\"wbg_messageNum\">" + SDY["SD_MessageNum"].ToString().Trim() + "</em></a> 条&nbsp;</td>\r\n");
