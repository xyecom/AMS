<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.favoriteallbusinesslist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        <h2><span></span>我收藏的所以商业信息列表</h2>\r\n");
	...
	XYBody.Append("        <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy-venture-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">紧急寻求\r\n");
