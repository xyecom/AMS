<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.searchkeyword,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("            <ul>\r\n");
	XYBody.Append("                <li class=\"on\"><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/searchkeyword.");	XYBody.Append(config.Suffix);	XYBody.Append("\">选词</a></li>\r\n");
	XYBody.Append("            </ul>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("        <div class=\"ly_tit32\">\r\n");
	XYBody.Append("            关键词:<input type=\"text\" name=\"keyword\" id=\"keyword\" size=\"30\" value=\"");	XYBody.Append(keyword.ToString());	XYBody.Append("\"/> \r\n");
	XYBody.Append("            <input  class=\"button\" type=\"submit\" value=\"搜索\"  onclick=\"return __xy_SearchKeyword();\"/>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </div>\r\n");
	...
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td>" + key["SK_Name"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("            <td>\r\n");
	...
	XYBody.Append("                            <th>状态信息</th>\r\n");
	XYBody.Append("                            <th>购买</th>\r\n");
	XYBody.Append("                        </tr>\r\n");
	...
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                            <td>" + rdata["rank"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                            <td>" + rdata["state"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                            <td>" + rdata["link"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                        </tr>\r\n");
	...
	XYBody.Append("    </form>\r\n");
	XYBody.Append("    <table class=\"hotkeyword\">\r\n");
	XYBody.Append("        <tr><th>热门关键词</th></tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td>\r\n");
	...
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <table class=\"hotkeyword\">\r\n");
	XYBody.Append("        <tr><th>最新关键词</th></tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td>\r\n");
