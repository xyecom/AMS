<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.ordersaleinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<form action=\"#\" id=\"edit\" method=\"post\">\r\n");
	XYBody.Append("    <div class=\"sysTip\">\r\n");
	XYBody.Append("        订单编号：<span class=\"red\">");	XYBody.Append(euid.OF_Code.ToString());	XYBody.Append(" </span>\r\n");
	XYBody.Append("        <input  name=\"OF_ID\" id=\"OF_ID\" type=\"hidden\" value=\"");	XYBody.Append(euid.OF_ID.ToString());	XYBody.Append("\" />  \r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("  	<table class=\"contentl\"> \r\n");
	XYBody.Append("      <caption>订货信息</caption>\r\n");
	XYBody.Append("        <tbody >\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>订单当前状态：</th>\r\n");
	XYBody.Append("            <td  style=\" font-weight:bold; font-size:16px;line-height:30px; height:30px;\">");	XYBody.Append(type.ToString());	XYBody.Append("&nbsp;</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>货品名称：</th>\r\n");
	XYBody.Append("            <td ><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("supply/info.");	XYBody.Append(config.Suffix);	XYBody.Append("?sd_id=");	XYBody.Append(es.InfoID.ToString());	XYBody.Append("\" title=\"");	XYBody.Append(es.Title.ToString());	XYBody.Append("\" target=\"_blank\" > ");	XYBody.Append(es.Title.ToString());	XYBody.Append(" </a> </td>\r\n");
	XYBody.Append("        </tr>                    \r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>货品单价：</th>\r\n");
	XYBody.Append("            <td><em><input  name=\"ProductPrice\" id=\"ProductPrice\" type=\"text\" onchange=\"getMoney()\" value=\"");	XYBody.Append(euid.OF_Price.ToString());	XYBody.Append("\" /></em>元/");	XYBody.Append(es.Unit.ToString());	XYBody.Append("	&nbsp;</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>购买数量：</th>\r\n");
	XYBody.Append("            <td ><input type=\"text\" name=\"txtNumber\" id=\"txtNumber\"  onchange=\"getMoney()\" class=\"inputtext\" value=\"");	XYBody.Append(euid.OF_Number.ToString());	XYBody.Append("\" maxlength=\"10\" size=\"9\"/> &nbsp;");	XYBody.Append(es.Unit.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>货品总价：</th>\r\n");
	XYBody.Append("            <td><em id=\"Allgoods\" style =\" color:Red;\">");	XYBody.Append(allgoods.ToString());	XYBody.Append("</em> &nbsp;元</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>运费承担方：</th>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <input id=\"OF_CBeary\"  name=\"OF_CBearm\" type=\"radio\" value=\"1\" checked=\"checked\" onclick=\"showDisplay('showTRFlag');radio(this,'OF_CBear');getMoney()\" />买家承担\r\n");
	XYBody.Append("                <input id=\"OF_CBearn\" name=\"OF_CBearm\" type=\"radio\" value=\"0\"  onclick=\"hiddenDisplay('showTRFlag');radio(this,'OF_CBear');getMoney()\"/>卖家承担<input type =\"hidden\" id=\"OF_CBear\"  name=\"OF_CBear\"/>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr id=\"showTRFlag\" name=\"showTRFlag\">\r\n");
	XYBody.Append("            <th>运费收取方式：</th>\r\n");
	XYBody.Append("            <td >\r\n");
	XYBody.Append("                <input id=\"CBeginy\" name=\"CBegink\" type=\"radio\" value=\"1\" onclick=\"radio(this,'OF_CBegin');\" checked=\"checked\"/>款到发货<input name=\"CBegink\" id=\"CBeginn\" type=\"radio\" value=\"0\" onclick=\"radio(this,'OF_CBegin');\" />货到付款<input type =\"hidden\" id=\"OF_CBegin\"  name=\"OF_CBegin\"/>\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>运费：</th>\r\n");
	XYBody.Append("            <td ><input   type=\"text\" id=\"Carriage\" name=\"Carriage\" value=\"");	XYBody.Append(euid.OF_Carriage.ToString());	XYBody.Append("\" onchange=\"getMoney()\" />&nbsp; 元</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>优惠：</th>\r\n");
	XYBody.Append("            <td ><input  type=\"text\"  id=\"Favorable\" name=\"Favorable\" value=\"");	XYBody.Append(euid.OF_Favorable.ToString());	XYBody.Append("\" onchange=\"getMoney()\"/> &nbsp;元 </td>\r\n");
	XYBody.Append("        </tr>                          \r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>交易开始时间：</th>\r\n");
	XYBody.Append("            <td  >");	XYBody.Append(euid.OF_BeginTime.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>交易金额： </th>\r\n");
	XYBody.Append("            <td >\r\n");
	XYBody.Append("            <em id=\"OrderMoney\" style=\"color:Red;\">");	XYBody.Append(euid.OF_Money.ToString());	XYBody.Append("</em>元</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        </tbody>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <table class=\"contentl\">\r\n");
	XYBody.Append("      <caption> 送货地址</caption>\r\n");
	XYBody.Append("                  <tbody>\r\n");
	XYBody.Append("                    <tr>\r\n");
	XYBody.Append("                      <th >联系人：</th>\r\n");
	XYBody.Append("                      <td >");	XYBody.Append(euid.LinkMan.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                    <tr>\r\n");
	XYBody.Append("                      <th>联系电话：</th>\r\n");
	XYBody.Append("                      <td>");	XYBody.Append(LinkTel.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                    <tr>\r\n");
	XYBody.Append("                      <th>\r\n");
	XYBody.Append("                          送货地址：</th>\r\n");
	XYBody.Append("                      <td> ");	XYBody.Append(euid.LinkAddress.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                    <tr><th>买家要求：</th><td>");	XYBody.Append(euid.OF_remark.ToString());	XYBody.Append("</td></tr>\r\n");
	XYBody.Append("                  </tbody>\r\n");
	XYBody.Append("                </table>\r\n");
	XYBody.Append("    <div class=\"content_action\">\r\n");
	XYBody.Append("               <input name=\"submit\" type=\"submit\" value=\"修改\" id=\"btnupdateof\" class =\"button\"/>\r\n");
	XYBody.Append("                <input type=\"button\" class=\"button\" id=\"Button1\" value=\"取消\" onclick=\"window.history.go(-1);\" />\r\n");
	XYBody.Append("              </div>\r\n");
	XYBody.Append("</form>\r\n");
	XYBody.Append("</div>\r\n");
