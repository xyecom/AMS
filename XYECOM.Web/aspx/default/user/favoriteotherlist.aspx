<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.favoriteotherlist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<h2><span></span>我收藏的其它信息列表</h2>\r\n");
	...
	int SDS__loop__id=0;
	foreach(DataRow SDS in infolist.Rows)
	{
		SDS__loop__id++;

	XYBody.Append(" <tr>\r\n");
	XYBody.Append("  <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + SDS["Fa_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("    <td> \r\n");

	if (SDS["htmlpage"].ToString().Trim()=="")
	{


	if (SDS["DescTabName"].ToString().Trim()=="exhibition")
	{
	...
	XYBody.Append("                 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("exhibition/info-" + SDS["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">" + SDS["title"].ToString().Trim() + "</a>         \r\n");

	}
	else
	{

	XYBody.Append("		 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("exhibition/info.");	XYBody.Append(config.Suffix);	XYBody.Append("?infoid=" + SDS["DescTabID"].ToString().Trim() + "\" target =\"_blank\">" + SDS["title"].ToString().Trim() + "</a>\r\n");
	...
	if (SDS["DescTabName"].ToString().Trim()=="company")
	{
	...
	XYBody.Append("                   <a href=\"http://" + SDS["U_Name"].ToString().Trim() + "");	XYBody.Append(pageinfo.DomainHost);	XYBody.Append("/\" target =\"_blank\">" + SDS["title"].ToString().Trim() + "</a>\r\n");

	}
	else
	{

	XYBody.Append("                     <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("shop/" + SDS["U_Name"].ToString().Trim() + "/index.");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">" + SDS["title"].ToString().Trim() + "</a>\r\n");
	...
	if (SDS["DescTabName"].ToString().Trim()=="brand")
	{
	...
	XYBody.Append("          	 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("brand/info-" + SDS["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">" + SDS["title"].ToString().Trim() + "</a>\r\n");
	...
	XYBody.Append("     <a href=\"" + SDS["htmlpage"].ToString().Trim() + "\" title =\"" + SDS["title"].ToString().Trim() + "\" target =\"_blank\">\r\n");
	XYBody.Append( Method.left(SDS["title"].ToString().Trim(),40));
	XYBody.Append("</a>\r\n");

	}	//end if

	XYBody.Append("<br/>" + SDS["addtime"].ToString().Trim() + "\r\n");
	XYBody.Append("   </td>\r\n");
	XYBody.Append("   <td>\r\n");
	...
	XYBody.Append("   " + SDS["UI_LinkMan"].ToString().Trim() + "</a><br />\r\n");
	...
	XYBody.Append("" + SDS["UI_Name"].ToString().Trim() + "</a></td>\r\n");
	XYBody.Append(" </tr>\r\n");
