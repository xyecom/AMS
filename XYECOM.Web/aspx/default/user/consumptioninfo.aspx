<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.consumptioninfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        <th width=\"55%\">消费说明</th>\r\n");
	XYBody.Append("   </tr>\r\n");
	XYBody.Append("   </thead>\r\n");
	XYBody.Append("   <tbody>\r\n");
	...
	XYBody.Append("     <tr>\r\n");
	XYBody.Append("	    <td>" + row["AC_ID"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>" + row["AC_Count"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>" + row["AC_Time"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("        <td>" + row["AC_Explain"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("     </tr>\r\n");
