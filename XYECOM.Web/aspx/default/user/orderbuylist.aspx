<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.orderbuylist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("				<option value=\"1\" 	>等待卖家补充运费</option>\r\n");
	XYBody.Append("				<option value=\"2\" 	>等待您确认运费并付款</option>\r\n");
	XYBody.Append("				<option value=\"3\" 	>等待卖家确认付款</option>\r\n");
	XYBody.Append("				<option value=\"4\" 	>等待卖家确认发货</option>\r\n");
	XYBody.Append("				<option value=\"5\" 	>等待您确认收货</option>\r\n");
	XYBody.Append("				<option value=\"6\" 	>您已确认收货</option>\r\n");
	XYBody.Append("				<option value=\"7\" 	>您要求退货</option>\r\n");
	XYBody.Append("				<option value=\"8\" 	>卖家同意退货</option>\r\n");
	XYBody.Append("					</select> \r\n");
	XYBody.Append("						<input name=\"searchbutton\" class=\"button\" type=\"submit\" value=\"查 看\" />\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("  <table  class=\"content\" width=\"100%\">\r\n");
	XYBody.Append("  <caption> 共有<em>(");	XYBody.Append(counts.ToString());	XYBody.Append(")</em>符合条件！</caption>\r\n");
	XYBody.Append("  <thead>\r\n");
	XYBody.Append("	  <tr>\r\n");
	...
	XYBody.Append("		  <th style=\"height: 20px\" >卖家</th>\r\n");
	...
	XYBody.Append("    <td>\r\n");
	 str = GetInfoUrl("offer","1",sd["SD_ID"].ToString());
	...
	XYBody.Append("    </td>    \r\n");
	XYBody.Append("    <td>  \r\n");
	XYBody.Append("        <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("shop/" + sd["U_Name"].ToString().Trim() + "/index.");	XYBody.Append(config.Suffix);	XYBody.Append("\" target=\"_blank\" >\r\n");
	XYBody.Append( Method.left(sd["UI_Name1"].ToString().Trim(),10));
	XYBody.Append("</a>\r\n");
	XYBody.Append("    </td>\r\n");
	...
	XYBody.Append("   <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/orderbuyinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?OF_ID=" + sd["OF_ID"].ToString().Trim() + "\" title=\"点击修改订货数量\">修改订货数量</a>\r\n");
	...
	XYBody.Append("   <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/orderbuyinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?OF_ID=" + sd["OF_ID"].ToString().Trim() + "&&Type=2\" title=\"点击确认运费并付款\">确认运费并付款</a>\r\n");
	...
	XYBody.Append("    <a href=\"#\"onclick=\"onupdateof(" + sd["OF_ID"].ToString().Trim() + ",5)\" title=\"点击确认收货\"> 确认收货</a>\r\n");
	...
	XYBody.Append("     <a href=\"#\"onclick=\"onupdateof(" + sd["OF_ID"].ToString().Trim() + ",6)\" title=\"点击确认交易成功\" > 确认交易成功</a>/\r\n");
	XYBody.Append("    <a  href=\"#\"onclick=\"onupdateof(" + sd["OF_ID"].ToString().Trim() + ",7)\" title=\"点击要求退货\"> 要求退货</a>  \r\n");
