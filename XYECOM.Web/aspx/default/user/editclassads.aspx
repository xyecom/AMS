<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.editclassads,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("          <caption>广告分类与价格<span>(指定要购买的时间)</span></caption>\r\n");
	XYBody.Append("          <tr>\r\n");
	XYBody.Append("            <th>类别名称：</th>\r\n");
	XYBody.Append("            <td>\r\n");
	...
	XYBody.Append("            <td><input name=\"timecycle\" readonly=\"readonly\" type=\"text\" value=\"1\" id=\"timecycle\" maxlength=\"2\" size=\"2\" onblur=\"_xy_BuyKey_RecalculatedPrice()\"/> ");	XYBody.Append(timeunits.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("          </tr>  \r\n");
	XYBody.Append("          <tr>\r\n");
	...
	XYBody.Append("          </table>\r\n");
	XYBody.Append("          <table  class=\"contentl\">\r\n");
	XYBody.Append("          <caption>广告详细信息</caption>\r\n");
	XYBody.Append("          <tr>\r\n");
	...
	XYBody.Append("          </tr> \r\n");
	XYBody.Append("         <tr>\r\n");
	XYBody.Append("          <th>图片地址：</th>\r\n");
	XYBody.Append("          <td>\r\n");
	XYBody.Append("              <input id=\"txtImageUrl\" value=\"");	XYBody.Append(ImageUrl.ToString());	XYBody.Append("\"  name=\"txtImageUrl\" size=\"45\" type=\"text\" /><font color=\"red\">上传图片和填写图片地址只能选择一项</font></td>\r\n");
	XYBody.Append("          </tr>\r\n");
	XYBody.Append("          <tr>\r\n");
	XYBody.Append("          <th>广告链接地址：</th>\r\n");
	XYBody.Append("              <td>\r\n");
	XYBody.Append("              <input id=\"txtLink\" name=\"txtLink\" value=\"");	XYBody.Append(Link.ToString());	XYBody.Append("\" size=\"45\" type=\"text\" />\r\n");
	XYBody.Append("              </td>\r\n");
	XYBody.Append("          </tr>\r\n");
	XYBody.Append("          <tr>\r\n");
	XYBody.Append("          <th>广告描述：</th>\r\n");
	XYBody.Append("          <td>\r\n");
	XYBody.Append("             <textarea id=\"txtDesc\" name=\"txtDesc\" cols=\"45\" rows=\"5\">");	XYBody.Append(Desc.ToString());	XYBody.Append("</textarea>\r\n");
	XYBody.Append("          </td>\r\n");
	XYBody.Append("           </tr>\r\n");
	XYBody.Append("          </table>\r\n");
	XYBody.Append("        <div class=\"content_action\">\r\n");
	XYBody.Append("            <input name=\"\" type =\"submit\" value=\"修改\" onclick=\"return buy_classad_1_Check();\" class =\"button\" />\r\n");
	XYBody.Append("            <input name=\"but02\" type=\"button\" value=\"取消\" onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/curclassads.");	XYBody.Append(config.Suffix);	XYBody.Append("'\" class =\"button\" />\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
