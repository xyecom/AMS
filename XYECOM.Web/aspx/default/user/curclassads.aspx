<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.curclassads,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <h3>当前参与的排名</h3>    \r\n");
	XYBody.Append("    <table class=\"content\">\r\n");
	XYBody.Append("     <thead>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th width=\"30%\">类别名称</th>\r\n");
	XYBody.Append("        <th width=\"15%\">开始时间</th>\r\n");
	XYBody.Append("        <th width=\"15%\">结束时间</th>\r\n");
	XYBody.Append("         <th width=\"19%\">审核状态</th>\r\n");
	XYBody.Append("         <th width=\"19%\">是否已开始</th>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("     </thead>\r\n");
	XYBody.Append("     <tbody>\r\n");
	...
	XYBody.Append("      <tr>        \r\n");
	XYBody.Append("         <td>   \r\n");
	 str = GetAllClassNameForClassAds(rank["ClassId"].ToString());
	
	XYBody.Append("            ");	XYBody.Append(str.ToString());	XYBody.Append("\r\n");
	XYBody.Append("            </td>\r\n");
	XYBody.Append("        <td>\r\n");
	 str = GetTime(rank["BeginTime"]);
	
	XYBody.Append("        ");	XYBody.Append(str.ToString());	XYBody.Append("\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td>\r\n");
	 str = GetTime(rank["EndTime"]);
	
	XYBody.Append("        ");	XYBody.Append(str.ToString());	XYBody.Append("\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td>\r\n");
	 str = GetAllAuditingState(rank["AuditingState"].ToString());
	
	XYBody.Append("        ");	XYBody.Append(str.ToString());	XYBody.Append("\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("        <td>\r\n");
	 str = GetIsNoBegin(rank["BeginTime"],rank["EndTime"]);
