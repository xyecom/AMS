<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.favoritelist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<h2><span></span>我收藏的商业信息列表</h2>\r\n");
	XYBody.Append("<div class=\"ly_100\">\r\n");
	XYBody.Append("<div class=\"ly_tit3\">\r\n");
	XYBody.Append(" <ul>\r\n");
	XYBody.Append(" <li class=\"on\"><a   href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/favoritelist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">所有信息</a></li>\r\n");
	XYBody.Append(" <li class=\"out\"><a   href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/favoriteallbusinesslist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">商业信息</a></li>\r\n");
	XYBody.Append(" <li class=\"out\"><a   href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/favoriteotherlist.");	XYBody.Append(config.Suffix);	XYBody.Append("\">其它信息</a></li>\r\n");
	XYBody.Append(" </ul>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<table class=\"ly_tab2 ly_w1\">\r\n");
	XYBody.Append("<thead><tr><td></td><td>信息标题</td><td>联系人和公司名称</td></tr></thead>\r\n");

	int SDD__loop__id=0;
	foreach(DataRow SDD in infolist.Rows)
	{
		SDD__loop__id++;

	XYBody.Append(" <tr>\r\n");
	XYBody.Append("  <td><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + SDD["Fa_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("  <td> \r\n");

	if (SDD["HTMLPage"].ToString().Trim()=="")
	{


	if (SDD["DescTabName"].ToString().Trim()=="offer")
	{


	if (SDD["flag"].ToString().Trim()=="1")
	{
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell-offer-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">供应\r\n");
	XYBody.Append( Method.left(SDD["title"].ToString().Trim(),20));
	XYBody.Append("</a>\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=offer&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">供应\r\n");
	XYBody.Append( Method.left(SDD["title"].ToString().Trim(),40));
	XYBody.Append("</a>\r\n");
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy-offer-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">求购\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=offer&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">求购\r\n");
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy-offer-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">紧急求购\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=offer&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">紧急求购\r\n");
	...
	if (SDD["DescTabName"].ToString().Trim()=="venture")
	{
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell-venture-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">提供\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=venture&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">提供\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=venture&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">寻求\r\n");
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy-offer-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">紧急寻求\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=venture&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">紧急寻求\r\n");
	...
	if (SDD["DescTabName"].ToString().Trim()=="investment")
	{
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell-investment-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">诚招\r\n");
	XYBody.Append( Method.left(SDD["title"].ToString().Trim(),20));
	XYBody.Append("代理加盟</a>\r\n");

	}
	else
	{

	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=investment&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">诚招\r\n");
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy-investment-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">愿做\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=investment&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">愿做\r\n");
	...
	if (SDD["DescTabName"].ToString().Trim()=="service")
	{
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell-service-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">提供\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/sell.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=service&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">提供\r\n");
	...
	XYBody.Append("              <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy-service-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">寻求\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=service&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">寻求\r\n");
	...
	XYBody.Append("             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("search/buy.");	XYBody.Append(config.Suffix);	XYBody.Append("?flag=service&infoid=" + SDD["DescTabID"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">紧急寻求\r\n");
	...
	if (SDD["DescTabName"].ToString().Trim()=="exhibition")
	{
	...
	XYBody.Append("               <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("exhibition/info-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">" + SDD["title"].ToString().Trim() + "</a>\r\n");

	}
	else
	{

	XYBody.Append("	      <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("exhibition/info.");	XYBody.Append(config.Suffix);	XYBody.Append("?infoid=" + SDD["DescTabID"].ToString().Trim() + "\" target =\"_blank\">" + SDD["title"].ToString().Trim() + "</a>\r\n");
	...
	if (SDD["DescTabName"].ToString().Trim()=="company")
	{
	...
	XYBody.Append("                   <a href=\"http://" + SDD["U_Name"].ToString().Trim() + "");	XYBody.Append(pageinfo.DomainHost);	XYBody.Append("/\" target =\"_blank\">\r\n");

	}
	else
	{

	XYBody.Append("                    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("shop/" + SDD["U_Name"].ToString().Trim() + "/index.");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">" + SDD["UI_Name"].ToString().Trim() + "</a>\r\n");
	...
	if (SDD["DescTabName"].ToString().Trim()=="brand")
	{
	...
	XYBody.Append("                       <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("brand/info-" + SDD["DescTabID"].ToString().Trim() + ".");	XYBody.Append(config.Suffix);	XYBody.Append("\" target =\"_blank\">" + SDD["title"].ToString().Trim() + "</a>\r\n");

	}
	else
	{

	XYBody.Append("	             <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("brand/info.");	XYBody.Append(config.Suffix);	XYBody.Append("?infoid=" + SDD["DescTabID"].ToString().Trim() + "\" target =\"_blank\">" + SDD["title"].ToString().Trim() + "</a>\r\n");
	...
	XYBody.Append("     <a href=\"" + SDD["HTMLPage"].ToString().Trim() + "\" title =\"" + SDD["title"].ToString().Trim() + "\" target =\"_blank\">\r\n");
	XYBody.Append( Method.left(SDD["title"].ToString().Trim(),40));
	XYBody.Append("</a>\r\n");

	}	//end if

	XYBody.Append("<br/>" + SDD["AddTime"].ToString().Trim() + "\r\n");
	XYBody.Append("   </td>\r\n");
	XYBody.Append("  <td>\r\n");
	...
	XYBody.Append("   " + SDD["UI_LinkMan"].ToString().Trim() + "</a><br />\r\n");
	...
	XYBody.Append("" + SDD["UI_Name"].ToString().Trim() + "</a></td>\r\n");
	XYBody.Append(" </tr>\r\n");
	...
	XYBody.Append("<input name=\"buy\"  class=\"button\" type=\"submit\" value=\"删除\" id=\"buy\" onclick=\" return bntDelete();\"/>\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("</table>\r\n");
