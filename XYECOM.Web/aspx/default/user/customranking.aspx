<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.customranking,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("             <caption> 自定义排名信息<span>(*为必填项)</span> </caption>\r\n");
	XYBody.Append("             <tr>\r\n");
	XYBody.Append("                <th>基本信息：</th>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <table>\r\n");
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                            <td>所属模块：</td>\r\n");
	...
	XYBody.Append("             </tr>\r\n");
	XYBody.Append("             <tr>\r\n");
	XYBody.Append("                 <th>信息标题：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("                 <td>\r\n");
	XYBody.Append("                 <input  name=\"title\"  type =\"text\" id=\"title\" maxlength=\"100\" size=\"50\" value=\"");	XYBody.Append(title.ToString());	XYBody.Append("\"/> \r\n");
	XYBody.Append("                 <br/>\r\n");
	XYBody.Append("                 <span>标题尽量简洁，并包含相应关键词</span>\r\n");
	XYBody.Append("                 </td>\r\n");
	XYBody.Append("             </tr>\r\n");
	XYBody.Append("             <tr>\r\n");
	XYBody.Append("                 <th>链接地址：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("                 <td>\r\n");
	XYBody.Append("                 <input  name=\"txtURL\"  type =\"text\" id=\"link\" maxlength=\"100\" size=\"50\" value=\"");	XYBody.Append(link.ToString());	XYBody.Append("\"/> \r\n");
	XYBody.Append("                 <br/>\r\n");
	XYBody.Append("                 <span>请填写网站完整URL地址，如http://www.xyecom.com</span>\r\n");
	XYBody.Append("                 </td>\r\n");
	XYBody.Append("             </tr>\r\n");
	XYBody.Append("          <tr>\r\n");
	XYBody.Append("             <th>详细内容：</th>\r\n");
	XYBody.Append("             <td>\r\n");
	XYBody.Append("            <textarea name=\"desc\" id=\"desc\" rows=\"7\" cols=\"80\">");	XYBody.Append(desc.ToString());	XYBody.Append("</textarea>\r\n");
	XYBody.Append("             <br/>\r\n");
	XYBody.Append("            <span>100汉字以内</span>\r\n");
	XYBody.Append("             </td>\r\n");
	XYBody.Append("             </tr>\r\n");
	XYBody.Append("             <tr>\r\n");
	XYBody.Append("                <th>信息图片：</th>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <span>\r\n");
	XYBody.Append("                        <font color=\"red\">温馨提示:</font>指定图片Url地址或上传图片,优先读取指定URL的图片\r\n");
	XYBody.Append("                    </span>\r\n");
	XYBody.Append("                    <br/><br/>\r\n");
	XYBody.Append("                    <div id=\"divImgUrl\" style=\"width:100%; margin-bottom:20px;\">\r\n");
	XYBody.Append("                        <input  name=\"ImageUrl\"  type =\"text\" id=\"ImageUrl\" maxlength=\"100\" size=\"50\" value=\"");	XYBody.Append(imageurl.ToString());	XYBody.Append("\"/> 请输入图片URL\r\n");
	XYBody.Append("                    </div>\r\n");
	XYBody.Append("                    <div id=\"divUploadImg\">\r\n");
	...
	XYBody.Append("            <input name=\"btnOK\" type =\"submit\"   value=\"确定\" onclick =\"return _xy_part_checkUserDefined();\" class =\"button\" id=\"Submit1\" />\r\n");
	XYBody.Append("            <input name=\"but02\" type=\"button\" value=\"取消\" onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/rematching.");	XYBody.Append(config.Suffix);	XYBody.Append("?rid=");	XYBody.Append(rankingId.ToString());	XYBody.Append("&rank=");	XYBody.Append(rank.ToString());	XYBody.Append("';\"  class =\"button\"/>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </form>\r\n");
	XYBody.Append("</div>\r\n");
