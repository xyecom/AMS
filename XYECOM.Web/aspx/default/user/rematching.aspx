<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.rematching,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("        <caption>自动匹配排名信息<span>(从匹配结果中选择要展示的信息并提交)</span></caption>\r\n");
	...
	XYBody.Append("                        <option value=\"0\">没有匹配信息，请发布相关信息并重新匹配或自定义信息</option>\r\n");
	...
	XYBody.Append("            <input name=\"\" type =\"submit\" value=\"提交\" class =\"button\" />\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("        <table class=\"contentl\">\r\n");
	XYBody.Append("        <caption>自定义排名信息<span>(优先显示自定义信息)</span></caption>\r\n");

	int item1__loop__id=0;
	foreach(XYECOM.Configuration.ModuleInfo item1 in moduleItems)
	{
		item1__loop__id++;

	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <th>");	XYBody.Append(item1.CName.ToString());	XYBody.Append("：</th>\r\n");
	XYBody.Append("            <td align=\"left\">\r\n");
	 str = GetCustomInfoTitle(item1.EName);
