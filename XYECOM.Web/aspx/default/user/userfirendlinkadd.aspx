<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.userfirendlinkadd,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("       <caption>友情链接管理<span></span></caption>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>网站名称：\r\n");
	XYBody.Append("        </th>\r\n");
	XYBody.Append("        <td><input name=\"SiteName\" type=\"text\" value=\"");	XYBody.Append(link.SiteName.ToString());	XYBody.Append("\" size=\"30\"  maxlength=\"40\" /></td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("       <th>网站地址：</th>\r\n");
	XYBody.Append("        <td><input name=\"Url\" type=\"text\" size=\"30\" maxlength=\"40\" value=\"");	XYBody.Append(link.Url.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("	    <em>请输入完整地址,如:http://www.xyecom.com</em>  \r\n");
	XYBody.Append("	    </td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      <tr>\r\n");
	XYBody.Append("        <th>Logo地址：</th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("	    <input name=\"LogoUrl\" type=\"text\"  size=\"50\" value=\"");	XYBody.Append(link.LogoUrl.ToString());	XYBody.Append("\"  maxlength=\"50\"/>\r\n");
	XYBody.Append("	    <em>请输入完整地址,如:http://www.xyecom.com/logo.img</em>  \r\n");
	XYBody.Append("	    </td>\r\n");
	XYBody.Append("      </tr>\r\n");
	XYBody.Append("      </table>\r\n");
	XYBody.Append("      <div class=\"content_action\">\r\n");
	XYBody.Append("        <input name=\"submit\"  type=\"submit\" class=\"button\" value=\"确认\" onclick=\"javascript:return userfirendlinkinfo()\"/> \r\n");
