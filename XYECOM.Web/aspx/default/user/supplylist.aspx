<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.supplylist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("                <tr> \r\n");
	XYBody.Append("                <td><input name=\"sd_id\" id=\"sd_id\" type=\"checkbox\" value=\"" + SD["SD_ID"].ToString().Trim() + "\" /></td>\r\n");
...
	XYBody.Append( Method.left(SD["SD_Title"].ToString().Trim(),200));
	XYBody.Append("</a>\r\n");

	if (SD["isshop"].ToString().Trim()=="True")
	{

	XYBody.Append("<img src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/user/images/shopindex.gif\" alt=\"推荐到商铺首页\" />\r\n");
	...
	XYBody.Append("                <td><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?type='offer'&InfoID=" + SD["SD_ID"].ToString().Trim() + "\"><em class=\"wbg_messageNum\">" + SD["SD_MessageNum"].ToString().Trim() + "</em></a>&nbsp;条</td>\r\n");
	...
	XYBody.Append("                <input name=\"Supply\"  type=\"submit\" class=\"button\" value=\"推荐到商铺首页\"  onclick =\"return resh(4);\"/>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("        </table>\r\n");
