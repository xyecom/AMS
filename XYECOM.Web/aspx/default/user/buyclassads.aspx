<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buyclassads,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("         <caption> 购买分类广告</caption>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("            <td>\r\n");
	XYBody.Append("                <table class=\"clsAd_table\">\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td>\r\n");
	XYBody.Append("                        <div class=\"div\"> ");	XYBody.Append(classadtree.ToString());	XYBody.Append(" </div>\r\n");
	XYBody.Append("                    </td>\r\n");
	XYBody.Append("                <td  valign=\"top\" class=\"tdle\">\r\n");
	XYBody.Append("                <div class=\"div-table\">\r\n");
	XYBody.Append("                <table class=\"ly_tab2 ly_w1\">\r\n");
	XYBody.Append("                      <thead>\r\n");
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                            <td>类别名称</td>\r\n");
	...
	if (tbclassad.Rows.Count>=number)
	{

	XYBody.Append("                            <table width=\"100%\">\r\n");
	XYBody.Append("                                        <tr>\r\n");
	XYBody.Append("                                            <th>位置</th>\r\n");
	XYBody.Append("                                            <th>到期时间</th>\r\n");
	XYBody.Append("                                        </tr>\r\n");

	int rdata__loop__id=0;
	foreach(DataRow rdata in tbclassad.Rows)
	{
		rdata__loop__id++;

	XYBody.Append("                                        <tr>\r\n");
	XYBody.Append("                                            <td>位置</td>\r\n");
	XYBody.Append("                                            <td>\r\n");
	 str = GetTime(rdata["EndTime"]);
	...
	XYBody.Append("                            ");	XYBody.Append(shifoushouchu.ToString());	XYBody.Append("<a href=\"buy_classad_1.aspx?classid=");	XYBody.Append(classid.ToString());	XYBody.Append("\">");	XYBody.Append(onclickurl.ToString());	XYBody.Append("</a>\r\n");
