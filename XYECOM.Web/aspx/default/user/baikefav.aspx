<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.baikefav,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("            <tr>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + s["FavId"].ToString().Trim() + "\" />\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                    <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("baike/view.");	XYBody.Append(config.suffix);	XYBody.Append("?lid=" + s["LemmaId"].ToString().Trim() + "\">" + s["LemmaName"].ToString().Trim() + "</a>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("                <td>\r\n");
	XYBody.Append("                " + s["AddTime"].ToString().Trim() + "\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	...
	XYBody.Append("        </tbody>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("    <div class=\"gq_quanx\">\r\n");
	XYBody.Append("        <input id=\"Checkbox1\" name=\"chkAll\" type=\"checkbox\" value=\"\" onclick=\"CheckedAll();\" />全选<input\r\n");
	XYBody.Append("            name=\"message\" class=\"button\" type=\"submit\" value=\"删除\" onclick=\"return bntDelete()\" /></div>\r\n");
