<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.businessdated,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("                <td ><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/receivemessagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("?type='investment'&InfoID=" + eib["IBI_ID"].ToString().Trim() + "\"><em class=\"wbg_messageNum\">");	XYBody.Append(summessage.ToString());	XYBody.Append("</em></a> 条&nbsp;</td>\r\n");
	...
	XYBody.Append("            <input name=\"setadd\"  class=\"button\" type=\"submit\" value=\"重发\" onclick=\"return setaddinfo();\"/>\r\n");
