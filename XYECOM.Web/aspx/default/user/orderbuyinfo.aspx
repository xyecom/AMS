<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.orderbuyinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("            <tbody>\r\n");
	XYBody.Append("              <tr>\r\n");
	XYBody.Append("				<td style=\"text-align:center; padding-left:23px; color:#FF8F17; font-weight:bold; font-size:14px;line-height:30px; height:30px;\"  >					\r\n");
	...
	XYBody.Append("				<td>\r\n");
	XYBody.Append("					<table class=\"contentl\">\r\n");
	XYBody.Append("                          <caption>卖家信息</caption>                          \r\n");
	XYBody.Append("                             <tbody>\r\n");
	XYBody.Append("							  <tr>\r\n");
	XYBody.Append("                              <th>公司名称：</th>\r\n");
	XYBody.Append("                              <td><a href=\"#\" target=\"company\">");	XYBody.Append(euii.Name.ToString());	XYBody.Append("</a></td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                           <tr>\r\n");
	XYBody.Append("                              <th> 联系人：</th>\r\n");
	XYBody.Append("                              <td>");	XYBody.Append(euii.LinkMan.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                            <tr>\r\n");
	XYBody.Append("                              <th>联系电话：</th>\r\n");
	XYBody.Append("                              <td>");	XYBody.Append(euii.Telephone.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                            <tr>\r\n");
	XYBody.Append("                              <th>手机：</th>\r\n");
	XYBody.Append("                              <td>");	XYBody.Append(euii.Mobile.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                          </tbody>\r\n");
	XYBody.Append("                        </table>\r\n");
	XYBody.Append("				</td>\r\n");
	...
	XYBody.Append("			 <td>\r\n");
	XYBody.Append("              <table class=\"contentl\"> \r\n");
	XYBody.Append("              <caption>订单信息</caption>\r\n");
	XYBody.Append("                      <tbody>\r\n");
	XYBody.Append("                      <tr>\r\n");
	...
	XYBody.Append("                          <td ><input type=\"text\" name=\"txtNumber\" id=\"txtNumber\"  onchange=\"getMoneybuy()\" class=\"inputtext\" value=\"");	XYBody.Append(euid.OF_Number.ToString());	XYBody.Append("\" maxlength=\"10\" size=\"9\"/> &nbsp;");	XYBody.Append(es.Unit.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                        </tr>\r\n");
	XYBody.Append("                        <tr>\r\n");
	...
	XYBody.Append("                          <td  >\r\n");
	XYBody.Append("                          ");	XYBody.Append(CBear.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                        </tr>\r\n");
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                          <th>运费收取方式：</th>\r\n");
	XYBody.Append("                          <td >");	XYBody.Append(CBegin.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("                        </tr>\r\n");
	XYBody.Append("                        <tr>\r\n");
	...
	XYBody.Append("              <tr><td> \r\n");
	XYBody.Append("              <table class=\"contentl\">\r\n");
	XYBody.Append("              <caption>买家信息</caption>\r\n");
	XYBody.Append("                          <tbody>\r\n");
	XYBody.Append("                            <tr>\r\n");
	XYBody.Append("                              <th >联系人：</th>\r\n");
	XYBody.Append("                              <td ><input type=\"text\" name=\"txtLinkMan\" id=\"txtLinkMan\" value=\"");	XYBody.Append(euid.LinkMan.ToString());	XYBody.Append("\"/></td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                            <tr>\r\n");
	XYBody.Append("                              <th>联系电话：</th>\r\n");
	XYBody.Append("                              <td><input id=\"txtlinkTel\" maxlength=\"60\"  size=\"60\" name=\"txtlinkTel\" type=\"text\"  value=\"");	XYBody.Append(euid.LinkTel.ToString());	XYBody.Append("\"/>     \r\n");
	XYBody.Append("                            </td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                            <tr>\r\n");
	XYBody.Append("                              <th>\r\n");
	XYBody.Append("                                  送货地址：</th>\r\n");
	XYBody.Append("                              <td> <input type=\"text\" name=\"txtLinkAddress\" id=\"txtLinkAddress\" size=\"60\" value=\"");	XYBody.Append(euid.LinkAddress.ToString());	XYBody.Append("\" /> </td>\r\n");
	XYBody.Append("                            </tr>\r\n");
	XYBody.Append("                            <tr><th>买家要求：</th><td><textarea class=\"itextarea02\" name=\"tbOF_remark\" cols=\"70\" rows=\"10\" id=\"tbOF_remark\">");	XYBody.Append(euid.OF_remark.ToString());	XYBody.Append("</textarea></td></tr>\r\n");
	XYBody.Append("                          </tbody>\r\n");
	XYBody.Append("                        </table>\r\n");
	XYBody.Append("                        </td></tr>\r\n");
	XYBody.Append("                        <tr><td>\r\n");
	XYBody.Append("                        <div class=\"content_action\"><input name=\"submit\" type=\"submit\" value=\"确定\" id=\"btnupdateof\" onclick=\"javascript:return updateofbuy();\" class =\"button\"/>\r\n");
	XYBody.Append("    <input type=\"button\" class=\"button\" id=\"Button1\" value=\"取消\" onclick=\"window.history.go(-1);\" /></div>\r\n");
	XYBody.Append("                        </td></tr>\r\n");
	XYBody.Append("            </tbody>\r\n");
	XYBody.Append("        </table>\r\n");
	XYBody.Append("           </form>\r\n");
