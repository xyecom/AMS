<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.certificateinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>修改企业证书<span>（*为必填项）</span></caption>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>证书名称：<em class=\"red\">*</em><span></span></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	<input name=\"txtname\" id=\"txtname\" type=\"text\" maxlength=\"30\" size=\"30\" value=\"");	XYBody.Append(name.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("    </td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>证书类别：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("    <select id=\"txttype\" name=\"txttype\">\r\n");
	XYBody.Append("    <option value=\"0\">请选择证书类别</option>\r\n");
	...
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th >\r\n");
	XYBody.Append("        发证机构：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("    <input name=\"txtorgan\" id=\"txtorgan\" type=\"text\" maxlength=\"30\" size=\"30\" value=\"");	XYBody.Append(organ.ToString());	XYBody.Append("\" />\r\n");
	XYBody.Append("      </td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th >生效日期：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("  <td>\r\n");
	XYBody.Append("  <input onclick=\"getDateString(this);\" id=\"txtbegin\" maxlength=\"15\" readonly=\"readonly\" name =\"txtbegin\" value=\"");	XYBody.Append(begin.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("<tr>\r\n");
	XYBody.Append("<th>\r\n");
	XYBody.Append("    截至日期：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("<td>\r\n");
	XYBody.Append("<input onclick=\"getDateString(this);\" id=\"txtupto\" maxlength=\"15\" readonly=\"readonly\" name =\"txtupto\" value=\"");	XYBody.Append(upto.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	XYBody.Append("<tr>\r\n");
	XYBody.Append("<th>\r\n");
	XYBody.Append("    上传证书：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("<td>\r\n");
	XYBody.Append("<input type=\"hidden\" id=\"aurl\" name=\"aurl\" value=\"\"/>\r\n");
	...
	XYBody.Append("<tr>\r\n");
	XYBody.Append("<th>\r\n");
	XYBody.Append("    您上传的时间：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("<td>\r\n");
	XYBody.Append(" <input  id=\"txtaddtime\" maxlength=\"15\" readonly=\"readonly\" name =\"txtaddtime\" value=\"");	XYBody.Append(addtime.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("</td>\r\n");
	XYBody.Append("</tr>\r\n");
	...
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("    <th>审核未通过原因：</th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        ");	XYBody.Append(causation.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>推荐建议：</th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("        ");	XYBody.Append(advice.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("  </tr>\r\n");

	}	//end if

	XYBody.Append("  </table>\r\n");
	XYBody.Append("<div class=\"content_action\"><input name=\"but01\" type =\"submit\" value=\"确定\" onclick =\"return certificate();\" class =\"button\" />\r\n");
