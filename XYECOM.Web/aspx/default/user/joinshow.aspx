<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.joinshow,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<h2>留言详情</h2>\r\n");
	XYBody.Append("<div id=\"ly_box1\">\r\n");
	XYBody.Append("  <div class=\"titles\"></div>\r\n");
	XYBody.Append("  <ul>\r\n");
	XYBody.Append("    <li>\r\n");
	XYBody.Append("	  <strong>代理过的品牌：");	XYBody.Append(quondamproduct.ToString());	XYBody.Append("</strong>	  \r\n");
	XYBody.Append("	</li>\r\n");
	XYBody.Append("    <li>\r\n");
	XYBody.Append("	  <strong>可代理地区：");	XYBody.Append(areas.ToString());	XYBody.Append("</strong>	  \r\n");
	XYBody.Append("	</li>\r\n");
	...
	XYBody.Append("	<li class=\"red\">您当前所在的用户组不能查看联系方式，请联系管理员升级！</li>\r\n");
