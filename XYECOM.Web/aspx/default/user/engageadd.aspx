<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.engageadd,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("  <caption>发布招聘信息 <span>（*为必填项）</span></caption>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>拟招聘岗位：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("        <td>   \r\n");
	XYBody.Append("            <input type =\"hidden\" id=\"engageaid\"  name=\"engageaid\"/>  \r\n");
	XYBody.Append("            <div id=\"classTypejob\"></div>\r\n");
	XYBody.Append("        </td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>具体职位名称：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td><input name=\"EI_Job\" type=\"text\" maxlength=\"40\" /><em>注：应与上一项拟招聘岗位相匹配</em></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>招聘类型：</th>\r\n");
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	    <select name=\"EI_Type\" id =\"EI_Type\">\r\n");
	...
	XYBody.Append("    <td><input name=\"EI_Branch\" type=\"text\" id=\"EI_Branch\" maxlength=\"40\" /></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>  \r\n");
	XYBody.Append("    <th >招聘人数：</th>\r\n");
	XYBody.Append("    <td><input name=\"EI_Number\" type=\"text\" size=\"8\" id=\"EI_Number\" maxlength=\"20\"/>人<em>注：只能填数字</em></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("   <tr>\r\n");
	XYBody.Append("    <th>截至日期：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td><input onclick=\"getDateString(this);\" id=\"EI_EndDate\"  readonly=\"readonly\" name =\"EI_EndDate\"/><em>注：（系统默认30天）</em></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("<tr>\r\n");
	XYBody.Append("    <th>工作地区：<em class=\"red\">*</em></th>\r\n");
	XYBody.Append("    <td>\r\n");
	...
	XYBody.Append("    <td><textarea name=\"EI_Request\" cols=\"60\" rows=\"8\"></textarea><em>注：（60-650字）</em>	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th >薪资福利：</th>\r\n");
	XYBody.Append("    <td><input name=\"EI_Pay\" type=\"text\" value=\"0\" size=\"8\"  id=\"EI_Pay\"/> 元<em>注：（0为面议，只能填数字）</em>	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  </table>\r\n");
	XYBody.Append("  <br>\r\n");
	XYBody.Append("  <table   class=\"contentl\">\r\n");
	...
	XYBody.Append("    <td>\r\n");
	XYBody.Append("	    <select name=\"EI_Eb\" id =\"EI_Eb\">\r\n");
	XYBody.Append("        <option value=\"不限\">不限</option>\r\n");
	...
	XYBody.Append("        <td>\r\n");
	XYBody.Append("	        <select name=\"EI_Age\" id=\"EI_Age\">\r\n");
	XYBody.Append("            <option value=\"不限\">不限</option>\r\n");
	...
	XYBody.Append("            </select> 岁\r\n");
	XYBody.Append("	    </td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("        <th>性别：</th>\r\n");
	XYBody.Append("        <td>\r\n");
	XYBody.Append("	        <select name=\"EI_Sex\" id=\"EI_Sex\">\r\n");
	XYBody.Append("            <option value=\"不限\">不限</option>\r\n");
	...
	XYBody.Append("        <td><input id=\"EI_Experience\" type=\"text\" name=\"EI_Experience\" size=\"5\"  />年以上	</td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("  <tr>\r\n");
	XYBody.Append("    <th>户口所在地：</th>\r\n");
	XYBody.Append("    <td><input id=\"EI_Nationality\" name=\"EI_Nationality\" type=\"text\"size=\"40\"  maxlength=\"180\"/></td>\r\n");
	XYBody.Append("  </tr>\r\n");
	XYBody.Append("</table>\r\n");
	XYBody.Append("<div class=\"content_action\">\r\n");
	XYBody.Append("    <input  type=\"submit\" class=\"button\" value=\"确认无误，提交！\" onclick=\"javascript:return engeinfo();\"/>\r\n");
	XYBody.Append("    <input  type=\"button\" class=\"button\" value=\"取消\" onclick=\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/engagelist.");	XYBody.Append(config.Suffix);	XYBody.Append("';\"/>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<br/><br/>\r\n");
	XYBody.Append("<!--检查联系信息-->\r\n");
	XYBody.Append("<table class=\"contentl\">\r\n");
	XYBody.Append("<caption>请检查您的联系信息</caption>\r\n");
	XYBody.Append("  <tr>\r\n");
