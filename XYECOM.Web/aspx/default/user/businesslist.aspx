<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.businesslist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("<div class=\"location fia\"><a href=\"index.");	XYBody.Append(config.Suffix);	XYBody.Append("\">个人中心</a> &gt; <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/businesslist.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("\">商业信息</a> &gt;  ");	XYBody.Append(module.CName.ToString());	XYBody.Append("管理</div>\r\n");
	...
	XYBody.Append("       <h2><span><input type=\"button\" class=\"button\" value=\"发布新的");	XYBody.Append(module.CName.ToString());	XYBody.Append("\"  onclick =\"window.location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/dis_post_step.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("'\"/></span>管理");	XYBody.Append(module.CName.ToString());	XYBody.Append("</h2>\r\n");
	...
	XYBody.Append("     <li class=\"out\"><a href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/businessisauditinglist.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("\">审核中(");	XYBody.Append(auditingcount.ToString());	XYBody.Append(")</a></li>\r\n");
	XYBody.Append("     <li class=\"out\"><a href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/businessnotaudtiinglist.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("\">审核未通过(");	XYBody.Append(notauditedcount.ToString());	XYBody.Append(")</a></li>\r\n");
	XYBody.Append("     <li class=\"out\"><a href =\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/businessdated.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("\">已过期(");	XYBody.Append(datedcount.ToString());	XYBody.Append(")</a></li>\r\n");
	XYBody.Append("     </ul>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <div class=\"ly_tit32\">\r\n");
	XYBody.Append("    关键字：<input type=\"text\" id=\"key\" maxlength=\"50\"  name =\"key\" value=\"");	XYBody.Append(key.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("        <select  id=\"infotype\" name =\"infotype\" >\r\n");
	XYBody.Append("         <option value=\"all\">所有信息</option>\r\n");

	int item1__loop__id=0;
	foreach(ModuleItemInfo item1 in module.Item)
	{
		item1__loop__id++;
	...
	XYBody.Append("            <option value=\"");	XYBody.Append(item1.ID.ToString().ToString());	XYBody.Append("\" selected>");	XYBody.Append(item1.Prefix.ToString());	XYBody.Append("");	XYBody.Append(item1.Postfix.ToString());	XYBody.Append("信息</option>\r\n");
	...
	XYBody.Append("    <input type=\"submit\" name=\"submit_search\" class =\"button\" value=\"查询\"/>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </div> \r\n");
	XYBody.Append("        <table class=\"ly_tab2 ly_w1\" id=\"businessauditing\">\r\n");
	XYBody.Append("            <thead><tr>\r\n");
	XYBody.Append("	                  <td>选择</td>	\r\n");
	XYBody.Append("	                   <td>图片</td>      \r\n");
	XYBody.Append("		              <td>标题</td>\r\n");
	XYBody.Append("		              <td>发布日期</td>\r\n");
	XYBody.Append("		              <td>状态</td>\r\n");
	XYBody.Append("		              <td>浏览次数</td>\r\n");
	XYBody.Append("		              <td>留言</td>\r\n");
	XYBody.Append("		              <td>修改</td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("            </thead>\r\n");
	XYBody.Append("            <tbody>\r\n");

	int eib__loop__id=0;
	foreach(DataRow eib in infolist.Rows)
	{
		eib__loop__id++;

	XYBody.Append("                  <tr>\r\n");
	XYBody.Append("                    <td ><input id=\"sd_id\" name=\"sd_id\" type=\"checkbox\" value=\"" + eib["IBI_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("                       <td >\r\n");
	 infoimg = GetInfoImgHref(eib["IBI_ID"].ToString());
	

	if (infoimg=="")
	{

	XYBody.Append("                            <img src=\"/common/images/DefaultImg.gif\" alt=\"" + eib["IBI_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}
	else
	{

	XYBody.Append("                            <img src=\"");	XYBody.Append(infoimg.ToString());	XYBody.Append("\" alt=\"" + eib["IBI_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}	//end if

	XYBody.Append("                       </td>\r\n");
	XYBody.Append("                    <td class=\"infoTitle\">\r\n");
	 infourl = GetInfoUrl(module.EName,eib["IBI_Sign"].ToString(),eib["IBI_ID"].ToString());
	
	XYBody.Append("                        <a href=\"");	XYBody.Append(infourl.ToString());	XYBody.Append("\" target =\"_blank\">\r\n");
	XYBody.Append( Method.left(eib["IBI_Title"].ToString().Trim(),20));
	XYBody.Append("</a>\r\n");
	XYBody.Append("                     </td>\r\n");
	XYBody.Append("                    <td class=\"wbg_setTime\">" + eib["IBI_PublishDate"].ToString().Trim() + "</td>  \r\n");
	XYBody.Append("                    <td style=\"text-align:center;\">\r\n");

	if (eib["IBI_Pause"].ToString().Trim()=="False")
	{

	XYBody.Append("<span style=\"color:#f60;;\">暂停</span>\r\n");

	}
	else
	{

	XYBody.Append("<span style=\"color:#336600;\">正常</span>\r\n");

	}	//end if

	XYBody.Append("                    </td>\r\n");
	XYBody.Append("                    <td class=\"wbg_clicknum\">" + eib["IBI_ClickNum"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                    <td >\r\n");
	 infourl = GetMessageListURL(eib["IBI_Sign"].ToString(),eib["IBI_ID"].ToString());
	
	XYBody.Append("                        <a href=\"");	XYBody.Append(infourl.ToString());	XYBody.Append("\"><em class=\"wbg_messageNum\">" + eib["IBI_MessageNum"].ToString().Trim() + "</em></a> 条&nbsp;</td>\r\n");
	XYBody.Append("                   <td><input type =\"button\" class =\"button\"  value =\"修改\" onclick =\"location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("user/adv_post.");	XYBody.Append(config.Suffix);	XYBody.Append("?ename=");	XYBody.Append(pageinfo.ModuleFlag);	XYBody.Append("&flag=" + eib["IBI_Sign"].ToString().Trim() + "&info_ID=" + eib["IBI_ID"].ToString().Trim() + "';\"/></td>\r\n");
	XYBody.Append("                    </tr>\r\n");
	...
	XYBody.Append("                    <input name=\"business\"  type=\"submit\" class=\"button\" value=\"启用\" onclick=\"return resh(3);\"/>\r\n");
	XYBody.Append("                    <input name =\"business\"type=\"submit\" class=\"button\" value=\"暂停\" onclick=\"return resh(2);\" />\r\n");
	XYBody.Append("                    <input name=\"refurbish\"  class=\"button\" type=\"submit\" value=\"刷新\" onclick=\"return resh(1);\"/>\r\n");
	XYBody.Append("                    <input name=\"business\"  class=\"button\" type=\"submit\" value=\"删除\" onclick=\"return bntDelete();\"/>\r\n");
	XYBody.Append("                </td>\r\n");
	XYBody.Append("            </tr>\r\n");
	XYBody.Append("        </table>\r\n");
