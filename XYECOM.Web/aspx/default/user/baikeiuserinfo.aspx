<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.baikeiuserinfo,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("    <script type=\"text/javascript\">\r\n");
	XYBody.Append("       function cl()\r\n");
	XYBody.Append("        {\r\n");
	XYBody.Append("            var i = 0;\r\n");
	XYBody.Append("            for(i=0;i<3;i++){\r\n");
	XYBody.Append("                $(\"li_\"+i).className= \"out\";\r\n");
	XYBody.Append("            }               \r\n");
	XYBody.Append("            $(\"li_\"+");	XYBody.Append(status.ToString());	XYBody.Append(").className = \"on\";\r\n");
	XYBody.Append("        }\r\n");
	XYBody.Append("    </" + "script>    \r\n");
	...
	XYBody.Append("                <ul>\r\n");
	XYBody.Append("                    <ul>\r\n");
	XYBody.Append("                        <li id=\"li_0\" class=\"on\"><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/baikeiuserinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?status=0\">\r\n");
	XYBody.Append("                            未通过</a> </li>\r\n");
	XYBody.Append("                        <li id=\"li_1\" class=\"out\"><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/baikeiuserinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?status=1\">\r\n");
	XYBody.Append("                            待审核</a> </li>\r\n");
	XYBody.Append("                        <li id=\"li_2\" class=\"out\"><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("user/baikeiuserinfo.");	XYBody.Append(config.Suffix);	XYBody.Append("?status=2\">\r\n");
	XYBody.Append("                            已通过</a> </li>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("        <div class=\"ly_100\">\r\n");
	XYBody.Append("            <table style=\"width: 100%;\">\r\n");
	XYBody.Append("                <tr>\r\n");
	XYBody.Append("                    <td colspan=\"3\">\r\n");
	XYBody.Append("                        <!--未通过-->\r\n");
	XYBody.Append("                        <table class=\"ly_tab2 ly_w1\" id=\"businessauditing\" width=\"100%\" style=\"line-height: 24px;\">\r\n");
	...
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        最新版本查看\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        编辑我的版本\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                </tr>\r\n");
	XYBody.Append("                            </thead>\r\n");
	XYBody.Append("                            <tbody>\r\n");
	...
	XYBody.Append("                                <tr>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        " + eb["LemmaName"].ToString().Trim() + "\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        " + eb["ModiyDate"].ToString().Trim() + "\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        " + eb["FailReason"].ToString().Trim() + "\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        " + eb["FailTime"].ToString().Trim() + "\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");

	if (int.Parse(eb["LemmaId"].ToString())<1)
	{
	...
	XYBody.Append("                                        <a href='#' onclick=\"location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("/view.");	XYBody.Append(config.Suffix);	XYBody.Append("?lid=" + eb["LemmaId"].ToString().Trim() + "'\"\r\n");
	XYBody.Append("                                            target=\"_blank\">查看</a>\r\n");

	}	//end if

	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                    <td>\r\n");
	XYBody.Append("                                        <input type=\"button\" class=\"button\" value=\"编辑\" onclick=\"location.href='");	XYBody.Append(config.WebURL);	XYBody.Append("baike/lemmaedit.");	XYBody.Append(config.Suffix);	XYBody.Append("?lid=" + eb["LemmaTmpId"].ToString().Trim() + "';\" />\r\n");
	XYBody.Append("                                    </td>\r\n");
	XYBody.Append("                                </tr>\r\n");
	...
	XYBody.Append("                                            </td>\r\n");
	XYBody.Append("                                            <td>\r\n");
	XYBody.Append("                                                " + eb["PassTime"].ToString().Trim() + "\r\n");
	XYBody.Append("                                            </td>\r\n");
	XYBody.Append("                                            <td>\r\n");
	XYBody.Append("                                                " + eb["ModifyReason"].ToString().Trim() + "\r\n");
	XYBody.Append("                                            </td>\r\n");
	XYBody.Append("                                            <td>\r\n");
	XYBody.Append("                                                " + eb["ModiyDate"].ToString().Trim() + "\r\n");
	XYBody.Append("                                            </td>\r\n");
	XYBody.Append("                                            <!--<td>\r\n");
	XYBody.Append("                                                " + eb["LemmaTmpId"].ToString().Trim() + "\r\n");
	XYBody.Append("                                            </td>-->\r\n");
	XYBody.Append("                                            <td>\r\n");
	XYBody.Append("                                                " + eb["BrowseTimes"].ToString().Trim() + "\r\n");
	XYBody.Append("                                            </td>\r\n");
	XYBody.Append("                                            <td>\r\n");
	XYBody.Append("                                                " + eb["EditTimes"].ToString().Trim() + "\r\n");
	XYBody.Append("                                            </td>\r\n");
	XYBody.Append("                                        </tr>\r\n");
