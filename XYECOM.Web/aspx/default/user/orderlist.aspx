<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.orderlist,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("	   <tbody>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("          <th style=\"width: 88px\">公司名称：</th>\r\n");
	XYBody.Append("          <td >   						  	  \r\n");
	XYBody.Append("					");	XYBody.Append(euii.Name.ToString());	XYBody.Append("\r\n");
	XYBody.Append("		 </td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("          <th style=\"width: 88px\"> 联系人：</th>\r\n");
	XYBody.Append("          <td  >");	XYBody.Append(euii.LinkMan.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("          <th style=\"width: 88px\">联系电话：</th>\r\n");
	XYBody.Append("          <td>");	XYBody.Append(euii.Telephone.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("        </tr>\r\n");
	XYBody.Append("        <tr>\r\n");
	XYBody.Append("          <th style=\"width: 88px\">手机：</th>\r\n");
	...
	XYBody.Append("      <td  style=\"font-weight:bold; font-size:14px;line-height:30px; height:30px;\"  >\r\n");
	...
	XYBody.Append("	</td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr id=\"showTRFlag\">\r\n");
	...
	XYBody.Append("      <td >\r\n");
	XYBody.Append("		<font color=\"#FF0000\"><strong>");	XYBody.Append(euid.OF_Money.ToString());	XYBody.Append("</strong> </font>元</td>\r\n");
	XYBody.Append("    </tr>                      \r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("      <th>\r\n");
	XYBody.Append("          订货时间：</th>\r\n");
	XYBody.Append("      <td  >");	XYBody.Append(euid.OF_BeginTime.ToString());	XYBody.Append("</td>\r\n");
	XYBody.Append("    </tr>                        \r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("      <th style=\"height: 21px\">买家汇款确认时间： </th>\r\n");
	XYBody.Append("      <td style=\"height: 21px\" >\r\n");
	XYBody.Append("      ");	XYBody.Append(bmoneytime.ToString());	XYBody.Append("                         \r\n");
	XYBody.Append("		</td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("      <th>卖家收款确认时间： </th>\r\n");
	XYBody.Append("      <td >");	XYBody.Append(amoneytime.ToString());	XYBody.Append("\r\n");
	XYBody.Append("		</td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("      <th>卖家发货确认时间： </th>\r\n");
	XYBody.Append("      <td >");	XYBody.Append(bgoodstime.ToString());	XYBody.Append("\r\n");
	XYBody.Append("		</td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("      <th>买家收货确认时间： </th>\r\n");
	XYBody.Append("      <td >");	XYBody.Append(agoodstime.ToString());	XYBody.Append("\r\n");
	XYBody.Append("		</td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("    <tr>\r\n");
	XYBody.Append("      <th>定单失效时间： </th>\r\n");
	XYBody.Append("      <td >");	XYBody.Append(achieye.ToString());	XYBody.Append("\r\n");
	XYBody.Append("		</td>\r\n");
	XYBody.Append("    </tr>\r\n");
	XYBody.Append("  </tbody>\r\n");
	XYBody.Append("</table>\r\n");
	...
	XYBody.Append("      </tbody>\r\n");
	XYBody.Append("    </table>\r\n");
	XYBody.Append("                        <div class=\"content_action\"><input type=\"button\" class=\"button\" id=\"updateof\" value=\"返回\" onclick=\"window.history.go(-1);\" /></div>\r\n");
	XYBody.Append("        </form>\r\n");
	XYBody.Append("        </div>\r\n");
