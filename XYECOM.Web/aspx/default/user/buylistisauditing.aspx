<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.user.buylistisauditing,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	int SDT__loop__id=0;
	foreach(DataRow SDT in infolist.Rows)
	{
		SDT__loop__id++;

	XYBody.Append("                   <tr> \r\n");
	XYBody.Append("                  <td ><input  name=\"sd_id\" id=\"sd_id\"  type=\"checkbox\" value=\"" + SDT["SD_ID"].ToString().Trim() + "\" /></td>\r\n");
	XYBody.Append("                    <td >\r\n");
	 infoimg = GetInfoImgHref(SDT["SD_ID"].ToString());
	

	if (infoimg=="")
	{

	XYBody.Append("                            <img src=\"/common/images/DefaultImg.gif\" alt=\"" + SDT["SD_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}
	else
	{

	XYBody.Append("                            <img src=\"");	XYBody.Append(infoimg.ToString());	XYBody.Append("\" alt=\"" + SDT["SD_Title"].ToString().Trim() + "\" width=\"60\" height=\"60\" />\r\n");

	}	//end if

	XYBody.Append("                    </td>\r\n");
	XYBody.Append("                    <td class=\"infoTitle\">\r\n");
	XYBody.Append( Method.left(SDT["SD_Title"].ToString().Trim(),20));
	XYBody.Append("                    </td>\r\n");
	XYBody.Append("                    <td class=\"wbg_setTime\">" + SDT["SD_PublishDate"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                    <td style=\"text-align:center;\">\r\n");

	if (SDT["SD_IsSupply"].ToString().Trim()=="True")
	{
