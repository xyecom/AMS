<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.teambuy.list,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("     <script type=\"text/javascript\" src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/js/validate.js\" language=\"javascript\"></" + "script>\r\n");
	XYBody.Append("     <script type=\"text/javascript\" src=\"");	XYBody.Append(config.WebURL);	XYBody.Append("templates/");	XYBody.Append(config.TemplatePath);	XYBody.Append("/js/SupplyBuyValidate.js\" language=\"javascript\"></" + "script>\r\n");
	...
	XYBody.Append("            } else {\r\n");
	XYBody.Append("                url += \".\" + config.Suffix + \"?keyword=\" + keyword;\r\n");
	XYBody.Append("                if (style != '') {\r\n");
	XYBody.Append("                    url += \"&style=\" + style;\r\n");
	XYBody.Append("                }\r\n");
	XYBody.Append("                if (pagesize != '') {\r\n");
	XYBody.Append("                    if (!IsNum(pagesize)) {\r\n");
	XYBody.Append("                        return alertmsg(false, '每页显示页数必须是数字！');\r\n");
	XYBody.Append("                    }\r\n");
	XYBody.Append("                    url += \"&pagesize=\" + pagesize;\r\n");
	XYBody.Append("                }\r\n");
	XYBody.Append("                if (pageindex != '') {\r\n");
	XYBody.Append("                    url += \"&pageindex=\" + pageindex;\r\n");
	XYBody.Append("                }\r\n");
	XYBody.Append("                window.location.href = url;\r\n");
	XYBody.Append("            }\r\n");
	XYBody.Append("        }\r\n");
