...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("                        <a href=\"");	XYBody.Append(config.weburl);	XYBody.Append("vote.");	XYBody.Append(config.suffix);	XYBody.Append("?voteid=" + vote["voteid"].ToString().Trim() + "\">" + vote["title"].ToString().Trim() + "</a></p>\r\n");
	XYBody.Append("                    <p class=\"height1\">\r\n");
	XYBody.Append("                        " + vote["desc"].ToString().Trim() + "</p>\r\n");
	XYBody.Append("                    <p class=\"height1\">\r\n");
	XYBody.Append("                        开始时间：" + vote["startTime"].ToString().Trim() + " | 结束时间：" + vote["endtime"].ToString().Trim() + "</p>\r\n");
	XYBody.Append("                </div>\r\n");
	...
	XYBody.Append("                    热点新闻排行</h2>\r\n");
	XYBody.Append("                <div class=\"su-div1\">\r\n");
	XYBody.Append("                    <p class=\"t1\">\r\n");
	XYBody.Append("                        <a href=\"\">北京有限公司撒旦发射点法大范甘迪萨芬广东佛山</a></p>\r\n");
	XYBody.Append("                    <p class=\"t2\">\r\n");
	XYBody.Append("                        <a href=\"\">北京有限公司撒旦发射点法大范甘迪</a></p>\r\n");
	XYBody.Append("                    <p class=\"t3\">\r\n");
	XYBody.Append("                        <a href=\"\">北京有限公司撒旦发射点</a></p>\r\n");
	XYBody.Append("                    <p class=\"t4\">\r\n");
	XYBody.Append("                        <a href=\"\">北京有限公司</a></p>\r\n");
	...
	XYBody.Append("                    <span class=\"nav-left\">最新企业</span><span class=\"span-right\"><a href=\"#\">更多</a></span></h2>\r\n");
	XYBody.Append("                <div class=\"su-div1\">\r\n");
	XYBody.Append("                    <p class=\"t4\">\r\n");
	XYBody.Append("                        <a href=\"\">北京有限公司</a></p>\r\n");
	XYBody.Append("                    <p class=\"t5\">\r\n");
	...
	XYBody.Append("                </div>\r\n");
	XYBody.Append("                <h2 class=\"su-h21\">\r\n");
	XYBody.Append("                    <span class=\"nav-left\">推荐企业</span><span class=\"span-right\"><a href=\"#\">更多</a></span></h2>\r\n");
	XYBody.Append("                <div class=\"su-div1\">\r\n");
	XYBody.Append("                    <p class=\"p1\">\r\n");
	XYBody.Append("                        地方噶士大夫撒旦撒地方啊斯蒂芬</p>\r\n");
	XYBody.Append("                    <ul class=\"su-ul1\">\r\n");
	XYBody.Append("                        <div class=\"su-pr\">\r\n");
	XYBody.Append("                            <a href=\"\">\r\n");
	XYBody.Append("                                <img src=\"");	XYBody.Append(config.weburl);	XYBody.Append("templates/default/images/su.jpg\" width=\"105\" height=\"73\"></a></div>\r\n");
	XYBody.Append("                        的方法士大夫撒旦啊斯蒂芬撒地方阿萨德啊斯蒂芬啊斯蒂芬暗室逢灯大师傅士大夫似的啊斯蒂芬啊斯蒂芬啊斯蒂芬啊斯蒂\r\n");
	XYBody.Append("                    </ul>\r\n");
	XYBody.Append("                    <p class=\"height1\">\r\n");
	XYBody.Append("                        <b>目标人群：所有的消费者</b></p>\r\n");
	XYBody.Append("                    <p class=\"height1\">\r\n");
	XYBody.Append("                        <b>完成调查的奖励：</b></p>\r\n");
	XYBody.Append("                    <p class=\"width\">\r\n");
	XYBody.Append("                        ￥200元(1名幸运者)</p>\r\n");
	XYBody.Append("                    <p class=\"width\">\r\n");
	XYBody.Append("                        ￥100元(2名幸运者)</p>\r\n");
	XYBody.Append("                    <p class=\"width\">\r\n");
	XYBody.Append("                        ￥10元(25名幸运者)</p>\r\n");
	XYBody.Append("                    <p class=\"width\">\r\n");
	XYBody.Append("                        ￥5元(每位填写者)</p>\r\n");
	XYBody.Append("                </div>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </div>\r\n");
