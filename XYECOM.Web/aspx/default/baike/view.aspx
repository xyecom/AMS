...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("	<h3><span class=\"texts\">英文：");	XYBody.Append(info.EnName.ToString());	XYBody.Append("</span><a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("baike/list.");	XYBody.Append(config.Suffix);	XYBody.Append("\">回列表</a></h3>\r\n");
	XYBody.Append("	<div class=\"content_topp\">\r\n");
	XYBody.Append("	<P>");	XYBody.Append(info.Content.ToString());	XYBody.Append("</P>\r\n");
	XYBody.Append("	</div>\r\n");
	XYBody.Append("		</div>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("<p class=\"main l mar-t8\">&#8594;如果您认为本词条还有待完善，请 <a href=\"");	XYBody.Append(config.WebURL);	XYBody.Append("baike/lemmaedit.");	XYBody.Append(config.Suffix);	XYBody.Append("?lid=");	XYBody.Append(info.LemmaId.ToString());	XYBody.Append("\" class=\"font14\">编辑词条</a></p>\r\n");
	XYBody.Append("<p class=\"main l ct-label\" ><span class=\"bold\">扩展阅读:</span>\r\n");
	...
	XYBody.Append("	<span class=\"bold\">收藏此词条: </span><input type=\"button\" onclick=\"FavoriteLemma();\" value=\"收藏\" /> &nbsp;	\r\n");
	XYBody.Append("</div>\r\n");
