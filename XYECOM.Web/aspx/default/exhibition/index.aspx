<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.exhibition.index,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("						<a href=\"\" class=\"h2_exhi1\"><h2>推荐展会</h2></a>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cnt\">\r\n");
	XYBody.Append("					<div id=\"best_exhi\">\r\n");
	XYBody.Append("						<ul>\r\n");
	XYBody.Append("							" +  XYECOMCreateHTML("XY_ShowIndex_TuijianZhanHui").ToString() + "\r\n");
	XYBody.Append("						</ul>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("					<div class=\"exhi_page\">\r\n");
	XYBody.Append("						<div class=\"exhi_list\">\r\n");
	XYBody.Append("							<ul class=\"bd\">\r\n");
	XYBody.Append("								<li class=\"l1 bold\">展会标题</li>\r\n");
	XYBody.Append("								<li class=\"l2 bold\">开展时间</li>\r\n");
	XYBody.Append("								<li class=\"l3 bold\">地点</li>\r\n");
	XYBody.Append("							</ul>\r\n");
	XYBody.Append("							<ul>\r\n");
	XYBody.Append("								" +  XYECOMCreateHTML("XY_ShowIndex_TuijianZhanHui01").ToString() + "\r\n");
	XYBody.Append("							</ul>\r\n");
	XYBody.Append("						</div>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	...
	XYBody.Append("					<div class=\"tit\">\r\n");
	XYBody.Append("						<span class=\"fright\"><a href=\"\" class=\"black\">更多&raquo;</a></span>\r\n");
	XYBody.Append("						<a href=\"\" class=\"h2_exhi2\"><h2>国内展会</h2></a>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cnt\">\r\n");
	XYBody.Append("					<div class=\"exhi_page\">\r\n");
	...
	XYBody.Append("							</ul>\r\n");
	XYBody.Append("							<ul>\r\n");
	XYBody.Append("								" +  XYECOMCreateHTML("XY_ShowIndex_GuoNeiZhanHui").ToString() + "\r\n");
	XYBody.Append("							</ul>\r\n");
	XYBody.Append("						</div>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	...
	XYBody.Append("					<div class=\"tit\">\r\n");
	XYBody.Append("						<span class=\"fright\"><a href=\"\" class=\"black\">更多&raquo;</a></span>\r\n");
	XYBody.Append("						<a href=\"\" class=\"h2_exhi3\"><h2>国际展会</h2></a>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("				<div class=\"cnt\">\r\n");
	XYBody.Append("					<div class=\"exhi_page\">\r\n");
	...
	XYBody.Append("							</ul>\r\n");
	XYBody.Append("							<ul>\r\n");
	XYBody.Append("								" +  XYECOMCreateHTML("XY_ShowIndex_GuoWaiZhanHui").ToString() + "\r\n");
	XYBody.Append("							</ul>\r\n");
	XYBody.Append("						</div>\r\n");
	XYBody.Append("					</div>\r\n");
	XYBody.Append("				</div>\r\n");
	...
	XYBody.Append("							<option value=\"\">国外会展</option>\r\n");
	...
	XYBody.Append("					<ul>\r\n");
	XYBody.Append("						" +  XYECOMCreateHTML("XY_ShowIndex_News").ToString() + "\r\n");
	XYBody.Append("					</ul>\r\n");
	XYBody.Append("				</div>\r\n");
	XYBody.Append("			</div>\r\n");
	XYBody.Append("			<div class=\"MTitle_01\">\r\n");
	...
	XYBody.Append("			<ul>\r\n");
	XYBody.Append("				" +  XYECOMCreateHTML("XY_Index_HangYePinPai").ToString() + "s\r\n");
	XYBody.Append("				<div class=\"clr\"></div>\r\n");
	XYBody.Append("			</ul>\r\n");
	XYBody.Append("			<div class=\"clr\"></div>\r\n");
	XYBody.Append("		</div>\r\n");
