...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("	  <span class=\"font14s\">\r\n");
	XYBody.Append("       <a href=\"");	XYBody.Append(str.ToString());	XYBody.Append("\">\r\n");
	XYBody.Append("	  " + info["infoTitle"].ToString().Trim() + "</a></span> ( 发布时间：" + info["addtime"].ToString().Trim() + " )</li>\r\n");
