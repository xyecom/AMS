...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("	<h2>品牌介绍</h2>\r\n");
	XYBody.Append("	<div class=\"pinp font14\">\r\n");
	 array = GetImages("brand",brand.Id);
	...
	XYBody.Append("    <img src=\"");	XYBody.Append(path.ToString());	XYBody.Append("\" alt=\"");	XYBody.Append(brand.UserBrandName.ToString());	XYBody.Append("\"/>\r\n");
	XYBody.Append("    <br />\r\n");
	XYBody.Append("    ");	XYBody.Append(brand.UserBrandName.ToString());	XYBody.Append("\r\n");
	XYBody.Append("	<br /></ul>\r\n");
	...
	XYBody.Append("	<br />\r\n");
	XYBody.Append("	</div>\r\n");
	XYBody.Append("	<p class=\"font142\">详细信息：");	XYBody.Append(brand.Description.ToString());	XYBody.Append("</p>\r\n");
	XYBody.Append("	</div>\r\n");
	XYBody.Append("</div>\r\n");
	XYBody.Append("</div>\r\n");
