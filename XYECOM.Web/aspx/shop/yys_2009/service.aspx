<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.shop.service,XYECOM.Page" %>
...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("    <div class=\"clr\"></div>\r\n");
	XYBody.Append("    <div class=\"where\">你现在的位置：首页 &gt; 服务信息</div>\r\n");
	...
	foreach(DataRow info in infolist.Rows)
	{
	 ...
	 str = GetInfoUrl("service",info["InfoFlag"],info["InfoId"],info["HtmlPage"]);
	
	 str1 = GetInfoImgHref("service",info["InfoId"]);
