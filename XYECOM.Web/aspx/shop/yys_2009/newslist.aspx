...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("    <div class=\"clr\"></div>\r\n");
	XYBody.Append("    <div class=where>你现在的位置：首页 &gt; 企业新闻</div>\r\n");
	...
	XYBody.Append("                <li><a href=\"");	XYBody.Append(infourl.ToString());	XYBody.Append("\">" + info["NewsTitle"].ToString().Trim() + "</a> <span>(" + info["Addtime"].ToString().Trim() + ")</span></li>\r\n");
