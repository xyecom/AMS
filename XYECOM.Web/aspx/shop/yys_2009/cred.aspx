...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("    <div class=\"clr\"></div>\r\n");
	XYBody.Append("    <div class=\"where\">你现在的位置：首页 &gt; 荣誉资质</div>\r\n");
	...
	XYBody.Append("                    </tr>\r\n");
	XYBody.Append("                </table>\r\n");
	XYBody.Append("                <table class=\"mainTextColor\" style=\"PADDING-BOTTOM: 10px; PADDING-TOP: 10px\" cellSpacing=\"1\" cellPadding=\"0\" width=\"95%\" align=\"center\" bgColor=#efefef border=0>\r\n");
	XYBody.Append("                    <Tbody>\r\n");
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                            <th width=\"21%\">证书</th>\r\n");
	XYBody.Append("                            <th width=\"28%\" >证书名称</th>\r\n");
	XYBody.Append("                            <th width=\"25%\">发证机构</th>\r\n");
	XYBody.Append("                            <th width=\"14%\">生效日期</th>\r\n");
	XYBody.Append("                            <th width=\"14%\">结束日期</th>\r\n");
	XYBody.Append("                        </tr>\r\n");
	 data = GetCertificate();
	...
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                            <td bgcolor=\"#ffffff\" height=\"25\" >\r\n");
	XYBody.Append("                                <a href=\"");	XYBody.Append(str.ToString());	XYBody.Append("\" target=\"_blank\"><img  width=100px src=\"");	XYBody.Append(str.ToString());	XYBody.Append("\" border=\"0\"/></a>\r\n");
	XYBody.Append("                            </td>\r\n");
	XYBody.Append("                            <td bgcolor=\"#ffffff\"><a  class=\"M\" target=\"_blank\" href='");	XYBody.Append(str.ToString());	XYBody.Append("'>" + info["CE_Name"].ToString().Trim() + "</a></td>\r\n");
	XYBody.Append("                            <td bgcolor=\"#ffffff\">" + info["CE_Organ"].ToString().Trim() + "</td>\r\n");
