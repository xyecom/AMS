...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("    <div class=\"clr\"></div>\r\n");
	XYBody.Append("    <div class=where>你现在的位置：首页 &gt; 供应信息</div>\r\n");
	...
	XYBody.Append("                <ul>\r\n");
	XYBody.Append("                    <li>招聘中心 </li>\r\n");
	XYBody.Append("                </ul>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("            <div class=newslist>\r\n");
	XYBody.Append("                <table class=mainTextColor width=\"95%\" align=center>\r\n");
	XYBody.Append("                    <tbody>\r\n");
	XYBody.Append("                    <tr>\r\n");
	XYBody.Append("                        <th width=\"21%\">职位名称</th>\r\n");
	XYBody.Append("                        <th width=\"41%\">工作性质</th>\r\n");
	XYBody.Append("                        <th width=\"20%\">招聘人数</th>\r\n");
	XYBody.Append("                        <th width=\"20%\">有效日期</th>\r\n");
	XYBody.Append("                    </tr>\r\n");
	...
	XYBody.Append("                        <tr>\r\n");
	XYBody.Append("                            <td  height=\"25\"><a target=\"_blank\" href='");	XYBody.Append(infourl.ToString());	XYBody.Append("'>" + info["EI_Job"].ToString().Trim() + "</a></td>\r\n");
	XYBody.Append("                            <td>" + info["EI_Type"].ToString().Trim() + "</td>\r\n");
	XYBody.Append("                            <td>" + info["EI_Number"].ToString().Trim() + "人</td>\r\n");
	XYBody.Append("                            <td>\r\n");
