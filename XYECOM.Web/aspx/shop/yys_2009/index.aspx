...
protected override void OnLoad(EventArgs e)
{
	...
	XYBody.Append("    <div class=\"clr\"></div>\r\n");
	XYBody.Append("    <div class=\"where\">你现在的位置：首页 </div>\r\n");
	...
	XYBody.Append("                <ul>\r\n");
	XYBody.Append("                    <li>推荐产品 </li>\r\n");
	XYBody.Append("                    <li class=\"more\">\r\n");
	XYBody.Append("                    <a href=\"offer.");	XYBody.Append(config.suffix);	XYBody.Append("\">更多&gt;&gt;</a>\r\n");
	XYBody.Append("                    </li>\r\n");
	XYBody.Append("                </ul>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("            <div class=\"tuijian_product\">\r\n");
	XYBody.Append("                <div class=\"scrollW\" id=\"demo\" style=\"MARGIN-LEFT: 17px\">\r\n");
	XYBody.Append("                    <div id=\"indemo\">\r\n");
	XYBody.Append("                        <div id=\"demo1\">\r\n");
	XYBody.Append("                            <ul>\r\n");
	...
	XYBody.Append("                                    <div class=\"picBox\"><a href=\"");	XYBody.Append(str.ToString());	XYBody.Append("\" target=\"_blank\"><img alt=\"" + info["InfoTitle"].ToString().Trim() + "\"  src=\"");	XYBody.Append(str1.ToString());	XYBody.Append("\" border=\"0\" onload='SetImgSize(this,100,100);'></a></div>\r\n");
	XYBody.Append("                                    <div class=\"textBox\"> <a target=\"_blank\" href='");	XYBody.Append(str.ToString());	XYBody.Append("'> " + info["InfoTitle"].ToString().Trim() + " </a> </div>\r\n");
	XYBody.Append("                                </li>\r\n");
	...
	XYBody.Append("        </div>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <!--推荐产品结束-->\r\n");
	XYBody.Append("    <!--工作室介绍-->\r\n");
	XYBody.Append("    <div id=\"bodyright\">\r\n");
	XYBody.Append("    <div class=\"leftkuang\">\r\n");
	XYBody.Append("        <div class=\"righttitle\">\r\n");
	XYBody.Append("            <ul>\r\n");
	XYBody.Append("              <li>工作室简介 </li>\r\n");
	XYBody.Append("              <li class=\"more\"></li>\r\n");
	XYBody.Append("            </ul>\r\n");
	XYBody.Append("        </div>\r\n");
	...
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <!--工作室介绍结束-->\r\n");
	XYBody.Append("    <!--供应信息-->\r\n");
	XYBody.Append("    <div id=\"bodyright\">\r\n");
	XYBody.Append("        <div class=\"leftkuang\">\r\n");
	XYBody.Append("            <div class=\"righttitle\">\r\n");
	XYBody.Append("            <ul>\r\n");
	XYBody.Append("                <li>最新供应 </li>\r\n");
	XYBody.Append("                <li class=\"more\"><a href=\"offer.");	XYBody.Append(config.suffix);	XYBody.Append("\">更多&gt;&gt;</a></li>\r\n");
	XYBody.Append("            </ul>\r\n");
	XYBody.Append("            </div>\r\n");
	XYBody.Append("            <div class=\"tuijian_product\">\r\n");
	XYBody.Append("            <ul>\r\n");
	...
	XYBody.Append("                    <li>\r\n");
	XYBody.Append("                        <div class=\"picBox\"><a href=\"");	XYBody.Append(str.ToString());	XYBody.Append("\" target=\"_blank\"><img alt=\"\" src=\"");	XYBody.Append(str1.ToString());	XYBody.Append("\" border=\"0\" onload='SetImgSize(this,100,100);'></a></div>\r\n");
	XYBody.Append("                        <div class=\"textBox\"><a href=\"");	XYBody.Append(str.ToString());	XYBody.Append("\" target=\"_blank\">" + newdata["infoTitle"].ToString().Trim() + "</a></div>\r\n");
	XYBody.Append("                    </li>\r\n");
