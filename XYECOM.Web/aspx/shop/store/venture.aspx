<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="XYECOM.Page.shop.venture,XYECOM.Page" %>
...
System.Web.HttpContext.Current.Response.End();
	...
	XYBody.Append("                                <a href=\"");	XYBody.Append(shopuserinfo.domain.ToString());	XYBody.Append("offerlist-------.");	XYBody.Append(config.suffix);	XYBody.Append("\" target=\"_blank\">广告促销</a>\r\n");
	XYBody.Append("                            </div>\r\n");
	...
	XYBody.Append("                        <div class=\"d_list\">\r\n");
	XYBody.Append("                            <div class=\"d_title\">\r\n");
	XYBody.Append("                                <a href=\"");	XYBody.Append(shopuserinfo.domain.ToString());	XYBody.Append("offerlist-------.");	XYBody.Append(config.suffix);	XYBody.Append("\" target=\"_blank\">冬季促销</a>\r\n");
	XYBody.Append("                            </div>\r\n");
	XYBody.Append("                            <div class=\"d_box\">\r\n");
	XYBody.Append("                                <ul>\r\n");
	...
	XYBody.Append("                        <div class=\"d_list\">\r\n");
	XYBody.Append("                            <div class=\"d_title\">\r\n");
	XYBody.Append("                                <a href=\"");	XYBody.Append(shopuserinfo.domain.ToString());	XYBody.Append("offerlist-------.");	XYBody.Append(config.suffix);	XYBody.Append("\" target=\"_blank\">商务办公</a>\r\n");
	XYBody.Append("                            </div>\r\n");
	XYBody.Append("                            <div class=\"d_box\">\r\n");
	XYBody.Append("                                <ul>\r\n");
	...
	XYBody.Append("                        <div class=\"d_list\">\r\n");
	XYBody.Append("                            <div class=\"d_title\">\r\n");
	XYBody.Append("                                <a href=\"");	XYBody.Append(shopuserinfo.domain.ToString());	XYBody.Append("offerlist-------.");	XYBody.Append(config.suffix);	XYBody.Append("\" target=\"_blank\">节庆礼品</a>\r\n");
	XYBody.Append("                            </div>\r\n");
	XYBody.Append("                            <div class=\"d_box\">\r\n");
	XYBody.Append("                                <ul>\r\n");
	...
	XYBody.Append("                        <div class=\"d_list\">\r\n");
	XYBody.Append("                            <div class=\"d_title\">\r\n");
	XYBody.Append("                                <a href=\"");	XYBody.Append(shopuserinfo.domain.ToString());	XYBody.Append("offerlist-------.");	XYBody.Append(config.suffix);	XYBody.Append("\" target=\"_blank\">传统工艺</a>\r\n");
	XYBody.Append("                            </div>\r\n");
	XYBody.Append("                            <div class=\"d_box\">\r\n");
	XYBody.Append("                                <ul>\r\n");
	...
	XYBody.Append("        </h3>\r\n");
	XYBody.Append("        投融资规模：");	XYBody.Append(info.Price.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        投融资类型：");	XYBody.Append(info.TypeName.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        投融资领域：");	XYBody.Append(info.Trade.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        地区：");	XYBody.Append(info.Area.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        项目网址：");	XYBody.Append(info.WebSite.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        项目摘要：");	XYBody.Append(info.Summary.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        项目发布时间：");	XYBody.Append(info.PublishTime.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        有效期至：");	XYBody.Append(info.EndTime.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("        详细描述：");	XYBody.Append(info.InfoContent.ToString());	XYBody.Append("<br />\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("    <div class=\"clear\">\r\n");
	XYBody.Append("    </div>\r\n");
	XYBody.Append("</div>\r\n");
